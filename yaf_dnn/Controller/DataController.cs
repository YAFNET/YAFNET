...
namespace YAF.DotNetNuke.Controller
{
    ...
    public class DataController
    {
        ...
        /// <param name="useStyledNicks"></param>
        /// <param name="showNoCountPosts"></param>
        /// <returns>Data Table of Latest Posts</returns>
        public static DataTable TopicLatest(object boardId, object numOfPostsToRetrieve, object userId, bool useStyledNicks, bool showNoCountPosts)
        {
