	...
	public class ProfileMenu : BaseControl
	{
		protected override void Render(System.Web.UI.HtmlTextWriter writer) 
		{
			...
			if (PageContext.BoardSettings.AllowPrivateMessages)
			{
				...
				html.AppendFormat("<li><a href='{0}'>{1}</a></li>",YAF.Classes.Utils.yaf_BuildLink.GetLink( YAF.Classes.Utils.ForumPages.cp_inbox,"sent=1"),PageContext.Localization.GetText("SENTITEMS"));
