...
namespace YAF.Controls
{
	public class MessageBase : BaseControl
	{
		...
		virtual protected void RenderModulesInBBCode( HtmlTextWriter writer, string message, MessageFlags theseFlags, int? displayUserId )
		{
		...
		virtual protected void GetModuleParameters( ref Dictionary<string, string> paramDic, string invokeString )
		{
			Regex regExSearch = new Regex( _rgxModuleParam, _options );
			Match m = regExSearch.Match( invokeString );

			System.Text.StringBuilder sb = new System.Text.StringBuilder( invokeString );
