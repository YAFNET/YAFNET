...
namespace YAF.Controls
{
    ...
    public class DataPanel : Panel, IPostBackDataHandler
    {
        ...
        public bool AllowTitleExpandCollapse
        {
            get
            {
                return this.ViewState[_allowTitleExpandCollapse] != null
                       && Convert.ToBoolean(this.ViewState[_allowTitleExpandCollapse]);
            }
        ...
        /// </remarks>
        [NotNull]
        [Description("Url of the image to use for the collapse-" + "action link.")]
        [Category("Appearance")]
        [DefaultValue("")]
        public string CollapseImageUrl
        {
            get
            {
                return this.ViewState[_collapseImageUrl] == null
                           ? string.Empty
                           : this.ViewState[_collapseImageUrl].ToString();
            }
        ...
        public string CollapseText
        {
            get
            {
                return this.ViewState[_collapseText] == null ? "Collapse" : this.ViewState[_collapseText].ToString();
            }
        ...
        public bool Collapsed
        {
            get
            {
                return this.ViewState[_collapsed] == null || Convert.ToBoolean(this.ViewState[_collapsed]);
            }
        ...
        public bool Collapsible
        {
            get
            {
                return this.ViewState[_collapsible] == null || Convert.ToBoolean(this.ViewState[_collapsible]);
            }
        ...
        public string ExpandImageUrl
        {
            get
            {
                return this.ViewState[_expandImageUrl] == null
                           ? string.Empty
                           : this.ViewState[_expandImageUrl].ToString();
            }
        ...
        public string ExpandText
        {
            get
            {
                return this.ViewState[_expandText] == null ? "Expand" : this.ViewState[_expandText].ToString();
            }
        ...
        public bool HideActionExpandCollapse
        {
            get
            {
                return this.ViewState[this._hideActionExpandCollapse] != null
                       && Convert.ToBoolean(this.ViewState[this._hideActionExpandCollapse]);
            }
        ...
        public string TitleText
        {
            get
            {
                return this.ViewState[_titleText] == null ? string.Empty : this.ViewState[_titleText].ToString();
            }
        ...
        private string CollapsedStateId
        {
            get
            {
                return string.Format("{0}_CurrentState", this.ID);
            }
        }
        ...
        private string HeaderPanelId
        {
            get
            {
                return string.Format("{0}_HeaderPanel", this.ID);
            }
        }
        ...
        public bool LoadPostData([NotNull] string postDataKey, [NotNull] NameValueCollection postCollection)
        {
            ...
            {
                this.Collapsed = collapsedState != "false";
            }
        ...
        private void ApplyStyle([NotNull] HtmlTableCell cell, [NotNull] Style controlStyle)
        {
            ...
            {
                foreach (string s in controlStyle.Font.Names.Where(s => fontNames.IndexOf(s) == -1))
                {
                    fontNames += string.Format(",{0}", s);
                }
            }
        ...
        private string PanelUrl(bool useImages, bool titleIsLink)
        {
            ...
            return useImages == false
                       ? "javascript:DataPanel_ExpandCollapse('{0}_ContentRow','{1}','{0}_ActionLink','{0}_CurrentState','{2}','{3}');"
                             .FormatWith(this.ID, titleLink, this.CollapseText, this.ExpandText)
                       : "javascript:DataPanel_ExpandCollapseImage('{0}_ContentRow','{1}','{0}_ActionLink','{0}_CurrentState','{2}','{3}','{4}','{5}');"
                             .FormatWith(
                                 this.ID,
                                 titleLink,
                                 this.ExpandImageUrl,
        ...
        private void UpdateControlsState()
        {
            ...
            this._actionLink.Visible = this.HideActionExpandCollapse == false;
