...
namespace YAF.Modules
{
    ...
    public class SharepointRoleSyncModule : SimpleBaseForumModule
    {
                            ...
                            using (SPWeb spWeb = spSite.OpenWeb())
                            {
                                try
                                {
                                    ...
                                    if (spUser != null)
                                    {
                                        ...
                                        {
                                            if (webGroups.Exists(g => g.Name.Equals(groupName))
                                                && !userGroups.Any(g => g.Name.Equals(groupName)))
                                            {
                                                System.Diagnostics.Trace.WriteLine(
                                                    "Adding to SharePoint Group: " + groupName);
                                                webGroups.Where(g => g.Name.Equals(groupName)).SingleOrDefault()
                                                    .AddUser(spUser);
                                            }
                                        }
                                    }
