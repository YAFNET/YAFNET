!function() {
    ...
    function ot(e) {
        return e && (!ke(e, "p,div") || e.className || Ce(e, "style") || !l(d(e)));
    }
    function rt(e, t) {
    ...
    var Fe = {
        ...
        indent: {
            state: function(e, t) {
                var n;
                return ke(t, "li") || ke(t, "ul,ol,menu") && (n = (t = this.getRangeHelper().selectedRange()).startContainer.parentNode, 
                t = t.endContainer.parentNode, n !== n.parentNode.firstElementChild || ke(t, "li") && t !== t.parentNode.lastElementChild) ? 0 : -1;
            },
            exec: function() {
        ...
        quote: {
            exec: function(e, t, n) {
                var o = '<div class="card mx-3 mb-3 border-secondary shadow-sm"><div class="card-body"><p contenteditable="false" class="d-inline"><i class="fa fa-quote-left text-primary fs-4"></i></p><p class="card-text"><span class="quote-content">', r = "</span></p></div></div>";
    ...
    const yt = o(Array.prototype.forEach), bt = o(Array.prototype.pop), xt = o(Array.prototype.push), wt = o(String.prototype.toLowerCase), Tt = o(String.prototype.toString), Et = o(String.prototype.match), Ct = o(String.prototype.replace), St = o(String.prototype.indexOf), Dt = o(String.prototype.trim), We = o(RegExp.prototype.test), kt = (S = TypeError, 
    function() {
    ...
    var Vt = function F(e) {
        ...
        let ye = null;
        const be = Ve({}, [ "alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns" ]), k = "http://www.w3.org/1998/Math/MathML", N = "http://www.w3.org/2000/svg", A = "http://www.w3.org/1999/xhtml";
        let _ = A, xe, we = null;
        const Te = Ve({}, [ k, N, A ], Tt);
        let M = null;
        ...
        function Se() {
            ...
            if (!L || L !== e) {
                ...
                g.table && (Ve(g, [ "tbody" ]), delete b.tbody), e.TRUSTED_TYPES_POLICY) {
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createHTML) throw kt('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createScriptURL) throw kt('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
        ...
        return c.sanitize = function(e) {
            ...
            let o = null, r = null;
            if ("string" != typeof (e = (xe = !e) ? "\x3c!--\x3e" : e) && !Ne(e)) {
                if ("function" != typeof e.toString) throw kt("toString is not a function");
                if ("string" != typeof (e = e.toString())) throw kt("dirty is not a string, aborting");
            }
            if (!c.isSupported) return e;
            if (ce || Se(n), c.removed = [], S = "string" != typeof e && S) {
                if (e.nodeName) {
                    n = R(e.nodeName);
                    if (!g[n] || b[n]) throw kt("root node is forbidden and cannot be sanitized in-place");
                }
            ...
            o && ue && O(o.firstChild);
            for (var i = ke(S ? e : o); t = i.nextNode(); ) Ae(t) || (t.content instanceof P && Re(t.content), 
            Me(t));
            if (S) return e;
            if (T) {
    ...
    function $t(e, t) {
        var n;
        p(e, function(e) {
            Le(e, !0) ? (n || e.nodeType === ge ? /\S/.test(e.nodeValue) : !ke(e, ".sceditor-ignore")) && (n || Ne(n = ve("p", {}, t), e), 
            xe(n, e)) : n = null;
        }, !1, !0);
    }
    function ze(r, e) {
        var a, b, u, i, o, d, f, l, x, s, c, p, t, m, h, g, v, y, F, H, n, w, P, z, T, E, B, U, W, V, j, $, Y, G, q, X, K, Z, J, C, Q, ee, te, ne, oe, S, re, D, ie, ae, le, se, k, ce, N, ue, A, _ = this, M = {}, R = [], L = {}, de = {}, O = (_.commands = Ye(!0, {}, e.commands || Fe), 
        ...
        fe.addHook("uponSanitizeElement", function(e, t) {
            ...
            r._sceditor = _, O.locale && "en" !== O.locale && W(), Ne(b = ve("div", {
            ...
            Te(d, "blur", ce), Te(d, "keyup", N), Te(d, "paste", G), Te(d, "cut copy", q), 
            ...
            if (et(b)) if (_.sourceMode()) t = e ? l.value.length : 0, l.setSelectionRange(t, t); else {
                if (lt(d), e) for ((n = d.lastChild) || (n = ve("p", {}, f), xe(d, n)); n.lastChild; ) ke(n = n.lastChild, "br") && n.previousSibling && (n = n.previousSibling);
            ...
            d.innerHTML = I(e = e || "<p><br /></p>"), D(), k(), A();
            ...
            S(), void 0 !== _.opts.onToggleMode && _.opts.onToggleMode(_));
        }, re = function() {
            ...
            var t, n, o;
            e.defaultPrevented || (_.closeDropDown(), 13 === e.which && !ke(v, "li,ul,ol") && ot(v) && (t = ve("br", {}, f), 
            ...
            tt(d, function(e) {
                var t;
                if (e.nodeType === he && !/inline/.test(De(e, "display")) && (!ke(e, ".sceditor-nlf") && ot(e))) return (t = ve("p", {}, f)).className = "sceditor-nlf", 
            ...
            if ($e(e)) _.bind("focus", e, t, n); else if (_.inSourceMode()) l.focus(); else {
                ...
                e = m.selectedRange();
                y || le(!0), e && 1 === e.endOffset && e.collapsed && (t = e.endContainer) && 1 === t.childNodes.length && ke(t.firstChild, "br") && (e.setStartBefore(t.firstChild), 
            ...
            0 === n.startOffset) && (o = se()) && !ke(o, "body")) {
                for (;t !== o; ) {
            ...
            for (var e = v; !ot(e) || Le(e, !0); ) if (!(e = e.parentNode) || ke(e, "body")) return;
            return e;
        }, _.clearBlockFormatting = function(e) {
            return (e = e || se()) && !ke(e, "body") && (m.saveRange(), e.className = "", 
            Ce(e, "style", ""), ke(e, "p,div,td") || rt(e, "p"), m.restoreRange()), 
            _;
        }, k = function(e) {
            var t, n, o;
            h && (h.hasHandler("valuechangedEvent") || k.hasHandler) && (o = !(n = _.sourceMode()) && m.hasSelection(), 
            e = (c = !1) !== e && !f.getElementById("sceditor-start-marker"), p && (clearTimeout(p), 
            p = !1), o && e && m.saveRange(), (t = n ? l.value : d.innerHTML) !== k.lastVal && (k.lastVal = t, 
            Qe(b, "valuechanged", {
                rawValue: n ? _.val() : t
            })), o) && e && m.removeMarkers();
        }, ce = function() {
            ...
            N.lastChar = e, c || (13 === e || 32 === e ? n ? N.triggerNext = !0 : k() : 8 === e || 46 === e ? t ? N.triggerNext = !0 : k() : N.triggerNext && (k(), 
            N.triggerNext = !1), clearTimeout(p), p = setTimeout(function() {
                c || k();
            }, 1500));
        }, ee = function(e) {
            (c = /start/i.test(e.type)) || k();
        }, ue = function() {
            _.updateOriginal();
        }, e();
    }
...
!function(t) {
    ...
    var l, f = t.escapeEntities, r = t.escapeUriScheme, h = t.dom, e = t.utils, p = h.css, s = h.attr, g = h.is, n = e.extend, b = e.each, i = t.command.get, v = {
        ...
        youtube: {
            txtExec: function(t) {
                ...
                i("youtube")._dropDown(e, t, function(t) {
                    e.insertText(`[youtube]https://www.youtube.com/watch?v=${t}[/youtube]`);
                });
            }
        }
    }, y = {
        ...
        quote: {
            ...
            quoteType: v.never,
            format: function(t, e) {
                for (var n, r = "data-author", i = "", l = t.children, o = 0; !n && o < l.length; o++) g(l[o], "cite") && (n = l[o]);
                return (n || s(t, r)) && (i = n && n.textContent || s(t, r), s(t, r, i), 
                n && t.removeChild(n), e = this.elementToBbcode(t), i = "=" + i.replace(/(^\s+|\s+$)/g, ""), 
                n) && t.insertBefore(n, t.firstChild), `[quote${i}]${e}[/quote]`;
            },
            html: function(t, e, n) {
                return '<div class="card mx-3 mb-3 border-secondary shadow-sm"><div class="card-body"><p contenteditable="false" class="d-inline"><i class="fa fa-quote-left text-primary fs-4"></i></p><p class="card-text"><span class="quote-content">' + (n = e.defaultattr ? n + '<cite class="card-text text-end d-block"><small class="text-body-secondary">' + f(e.defaultattr) + "</small></cite>" : n) + "</span></p></div></div>";
            }
        },
        code: {
            tags: {
        ...
        youtube: {
            ...
            format: function(t, e) {
                return (t = s(t, "data-youtube-id")) ? `[youtube]https://www.youtube.com/watch?v=${t}[/youtube]` : e;
            },
            html: function(t, e, n) {
                n = n.match(/(?:v=|v\/|embed\/|youtu.be\/)?([a-zA-Z0-9_-]{11})/)[1];
                return `<div data-oembed-url="https://youtube.com/embed/${n}" data-youtube-id="${n}" class="ratio ratio-16x9"><iframe src="https://youtube.com/embed/${n}?hd=1"></iframe></div>`;
            }
        },
        rtl: {
            styles: {
    ...
    var w = "open", E = "content", B = "newline", T = "close";
    ...
    function C(t) {
        ...
        function o(t, e) {
            var n, r, i;
            return t === w && (n = e.match(/\[([^\]\s=]+)(?:([^\]]+))?\]/)) && (i = l(n[1]), 
            ...
            (i = t === B ? "#newline" : i) && (t !== w && t !== T || y[i]) || (t = E, 
            i = "#"), new u(t, i, e, r);
        }
        function d(t, e, n) {
        ...
        function c(t, e) {
            for (var n, r, i, l, o, a, s = "", u = function(t) {
                ...
                if (n.type === w) a = n.children[n.children.length - 1] || {}, r = y[n.name], 
        ...
        h.opts = n({}, C.defaults, t), h.tokenize = function(t) {
            var e, n, r, i = [], l = [ {
                type: E,
                regex: /^([^\[\r\n]+|\[)/
            }, {
            ...
            var t = function(t) {
                ...
                i.type = E), i.type) {
                  case w:
                    r(i.name) && f.pop(), n(i), (l = y[i.name]) && !l.isSelfClosing && (l.closedBy || d(i.name, T, t)) ? f.push(i) : l && l.isSelfClosing || (i.type = E);
                    break;

                  case T:
                    if (e() && i.name !== e().name && r("/" + i.name) && f.pop(), 
                    e() && i.name === e().name) e().closing = i, f.pop(); else if (d(i.name, w, f)) {
                        for (;o = f.pop(); ) {
                            if (o.name === i.name) {
                                o.closing = i;
                                break;
                        ...
                        for (s && s.type === B && (l = y[i.name]) && !1 === l.isInline && (n(s), 
            ...
            return n.fixInvalidNesting && function t(e, n, r, i) {
                ...
                n = n || [];
                i = i || e;
                for (o = 0; o < e.length; o++) if ((l = e[o]) && l.type === w) {
                    var c, f;
                    if (r && !u(l)) if (f = g(n), s = f.splitAt(l), a = 1 < n.length ? n[n.length - 2].children : i, 
                    m(l, f) && ((c = f.clone()).children = l.children, l.children = [ c ]), 
                    -1 < (c = a.indexOf(f))) return s.children.splice(0, 1), a.splice(c + 1, 0, l, s), 
                    void ((f = s.children[0]) && f.type === B && !u(l) && (s.children.splice(0, 1), 
                    a.splice(c + 2, 0, f)));
                ...
                n && (a = y[n.name]);
                var m = d;
                for (;m--; ) (i = e[m]) && (i.type === B ? (l = 0 < m ? e[m - 1] : null, 
                ...
                a.breakStart && (f = !0))), l && l.type === w && (s = y[l.name]) && (r ? !1 === s.isInline && (f = !0) : (!1 === s.isInline && h.opts.breakAfterBlock && !1 !== s.breakAfter && (f = !0), 
                s.breakAfter && (f = !0))), !r && !c && o && o.type === w && (s = y[o.name]) && (!1 === s.isInline && h.opts.breakBeforeBlock && !1 !== s.breakBefore && (f = !0), 
                s.breakBefore && (f = !0), c = f) ? e.splice(m, 1) : (f && e.splice(m, 1), 
                c = !1)) : i.type === w && t(i.children, i, r));
                ...
                var i = function(t) {
                    for (var e = t.length; e--; ) {
                        var n = t[e].type;
                        if (n === w || n === T) return !1;
                        if (n === E && /\S|\u00A0/.test(t[e].val)) return !1;
                    }
                    return !0;
                };
                var l = e.length;
                for (;l--; ) (n = e[l]) && n.type === w && (r = y[n.name], t(n.children), 
            ...
            return function t(e) {
                ...
                o = (i ? i.quoteType : null) || h.opts.quoteType || v.auto, i || n.type !== w) if (n.type === w) {
    ...
    function m() {
        ...
        function c(t, e) {
            function f(t, s, u) {
                ...
                return h.traverse(t, function(t) {
                    ...
                    a ? (s || (i || (e = m(t, e, !1)), e = m(t, e, !0)), c += function(t, e) {
                        var n = t.nodeName.toLowerCase(), r = h.isInline;
                        if (!r(t, !0) || "br" === n) {
                            for (var i, l, o = t.previousSibling; o && 1 === o.nodeType && !g(o, "br") && r(o, !0) && !o.firstChild; ) o = o.previousSibling;
        ...
        function t(t, e, n) {
            var r = new C(u.opts.parserOptions), t = t || n ? r.toHTMLFragment : r.toHTML;
            return l = u.opts, t(u.opts.bbcodeTrim ? e.trim() : e);
        }
        function e(t, e, n, r) {
            n = n || document;
            var i, l = !!h.closest(r, "code"), o = n.createElement("div"), a = n.createElement("div"), s = new C(u.opts.parserOptions);
    ...
    }, m.formatBBCodeString = x, t.formats.bbcode = m, t.BBCodeParser = C;
}(sceditor);
