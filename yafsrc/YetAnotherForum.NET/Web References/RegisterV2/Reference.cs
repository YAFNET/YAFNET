...
namespace YAF.RegisterV2 {
    ...
    public partial class RegisterV2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private SendOrPostCallback LatestInfoOperationCompleted;
        ...
        /// <remarks/>
        public IAsyncResult BeginLatestInfo(long currentVersion, string culture, AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public LatestVersionInformation EndLatestInfo(IAsyncResult asyncResult) {
        ...
        private void OnLatestInfoOperationCompleted(object arg) {
            if ((this.LatestInfoCompleted != null)) {
                InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
    ...
    public partial class LatestInfoCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        internal LatestInfoCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : 
