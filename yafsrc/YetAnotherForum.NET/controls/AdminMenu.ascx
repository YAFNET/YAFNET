        ...
        <i class="fa fa-tachometer-alt fa-fw"></i>&nbsp;<%= this.GetText("ADMINMENU", "ADMIN")  %>
                        ...
                        <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a 
                                                                  href="<%= YafBuildLink.GetLink(ForumPages.admin_boardsettings) %>">
                        ...
                        <li class="dropdown-item"> <a href="<%= YafBuildLink.GetLink(ForumPages.admin_extensions) %>"
                               >
                                <i class="fa fa-puzzle-piece fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                                                    LocalizedTag="admin_extensions" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                            </a></li>
                        <li class="dropdown-item"> <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bbcode) %>"
                               >
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_spamlog) %>"
                               >
                                <i class="fa fa-book fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                                                    LocalizedTag="admin_spamlog" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                            </a></li>
                        <li class="dropdown-item">    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_spamwords) %>"
                               >
                                <i class="fa fa-shield-alt fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                                                    LocalizedTag="admin_spamwords" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                            </a></li>
                        <li class="dropdown-item">   <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedemail) %>"
                               >
                                <i class="fa fa-hand-paper fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                                                    LocalizedTag="admin_bannedemail" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                            </a></li>
                        <li class="dropdown-item">   <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedip) %>"
                               >
                                <i class="fa fa-hand-paper fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                                                    LocalizedTag="admin_bannedip" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                            </a></li>
                        <li class="dropdown-item"> <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedname) %>"
                               >
                                <i class="fa fa-hand-paper fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_accessmasks) %>">
                                    <i class="fa fa-universal-access fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_accessmasks" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_groups) %>">
                                    <i class="fa fa-users fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_groups" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_users) %>">
                                    <i class="fa fa-users fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_users" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_ranks) %>">
                                    <i class="fa fa-graduation-cap fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_ranks" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_medals) %>">
                                    <i class="fa fa-trophy fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_medals" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_mail) %>">
                                    <i class="fa fa-at fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_mail" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_digest) %>">
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            <a href="#" 
                               data-toggle="dropdown" 
                               class="dropdown-toggle"><i class="fa fa-recycle fa-fw"></i>&nbsp;<YAF:LocalizedLabel runat="server"
                                                                           LocalizedTag="Maintenance" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_prune) %>">
                                    <i class="fa fa-trash fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_prune" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_pm) %>">
                                    <i class="fa fa-envelope-square fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_pm" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_taskmanager) %>">
                                    <i class="fa fa-tasks fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_taskmanager" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_eventlog) %>">
                                    <i class="fa fa-book fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                                        LocalizedTag="admin_eventlog" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                </a></li>
                                <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_restartapp) %>">
                            ...
                            <li class="dropdown-item dropdown-submenu">
                                <a href="#" 
                                   data-toggle="dropdown" 
                                   class="dropdown-toggle"><i class="fa fa-database fa-fw"></i>&nbsp;<YAF:LocalizedLabel runat="server"
                                                                               LocalizedTag="Database" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel></a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_reindex) %>">
                                        <i class="fa fa-database fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server" 
                                                            LocalizedTag="admin_reindex" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                    </a></li>
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_runsql) %>">
                                        <i class="fa fa-database fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server" 
                            ...
                            <li class="dropdown-item dropdown-submenu">
                                <a href="#" 
                                   data-toggle="dropdown" 
                                   class="dropdown-toggle"><i class="fa fa-newspaper fa-fw"></i>&nbsp;<YAF:LocalizedLabel runat="server"
                                                                               LocalizedTag="NNTP" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel></a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_nntpservers) %>">
                                        <i class="fa fa-newspaper fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server" 
                                                            LocalizedTag="admin_nntpservers" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                    </a></li>
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_nntpforums) %>">
                                        <i class="fa fa-newspaper fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server" 
                                                            LocalizedTag="admin_nntpforums" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                    </a></li>
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_nntpretrieve) %>">
                                        <i class="fa fa-newspaper fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server" 
                            ...
                            <li class="dropdown-item dropdown-submenu">
                                <a href="#" 
                                   data-toggle="dropdown" 
                                   class="dropdown-toggle"><i class="fa fa-download fa-fw"></i>&nbsp;<YAF:LocalizedLabel runat="server"
                                                                               LocalizedTag="Upgrade" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel></a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-item"><a href="<%= YafBuildLink.GetLink(ForumPages.admin_version) %>">
