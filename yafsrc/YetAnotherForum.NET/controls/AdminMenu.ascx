        ...
        <%= this.GetText("ADMINMENU", "ADMIN")  %>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="hostDropdown">
                            <li class="dropdown-item">
                                <a href="<%= YafBuildLink.GetLink(ForumPages.admin_admin) %>">
                        ...
                        <ul class="dropdown-menu">
                                    <li class="dropdown-item">
                                        <a href="<%= YafBuildLink.GetLink(ForumPages.admin_boardsettings) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_forums) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_replacewords) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_extensions) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bbcode) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_languages) %>">
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_spamlog) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_spamwords) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedemail) %>">
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedip) %>">
                                <i class="fa fa-hand-paper fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                        ...
                        <li class="dropdown-item">
                            <a href="<%= YafBuildLink.GetLink(ForumPages.admin_bannedname) %>">
                                <i class="fa fa-hand-paper fa-fw"></i>&nbsp;
                                <YAF:LocalizedLabel runat="server" 
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_accessmasks) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_groups) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_users) %>">
                                    <i class="fa fa-users fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_ranks) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_medals) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_mail) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_digest) %>">
                        ...
                        <li class="dropdown-item dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_prune) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_pm) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_taskmanager) %>">
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_eventlog) %>">
                                    <i class="fa fa-book fa-fw"></i>&nbsp;
                                    <YAF:LocalizedLabel runat="server" 
                                ...
                                <li class="dropdown-item">
                                    <a href="<%= YafBuildLink.GetLink(ForumPages.admin_restartapp) %>">
