...
<li class="nav-item dropdown">
    ...
    <li class="dropdown-item dropdown-submenu<%= this.PageContext.ForumPageType == ForumPages.admin_attachments ||
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-item<%= this.PageContext.ForumPageType == ForumPages.admin_tags ? " active" : ""%>">
                                    <a href="<%= BuildLink.GetLink(ForumPages.admin_tags) %>">
                                        <i class="fa fa-tags fa-fw"></i>&nbsp;
                                        <YAF:LocalizedLabel runat="server"
                                                            LocalizedTag="admin_tags" LocalizedPage="ADMINMENU"></YAF:LocalizedLabel>
                                    </a>
                                </li>
