										...
										<asp:Repeater ID="shoutBoxRepeater" runat="server">
											<ItemTemplate>
												<div style="padding: 0; margin: 0">													
													<b><YAF:UserLink ID="UserLink1" runat="server" BlankTarget="true" UserID='<%# Convert.ToInt32(((System.Data.DataRowView)Container.DataItem)["UserID"]) %>' Style='<%# ((System.Data.DataRowView)Container.DataItem)["Style"] %>' ></YAF:UserLink></b> (<em><YAF:DisplayDateTime ID="PostedDateTime" runat="server" Format="BothTopic" DateTime='<%#((System.Data.DataRowView)Container.DataItem)["Date"]%>'></YAF:DisplayDateTime></em>): 
