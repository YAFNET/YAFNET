...
<h2 runat="server" id="trHeader">
    <YAF:LocalizedLabel ID="LocalizedLabel1" runat="server" 
                        LocalizedTag="HEAD_KILL_USER" LocalizedPage="ADMIN_EDITUSER" />
</h2>
<div class="mb-3">
    ...
    <div class="mb-3 col-md-4">
        <asp:Label runat="server" AssociatedControlID="BanEmail">
            <YAF:LocalizedLabel ID="LocalizedLabel3" runat="server" 
                                LocalizedTag="BAN_EMAIL_OFUSER" LocalizedPage="ADMIN_EDITUSER" />
        </asp:Label>
    ...
    <div class="mb-3 col-md-4">
        <asp:Label runat="server" AssociatedControlID="BanIps">
            <YAF:LocalizedLabel ID="LocalizedLabel8" runat="server" 
                                LocalizedTag="BAN_IP_OFUSER" LocalizedPage="ADMIN_EDITUSER" />
        </asp:Label>
        <div class="form-check form-switch">
    ...
    <div class="mb-3 col-md-4">
        <asp:Label runat="server" AssociatedControlID="BanName">
            <YAF:LocalizedLabel ID="LocalizedLabel9" runat="server" 
                                LocalizedTag="BAN_NAME_OFUSER" LocalizedPage="ADMIN_EDITUSER" />
        </asp:Label>
        <div class="form-check form-switch">
...
<div class="mb-3">
    <asp:Label runat="server" AssociatedControlID="SuspendOrDelete">
        <YAF:LocalizedLabel ID="LocalizedLabel6" runat="server" 
                            LocalizedTag="SUSPEND_OR_DELETE_ACCOUNT" LocalizedPage="ADMIN_EDITUSER" />
    </asp:Label>
    ...
    <div class="mb-3">
            <asp:Label runat="server" AssociatedControlID="ViewPostsLink">
                <YAF:LocalizedLabel ID="LocalizedLabel4" runat="server" 
                                    LocalizedTag="DELETE_POSTS_USER" LocalizedPage="ADMIN_EDITUSER" />
            </asp:Label>
            <strong>
                <asp:Literal ID="PostCount" runat="server"></asp:Literal></strong> (<asp:HyperLink ID="ViewPostsLink" runat="server" Target="_blank">
                    <YAF:LocalizedLabel ID="LocalizedLabel5" runat="server" 
                                        LocalizedTag="VIEW_ALL" LocalizedPage="ADMIN_EDITUSER" />
                </asp:HyperLink>)
        </div>
        ...
        <div class="mb-3">
            <asp:Label runat="server" AssociatedControlID="ReportUser">
                <YAF:LocalizedLabel ID="LocalizedLabel10" runat="server" 
                                    LocalizedTag="REPORT_USER" LocalizedPage="ADMIN_EDITUSER" />
            </asp:Label>
            <div class="form-check form-switch">
