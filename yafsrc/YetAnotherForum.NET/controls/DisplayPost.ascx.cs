...
namespace YAF.Controls
{
    ...
    public partial class DisplayPost : BaseUserControl
    {
        ...
        protected void Page_Load([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            if (this.PopMenu1.Visible)
            {
                ...
                this.PopMenu1.AddPostBackItem(
                    "userprofile", this.PageContext.Localization.GetText("POSTS", "USERPROFILE"));

                this.PopMenu1.AddPostBackItem(
                    "lastposts", this.PageContext.Localization.GetText("PROFILE", "SEARCHUSER"));

                if (YafContext.Current.BoardSettings.EnableThanksMod)
                {
                    this.PopMenu1.AddPostBackItem(
                        "viewthanks", this.PageContext.Localization.GetText("VIEWTHANKS", "TITLE"));
                }
                ...
                if (!this.PageContext.IsGuest)
                {
                    if (this.Get<YafUserIgnored>().IsIgnored(this.PostData.UserId))
                    {
                        this.PopMenu1.AddPostBackItem(
                            ...
                            this.PageContext.Localization.GetText("POSTS", "TOGGLEUSERPOSTS_SHOW"));
                    }
                    else
                    {
                        this.PopMenu1.AddPostBackItem(
                            "toggleuserposts_hide",
                            this.PageContext.Localization.GetText("POSTS", "TOGGLEUSERPOSTS_HIDE"));
                    }
                }
                    ...
                    this.PageContext.PageUserID != (int)this.DataRow["UserID"])
                {
                    ...
                    {
                        this.PopMenu1.AddPostBackItem(
                            "addbuddy", this.PageContext.Localization.GetText("BUDDY", "ADDBUDDY"));
                    }
        ...
        private void FormatThanksRow()
        {
            ...
            {
                this.ThanksDataLiteral.Text =
                    this.PageContext.Localization.GetText("THANKSINFO").FormatWith(
        ...
        private void PopMenu1_ItemClick([NotNull] object sender, [NotNull] PopEventArgs e)
        {
            switch (e.Item)
            {
                ...
                case "addbuddy":
                    ...
                    {
                        this.PageContext.AddLoadMessage(
                            this.PageContext.Localization.GetText("NOTIFICATION_BUDDYREQUEST"));
                    }
