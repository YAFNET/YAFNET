        ...
        <table width="100%" class="content" cellspacing="1" cellpadding="4">
            ...
            <asp:PlaceHolder ID="PasswordResetErrorHolder" runat="server" Visible="false">
                <tr>
                    <td class="header2" colspan="2">
                        ...
                        Verify that "EnablePasswordReset" is "true" in your provider configuration settings
                        in the web.config.
                    </td>
                </tr>
            </asp:PlaceHolder>
            <tr>
                ...
                <td class="post">
                    <asp:RadioButtonList ID="rblPasswordResetFunction" runat="server" AutoPostBack="true"
                        ...
                        <asp:ListItem Selected="True" Text="Reset Password and Email New Password to User"
                            Value="reset" />
                        <asp:ListItem Text="Manually Change Password and Optionally Email New Password to User"
                            Value="change" />
                    </asp:RadioButtonList>
                </td>
            </tr>
            ...
            <asp:PlaceHolder ID="ChangePasswordHolder" runat="server" Visible="false">
                <tr>
                    ...
                    <td class="post" width="50%">
                        ...
                        <asp:RequiredFieldValidator ID="PasswordValidator" runat="server" ValidationGroup="passchange"
                            ErrorMessage="Must Enter New Password" ControlToValidate="txtNewPassword" SetFocusOnError="true"
                            Display="None" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="post" width="50%">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="passchange"
                            ErrorMessage="Must Enter a Confirm Password" ControlToValidate="txtConfirmPassword"
                            SetFocusOnError="true" Display="None" />
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ValidationGroup="passchange"
                            ErrorMessage="Confirmation password does not match" ControlToCompare="txtNewPassword"
                ...
                <tr>
                    <td class="postheader">
                        ...
                        Email the user a notification of their new password?
                    </td>
                    <td class="post" width="50%">
            ...
            <tr>
                <td class="postfooter" colspan="2" align="center">
                    <asp:Button ID="btnChangePassword" Visible="false" runat="server" Text="Change Password"
                        CssClass="pbutton" ValidationGroup="passchange" OnClick="btnChangePassword_Click"
                        CausesValidation="true" />
                    <asp:Button ID="btnResetPassword" runat="server" Text="Reset" CssClass="pbutton"
