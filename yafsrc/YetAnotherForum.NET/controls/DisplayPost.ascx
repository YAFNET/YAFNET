...
<tr class="postheader">		
	...
	<td width="80%" class="postPosted" colspan='<%#GetIndentSpan()%>'>
		...
		<div class="rightItem postedRight">
			<asp:HyperLink ID="ActionLink" runat="server" CssClass="yaflittlebutton PopMenuLink">Post Actions</asp:HyperLink>
			<YAF:PopupPanel id="Panel" runat="server" AttachToControl="ActionLink">            
...
<tr class="postsep">
	<td colspan="3">
		<YAF:PopMenu runat="server" ID="PopMenu1" AttachToControl="UserProfileLink" />
	</td>
</tr>
