    ...
    <div class="outerMenuContainer">
        <div class="menuMyContainer">
            <ul class="menuMyList">
                <% if (!this.PageContext.IsGuest)
                   {%>
                <li class="menuMy"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "MYPROFILE")%>"
                ...
                <% if (!this.PageContext.IsGuest && this.PageContext.BoardSettings.AllowPrivateMessages)
                   {%>
                <li class="menuMy"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "INBOX")%>"
                ...
                <%
                   ...
                   {%>
                <li class="menuMy"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "BUDDIES")%>"
                ...
                <%
                    ...
                    {%>
                <li class="menuMy"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "MYALBUMS")%>"
                ...
                <%if (!this.PageContext.IsGuest)
                  {%>
                <li class="menuMy"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "MYTOPICS")%>"
                ...
                <li class="menuAccount">
                    <asp:LinkButton ID="LogOutButton" runat="server" OnClick="LogOutClick"><%=this.PageContext.Localization.GetText("TOOLBAR", "LOGOUT")%></asp:LinkButton></li>
                <%
                    }    
                %>
            </ul>
    ...
    ,
        ...
        <div class="menuContainer">
            <ul class="menuList">
                ...
                <%if (this.PageContext.IsGuest)
                  {%>
                <li class="menuGeneral"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "ACTIVETOPICS")%>"
                    href="<%=YafBuildLink.GetLink(ForumPages.mytopics) %>">
                ...
                <%
                    ...
                    {%>
                <li class="menuGeneral"><a title="<%=this.PageContext.Localization.GetText("TOOLBAR", "MEMBERS")%>"
                    href="<%=YafBuildLink.GetLink(ForumPages.members)%>">
                    <%=this.PageContext.Localization.GetText("TOOLBAR", "MEMBERS")%></a> </li>
                <li class="menuGeneral"><a title="<%=this.PageContext.Localization.GetText("TOOLBAR", "TEAM")%>"
            ...
            <ul class="menuAdminList">
                <li class="menuAdmin"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "ADMIN")%>"
             ...
             {%>
                <li class="menuAdmin"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "HOST")%>"
                ...
                <%if (this.PageContext.IsModerator || this.PageContext.IsForumModerator)
                  {%>
                <li class="menuAdmin"><a target='_top' title="<%=this.PageContext.Localization.GetText("TOOLBAR", "MODERATE")%>"
