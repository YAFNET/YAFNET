        ...
        return this.each(function() {
            ...
            function changeSettings(newsettings) {
                ...
                if (value !== "") {
                    ...
                    elements.input.val(
                        settings.callback_after_calculation(parseFloat(value).toFixed(settings.decimals)));
                }
            }
                    ...
                    function(i, key) {
                        if (originalinput.is("[" + key + "]")) {
                            if (data[key] !== undefined) {
                                console.warn('Both the "data-bts-' +
                                    key +
            ...
            function _updateSettings(newsettings) {
                ...
                if (newsettings.postfix) {
                    ...
                    originalinput.parent().find(".bootstrap-touchspin-postfix .input-group-text")
                ...
                if (newsettings.prefix) {
                    ...
                    originalinput.parent().find(".bootstrap-touchspin-prefix .input-group-text")
            ...
            function _buildInputGroup() {
                ...
                if (settings.verticalbuttons) {
                    html = '<div class="input-group ' +
                        inputGroupSize +
                        ' bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-text">' +
                        settings.prefix +
                    ...
                    html = '<div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><button class="' +
                        settings.buttondown_class +
                        ' bootstrap-touchspin-down" type="button">' +
                        settings.buttondown_txt +
                        '</button><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"><span class="input-group-text">' +
                        settings.prefix +
            ...
            function _bindEvents() {
                originalinput.on("keydown.touchspin",
                    function(ev) {
                ...
                originalinput.on("blur.touchspin",
                    function() {
                        _checkValue();
                    });
                ...
                elements.up.on("keyup.touchspin",
                    function(ev) {
                        var code = ev.keyCode || ev.which;
                ...
                elements.down.on("mousemove.touchspin touchmove.touchspin",
                    function(ev) {
                        if (!spinning) {
                            return;
                        }
                ...
                originalinput.on("mousewheel.touchspin DOMMouseScroll.touchspin",
                    function(ev) {
            ...
            function _checkValue() {
                ...
                originalinput.val(
                    settings.callback_after_calculation(parseFloat(returnval).toFixed(settings.decimals)));
            }
