...
var yafEditor = function yafEditor(name) {
    this.Name = name;
};
        ...
        case "createlink":
            ...
            if (url != '' && url != null) {
                if (getCurrentSelection(textObj)) {
                    ...
                    if (desc != '' && desc != null) replaceSelection(textObj, '[url=' + url + ']' + desc + '[/url]');else replaceSelection(textObj, '[url]' + url + '[/url]');
                }
            }
            break;
        case "unorderedlist":
...
function Button_Over(img) {
    if (typeof img._enabled == "boolean" && !img._enabled) img.className = "ButtonOff";else img.className = "ButtonOver";
}

function Button_Out(img) {
    if (typeof img._enabled == "boolean" && !img._enabled) img.className = "ButtonOff";else if (typeof img._selected == "boolean" && img._selected) img.className = "ButtonChecked";else img.className = "ButtonOut";
}
...
function Button_SetState(doc, name, cmd) {
    ...
    if (!img._enabled) img.className = "ButtonOff";else if (img._selected) img.className = "ButtonChecked";else img.className = "ButtonOut";
}
...
function replaceSelection(input, replaceString) {
    if (input.setSelectionRange) {
        ...
        if (selectionStart != selectionEnd) // has there been a selection
            setSelectionRange(input, selectionStart, selectionStart + replaceString.length);else // set caret
