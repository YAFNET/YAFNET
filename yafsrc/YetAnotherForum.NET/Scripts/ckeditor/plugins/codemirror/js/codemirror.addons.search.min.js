...
onKeyDown:e})}function k(d,a,b,c,e){d.openDialog?d.openDialog(a,e,{value:c,selectValueOnOpen:!0}):e(prompt(b,c))}function t(d,a,b,c){d.openConfirm?d.openConfirm(a,c):confirm(b)&&c[0]()}function x(d){return d.replace(/\\([nrt\\])/g,function(d,a){return"n"==a?"\n":"r"==a?"\r":"t"==a?"\t":"\\"==a?"\\":d})}function y(d){var a=d.match(/^\/(.*)\/([a-z]*)$/);if(a)try{d=new RegExp(a[1],-1==a[2].indexOf("i")?"":"i")}catch(b){}else d=x(d);return("string"==typeof d?""==d:d.test(""))&&(d=/x^/),d}function m(d,
a,b){a.queryText=b;a.query=y(b);d.removeOverlay(a.overlay,n(a.query));a.overlay=z(a.query,n(a.query));d.addOverlay(a.overlay);d.showMatchesOnScrollbar&&(a.annotate&&(a.annotate.clear(),a.annotate=null),a.annotate=d.showMatchesOnScrollbar(a.query,n(a.query)))}function A(d,c,e,g){var f=p(d);if(f.query)return l(d,c);var h=d.getSelection()||f.lastQuery;if(h instanceof RegExp&&"x^"==h.source&&(h=null),e&&d.openDialog){var n=null,t=function(a,c){b.e_stop(c);a&&(a!=f.queryText&&(m(d,f,a),f.posFrom=f.posTo=
d.getCursor()),n&&(n.style.opacity=1),l(d,c.shiftKey,function(a,b){var c;3>b.line&&document.querySelector&&(c=d.display.wrapper.querySelector(".CodeMirror-dialog"))&&c.getBoundingClientRect().bottom-4>d.cursorCoords(b,"window").top&&((n=c).style.opacity=.4)}))};q(d,a(d),h,t,function(a,c){var f=b.keyName(a),e=d.getOption("extraKeys"),f=e&&e[f]||b.keyMap[d.getOption("keyMap")][f];"findNext"==f||"findPrev"==f||"findPersistentNext"==f||"findPersistentPrev"==f?(b.e_stop(a),m(d,p(d),c),d.execCommand(f)):
"find"!=f&&"findPersistent"!=f||(b.e_stop(a),t(c,a))});g&&h&&(m(d,f,h),l(d,c))}else k(d,a(d),"Search for:",h,function(a){a&&!f.query&&d.operation(function(){m(d,f,a);f.posFrom=f.posTo=d.getCursor();l(d,c)})})}function l(a,c,f){a.operation(function(){var e=p(a),g=h(a,e.query,c?e.posFrom:e.posTo);(g.find(c)||(g=h(a,e.query,c?b.Pos(a.lastLine()):b.Pos(a.firstLine(),0)),g.find(c)))&&(a.setSelection(g.from(),g.to()),a.scrollIntoView({from:g.from(),to:g.to()},20),e.posFrom=g.from(),e.posTo=g.to(),f&&f(g.from(),
g.to()))})}function g(a){a.operation(function(){var b=p(a);(b.lastQuery=b.query)&&(b.query=b.queryText=null,a.removeOverlay(b.overlay),b.annotate&&(b.annotate.clear(),b.annotate=null))})}function a(a){return'\x3cspan class\x3d"CodeMirror-search-label"\x3e'+a.phrase("Search:")+'\x3c/span\x3e \x3cinput type\x3d"text" style\x3d"width: 10em" class\x3d"CodeMirror-search-field"/\x3e \x3cspan style\x3d"color: #888" class\x3d"CodeMirror-search-hint"\x3e'+a.phrase("(Use /re/ syntax for regexp search)")+"\x3c/span\x3e"}
function c(a){return'\x3cspan class\x3d"CodeMirror-search-label"\x3e'+a.phrase("Replace?")+"\x3c/span\x3e \x3cbutton\x3e"+a.phrase("Yes")+"\x3c/button\x3e \x3cbutton\x3e"+a.phrase("No")+"\x3c/button\x3e \x3cbutton\x3e"+a.phrase("All")+"\x3c/button\x3e \x3cbutton\x3e"+a.phrase("Stop")+"\x3c/button\x3e "}function f(a,b,c){a.operation(function(){for(var f=h(a,b);f.findNext();)if("string"!=typeof b){var e=a.getRange(f.from(),f.to()).match(b);f.replace(c.replace(/\$(\d)/g,function(a,b){return e[b]}))}else f.replace(c)})}
function e(a,b){if(!a.getOption("readOnly")){var e=a.getSelection()||p(a).lastQuery,l='\x3cspan class\x3d"CodeMirror-search-label"\x3e'+(b?a.phrase("Replace all:"):a.phrase("Replace:"))+"\x3c/span\x3e";k(a,l+(' \x3cinput type\x3d"text" style\x3d"width: 10em" class\x3d"CodeMirror-search-field"/\x3e \x3cspan style\x3d"color: #888" class\x3d"CodeMirror-search-hint"\x3e'+a.phrase("(Use /re/ syntax for regexp search)")+"\x3c/span\x3e"),l,e,function(e){e&&(e=y(e),k(a,'\x3cspan class\x3d"CodeMirror-search-label"\x3e'+
a.phrase("With:")+'\x3c/span\x3e \x3cinput type\x3d"text" style\x3d"width: 10em" class\x3d"CodeMirror-search-field"/\x3e',a.phrase("Replace with:"),"",function(k){if(k=x(k),b)f(a,e,k);else{g(a);var l=h(a,e,a.getCursor("from")),m=function(){var b,g=l.from();!(b=l.findNext())&&(l=h(a,e),!(b=l.findNext())||g&&l.from().line==g.line&&l.from().ch==g.ch)||(a.setSelection(l.from(),l.to()),a.scrollIntoView({from:l.from(),to:l.to()}),t(a,c(a),a.phrase("Replace?"),[function(){n(b)},m,function(){f(a,e,k)}]))},
n=function(a){l.replace("string"==typeof e?k:k.replace(/\$(\d)/g,function(b,d){return a[d]}));m()};m()}}))})}}b.commands.find=function(a){g(a);A(a)};b.commands.findPersistent=function(a){g(a);A(a,!1,!0)};b.commands.findPersistentNext=function(a){A(a,!1,!0,!0)};b.commands.findPersistentPrev=function(a){A(a,!0,!0,!0)};b.commands.findNext=A;b.commands.findPrev=function(a){A(a,!0)};b.commands.clearSearch=g;b.commands.replace=e;b.commands.replaceAll=function(a){e(a,!0)}});
(function(b){"function"==typeof b.define&&b.define("addonSearch",["addon/search/search.js"],function(){})})(this);