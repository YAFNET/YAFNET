...
F&&(a.state=t)},xmlCurrentTag:function(a){return a.tagName?{name:a.tagName,close:"closeTag"==a.type}:null},xmlCurrentContext:function(a){var b=[];for(a=a.context;a;a=a.prev)a.tagName&&b.push(a.tagName);return b.reverse()}}});b.defineMIME("text/xml","xml");b.defineMIME("application/xml","xml");b.mimeModes.hasOwnProperty("text/html")||b.defineMIME("text/html",{name:"xml",htmlMode:!0})});(function(b){"function"==typeof b.define&&b.define("modeHandlebars",["mode/handlebars/handlebars.js"],function(){})})(this);