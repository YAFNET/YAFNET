...
CKEDITOR.htmlDataProcessor.prototype =
{
    toHtml: function(data, fixForBody) {
        ...
        // [attach]
        data = data.replace(/\[attach\](.+?)\[\/attach]/gi, '<a href="resource.ashx?i=$1" class="attachedImage" data-gallery><img src="resource.ashx?p=$1" alt="Attached Image" class="img-user-posted img-thumbnail" /></a>');
