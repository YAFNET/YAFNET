"use strict";function escape(n){var t=n;return t=t.replace(/&/g,"&amp;"),t=t.replace(/</g,"&lt;"),t=t.replace(/>/g,"&gt;"),t.replace(/"/g,"&quot;")}function diffString(n,t){var f,r,o;n=n.replace(/\s+$/,"");t=t.replace(/\s+$/,"");var i=diff(n==""?[]:n.split(/\s+/),t==""?[]:t.split(/\s+/)),e="",u=n.match(/\s+/g);if(u==null?u=["\n"]:u.push("\n"),f=t.match(/\s+/g),f==null?f=["\n"]:f.push("\n"),i.n.length==0)for(r=0;r<i.o.length;r++)e+="<del>"+escape(i.o[r])+u[r]+"<\/del>";else{if(i.n[0].text==null)for(t=0;t<i.o.length&&i.o[t].text==null;t++)e+="<del>"+escape(i.o[t])+u[t]+"<\/del>";for(r=0;r<i.n.length;r++)if(i.n[r].text==null)e+="<ins>"+escape(i.n[r])+f[r]+"<\/ins>";else{for(o="",t=i.n[r].row+1;t<i.o.length&&i.o[t].text==null;t++)o+="<del>"+escape(i.o[t])+u[t]+"<\/del>";e+=" "+i.n[r].text+f[r]+o}}return e}function randomColor(){return"rgb("+Math.random()*100+"%, "+Math.random()*100+"%, "+Math.random()*100+"%)"}function diffString2(n,t){var r,u,f,e,s,o,i;for(n=n.replace(/\s+$/,""),t=t.replace(/\s+$/,""),r=diff(n==""?[]:n.split(/\s+/),t==""?[]:t.split(/\s+/)),u=n.match(/\s+/g),u==null?u=["\n"]:u.push("\n"),f=t.match(/\s+/g),f==null?f=["\n"]:f.push("\n"),e="",s=[],i=0;i<r.o.length;i++)s[i]=randomColor(),e+=r.o[i].text!=null?escape(r.o[i].text)+u[i]:"<del>"+escape(r.o[i])+u[i]+"<\/del>";for(o="",i=0;i<r.n.length;i++)o+=r.n[i].text!=null?escape(r.n[i].text)+f[i]:"<ins>"+escape(r.n[i])+f[i]+"<\/ins>";return{o:e,n:o}}function diff(n,t){for(var r={},u={},i=0;i<t.length;i++)r[t[i]]==null&&(r[t[i]]={rows:[],o:null}),r[t[i]].rows.push(i);for(i=0;i<n.length;i++)u[n[i]]==null&&(u[n[i]]={rows:[],n:null}),u[n[i]].rows.push(i);for(i in r)r[i].rows.length==1&&typeof u[i]!="undefined"&&u[i].rows.length==1&&(t[r[i].rows[0]]={text:t[r[i].rows[0]],row:u[i].rows[0]},n[u[i].rows[0]]={text:n[u[i].rows[0]],row:r[i].rows[0]});for(i=0;i<t.length-1;i++)t[i].text!=null&&t[i+1].text==null&&t[i].row+1<n.length&&n[t[i].row+1].text==null&&t[i+1]==n[t[i].row+1]&&(t[i+1]={text:t[i+1],row:t[i].row+1},n[t[i].row+1]={text:n[t[i].row+1],row:i+1});for(i=t.length-1;i>0;i--)t[i].text!=null&&t[i-1].text==null&&t[i].row>0&&n[t[i].row-1].text==null&&t[i-1]==n[t[i].row-1]&&(t[i-1]={text:t[i-1],row:t[i].row-1},n[t[i].row-1]={text:n[t[i].row-1],row:i-1});return{o:n,n:t}}function DataPanel_ExpandCollapse(n,t,i,r,u,f){document.getElementById(n).style.display==""?(document.getElementById(n).style.display="none",t!=""&&(document.getElementById(t).title=f),document.getElementById(i)!=null&&(document.getElementById(i).innerHTML=f,document.getElementById(i).title=f),document.getElementById(r).value="true"):(document.getElementById(n).style.display="",t!=""&&(document.getElementById(t).title=u),document.getElementById(i)!=null&&(document.getElementById(i).innerHTML=u,document.getElementById(i).title=u),document.getElementById(r).value="false")}function DataPanel_ExpandCollapseImage(n,t,i,r,u,f,e,o){var s=document.getElementById(i).getElementsByTagName("img");document.getElementById(n).style.display==""?(document.getElementById(n).style.display="none",t!=""&&(document.getElementById(t).title=o),s[0].src=u,s[0].alt=o,s[0].title=o,document.getElementById(r).value="true"):(document.getElementById(n).style.display="",t!=""&&(document.getElementById(t).title=e),s[0].src=f,s[0].alt=e,s[0].title=o,document.getElementById(r).value="false")}function ScrollToTop(){return jQuery("body,html").animate({scrollTop:0},820),!1}function toggleContainer(n,t,i,r){var f=jQuery("#"+n),u=jQuery("#"+t);f.toggle(function(){u.attr("title",r);u.html(r);u.addClass("hide")},function(){u.attr("title",i);u.html(i);u.addClass("show")})}function getEvent(n){return n.stopPropagation?(n.stopPropagation(),n.preventDefault(),n):(window.event.returnValue=!1,window.event.cancelBubble=!0,window.event)}function yaf_mouseover(){var n=getEvent(window.event);n.srcElement?n.srcElement.style.cursor="hand":n.target&&(n.target.style.cursor="pointer")}function yaf_left(n){return jQuery(n).position().left}function yaf_top(n){return jQuery(n).position().top+jQuery(n).outerHeight()+1}function yaf_popit(n){var t=getEvent(window.event),i,u,r;if(!document.getElementById)throw"ERROR: missing getElementById";if(t.srcElement)i=t.srcElement;else if(t.target)i=t.target;else throw"ERROR: missing event target";if(u=document.getElementById(n),window.themenu&&window.themenu.id!=u.id&&yaf_hidemenu(),window.themenu=u,!window.themenu.style)throw"ERROR: missing style";return jQuery(themenu).is(":visible")?yaf_hidemenu():(r=yaf_left(i),r+jQuery(themenu).outerWidth()+2>jQuery(document).width()&&(r=jQuery(document).width()-jQuery(themenu).outerWidth()-2),themenu.style.left=r+"px",themenu.style.top=yaf_top(i)+"px",themenu.style.zIndex=100,jQuery(themenu).fadeIn()),!1}function yaf_hidemenu(){window.themenu&&(jQuery(window.themenu).fadeOut(),window.themenu=null)}function mouseHover(n,t){if(t){n.className="popupitemhover";try{n.style.cursor="pointer"}catch(i){n.style.cursor="hand"}}else n.className="popupitem"}function formatState(n){if(!n.id||$($(n.element).data("content")).length===0)return n.text;return $($(n.element).data("content"))}function doClick(n,t){var r,i;r=window.event?window.event.keyCode:t.which;r==13&&(i=document.getElementById(n),i!=null&&(t.preventDefault(),i.click(),event.keyCode=0))}function toggleNewSelection(n){var t=n.checked;$("input[id*='New']").each(function(){$(this).attr("checked",!1)});n.checked=t}function toggleOldSelection(n){var t=n.checked;$("input[id*='Old']").each(function(){$(this).attr("checked",!1)});n.checked=t}function RenderMessageDiff(n,t,i,r){var u=$("input[id*='New']:checked"),f=$("input[id*='Old']:checked");if(f.length&&u.length)if($("input[id*='Old']:checked").attr("id").slice(-1)==$("input[id*='New']:checked").attr("id").slice(-1))alert(r);else{var e=difflib.stringAsLines($("input[id*='Old']:checked").parent().next().next().find("input[id*='MessageField']").attr("value")),o=difflib.stringAsLines($("input[id*='New']:checked").parent().next().find("input[id*='MessageField']").attr("value")),s=new difflib.SequenceMatcher(e,o),h=s.get_opcodes();$("#diffContent").html('<div class="diffContent">'+diffview.buildView({baseTextLines:e,newTextLines:o,opcodes:h,baseTextName:n+u.parent().next().next().next().next().html(),newTextName:n+u.parent().next().next().next().next().html(),contextSize:3,viewType:0}).outerHTML+"<\/div>")}else f.length||u.length?alert(i):alert(t)}function getPaginationData(n,t,i){var r=$("#PostAttachmentListPlaceholder").data("userid"),u="{userID:"+r+", pageSize:"+n+",pageNumber:"+t+"}",f=$("#PostAttachmentListPlaceholder").data("url")+"YafAjax.asmx/GetAttachments";$.ajax({type:"POST",url:f,data:u,contentType:"application/json; charset=utf-8",dataType:"json",success:function(r){if($("#PostAttachmentListPlaceholder ul").empty(),$("#PostAttachmentLoader").hide(),r.d.AttachmentList.length===0){var u=$("#PostAttachmentListPlaceholder ul"),f=$("#PostAttachmentListPlaceholder").data("notext");u.append("<li><em>"+f+"<\/em><\/li>")}$.each(r.d.AttachmentList,function(n,t){var r=$("#PostAttachmentListPlaceholder ul"),i=$('<li class="popupitem" onmouseover="mouseHover(this,true)" onmouseout="mouseHover(this,false)" style="white-space: nowrap; cursor: pointer;" />');i.attr("onclick",t.OnClick);t.DataURL&&(i.attr("title",'<img src="'+t.DataURL+'" style="max-width:200px" />'),i.attr("data-toggle","tooltip"));i.append(t.IconImage);r.append(i)});setPageNumber(n,t,r.d.TotalRecords);i&&(jQuery(".attachments-toggle").dropdown("toggle"),jQuery('[data-toggle="tooltip"]').tooltip({html:!0,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"><\/div><div class="tooltip-inner" style="max-width:250px"><\/div><\/div>',placement:"top"}))},error:function(n){$("#PostAttachmentLoader").hide();$("#PostAttachmentListPlaceholder").html(n.statusText).fadeIn(1e3)}})}function setPageNumber(n,t,i){var f=Math.ceil(i/n),s=$("#AttachmentsListPager"),r=$('<ul class="pagination-sm" />'),e,o,u;for(s.empty(),t>0&&r.append('<li class="page-item"><a href="javascript:getPaginationData('+n+","+(t-1)+","+i+',true)" class="page-link">&laquo;<\/a><\/li>'),e=t-2,o=t+3,e<0&&(e=0),o>f&&(o=f),e>0&&(r.append('<a href="javascript:getPaginationData('+n+",0,"+i+', true)">1<\/a>'),r.append("<span>...<\/span>")),u=e;u<o;u++)u===t?r.append('<li class="page-item active"><span class="page-link">'+(u+1)+"<\/span>"):r.append('<li class="page-item"><a href="javascript:getPaginationData('+n+","+u+","+i+',true);" class="page-link">'+(u+1)+"<\/a><\/li>");o<f&&(r.append("<span>...<\/span>"),r.append('<li class="page-item"><a href="javascript:getPaginationData('+n+","+(f-1)+","+i+',true)" class="page-link">'+f+"<\/a><\/li>"));t<f-1&&r.append('<li class="page-item"><a href="javascript:getPaginationData('+n+","+(t+1)+","+i+',true)" class="page-link">&raquo;<\/a><\/li>');s.append(r)}function AttachmentsPageSelectCallback(n){var t=jQuery("#AttachmentsPagerHidden div.result:eq("+n+")").clone();return jQuery("#AttachmentsPagerResult").empty().append(t),!1}(function(n,t){typeof exports=="object"&&typeof module!="undefined"?module.exports=t():typeof define=="function"&&define.amd?define(t):n.moment=t()})(undefined,function(){function n(){return po.apply(null,arguments)}function fv(n){po=n}function fi(n){return n instanceof Array||Object.prototype.toString.call(n)==="[object Array]"}function su(n){return n!=null&&Object.prototype.toString.call(n)==="[object Object]"}function ev(n){for(var t in n)return!1;return!0}function pi(n){return typeof n=="number"||Object.prototype.toString.call(n)==="[object Number]"}function hu(n){return n instanceof Date||Object.prototype.toString.call(n)==="[object Date]"}function wo(n,t){for(var r=[],i=0;i<n.length;++i)r.push(t(n[i],i));return r}function l(n,t){return Object.prototype.hasOwnProperty.call(n,t)}function ei(n,t){for(var i in t)l(t,i)&&(n[i]=t[i]);return l(t,"toString")&&(n.toString=t.toString),l(t,"valueOf")&&(n.valueOf=t.valueOf),n}function at(n,t,i,r){return tc(n,t,i,r,!0).utc()}function ov(){return{empty:!1,unusedTokens:[],unusedInput:[],overflow:-2,charsLeftOver:0,nullInput:!1,invalidMonth:null,invalidFormat:!1,userInvalidated:!1,iso:!1,parsedDateParts:[],meridiem:null}}function u(n){return n._pf==null&&(n._pf=ov()),n._pf}function df(n){if(n._isValid==null){var t=u(n),r=ko.call(t.parsedDateParts,function(n){return n!=null}),i=!isNaN(n._d.getTime())&&t.overflow<0&&!t.empty&&!t.invalidMonth&&!t.invalidWeekday&&!t.nullInput&&!t.invalidFormat&&!t.userInvalidated&&(!t.meridiem||t.meridiem&&r);if(n._strict&&(i=i&&t.charsLeftOver===0&&t.unusedTokens.length===0&&t.bigHour===undefined),Object.isFrozen!=null&&Object.isFrozen(n))return i;n._isValid=i}return n._isValid}function cu(n){var t=at(NaN);return n!=null?ei(u(t),n):u(t).userInvalidated=!0,t}function b(n){return n===void 0}function gf(n,t){var f,i,r;if(b(t._isAMomentObject)||(n._isAMomentObject=t._isAMomentObject),b(t._i)||(n._i=t._i),b(t._f)||(n._f=t._f),b(t._l)||(n._l=t._l),b(t._strict)||(n._strict=t._strict),b(t._tzm)||(n._tzm=t._tzm),b(t._isUTC)||(n._isUTC=t._isUTC),b(t._offset)||(n._offset=t._offset),b(t._pf)||(n._pf=u(t)),b(t._locale)||(n._locale=t._locale),lu.length>0)for(f in lu)i=lu[f],r=t[i],b(r)||(n[i]=r);return n}function vr(t){gf(this,t);this._d=new Date(t._d!=null?t._d.getTime():NaN);this.isValid()||(this._d=new Date(NaN));au===!1&&(au=!0,n.updateOffset(this),au=!1)}function oi(n){return n instanceof vr||n!=null&&n._isAMomentObject!=null}function k(n){return n<0?Math.ceil(n)||0:Math.floor(n)}function f(n){var t=+n,i=0;return t!==0&&isFinite(t)&&(i=k(t)),i}function go(n,t,i){for(var e=Math.min(n.length,t.length),o=Math.abs(n.length-t.length),u=0,r=0;r<e;r++)(i&&n[r]!==t[r]||!i&&f(n[r])!==f(t[r]))&&u++;return u+o}function ns(t){n.suppressDeprecationWarnings===!1&&typeof console!="undefined"&&console.warn&&console.warn("Deprecation warning: "+t)}function d(t,i){var r=!0;return ei(function(){var e,u,f,o;if(n.deprecationHandler!=null&&n.deprecationHandler(null,t),r){for(e=[],f=0;f<arguments.length;f++){if(u="",typeof arguments[f]=="object"){u+="\n["+f+"] ";for(o in arguments[0])u+=o+": "+arguments[0][o]+", ";u=u.slice(0,-2)}else u=arguments[f];e.push(u)}ns(t+"\nArguments: "+Array.prototype.slice.call(e).join("")+"\n"+(new Error).stack);r=!1}return i.apply(this,arguments)},i)}function ts(t,i){n.deprecationHandler!=null&&n.deprecationHandler(t,i);ne[t]||(ns(i),ne[t]=!0)}function vt(n){return n instanceof Function||Object.prototype.toString.call(n)==="[object Function]"}function sv(n){var t;for(var i in n)t=n[i],vt(t)?this[i]=t:this["_"+i]=t;this._config=n;this._ordinalParseLenient=new RegExp(this._ordinalParse.source+"|"+/\d{1,2}/.source)}function is(n,t){var r=ei({},n);for(var i in t)l(t,i)&&(su(n[i])&&su(t[i])?(r[i]={},ei(r[i],n[i]),ei(r[i],t[i])):t[i]!=null?r[i]=t[i]:delete r[i]);for(i in n)l(n,i)&&!l(t,i)&&su(n[i])&&(r[i]=ei({},r[i]));return r}function te(n){n!=null&&this.set(n)}function hv(n,t,i){var r=this._calendar[n]||this._calendar.sameElse;return vt(r)?r.call(t,i):r}function cv(n){var t=this._longDateFormat[n],i=this._longDateFormat[n.toUpperCase()];return t||!i?t:(this._longDateFormat[n]=i.replace(/MMMM|MM|DD|dddd/g,function(n){return n.slice(1)}),this._longDateFormat[n])}function lv(){return this._invalidDate}function av(n){return this._ordinal.replace("%d",n)}function vv(n,t,i,r){var u=this._relativeTime[i];return vt(u)?u(n,t,i,r):u.replace(/%d/i,n)}function yv(n,t){var i=this._relativeTime[n>0?"future":"past"];return vt(i)?i(t):i.replace(/%s/i,t)}function p(n,t){var i=n.toLowerCase();rr[i]=rr[i+"s"]=rr[t]=n}function g(n){return typeof n=="string"?rr[n]||rr[n.toLowerCase()]:undefined}function ie(n){var r={},t;for(var i in n)l(n,i)&&(t=g(i),t&&(r[t]=n[i]));return r}function w(n,t){re[n]=t}function pv(n){var t=[];for(var i in n)t.push({unit:i,priority:re[i]});return t.sort(function(n,t){return n.priority-t.priority}),t}function ur(t,i){return function(r){return r!=null?(ls(this,t,r),n.updateOffset(this,i),this):vu(this,t)}}function vu(n,t){return n.isValid()?n._d["get"+(n._isUTC?"UTC":"")+t]():NaN}function ls(n,t,i){n.isValid()&&n._d["set"+(n._isUTC?"UTC":"")+t](i)}function wv(n){return(n=g(n),vt(this[n]))?this[n]():this}function bv(n,t){var r,i;if(typeof n=="object")for(n=ie(n),r=pv(n),i=0;i<r.length;i++)this[r[i].unit](n[r[i].unit]);else if(n=g(n),vt(this[n]))return this[n](t);return this}function ni(n,t,i){var r=""+Math.abs(n),u=t-r.length,f=n>=0;return(f?i?"+":"":"-")+Math.pow(10,Math.max(0,u)).toString().substr(1)+r}function r(n,t,i,r){var u=r;typeof r=="string"&&(u=function(){return this[r]()});n&&(fr[n]=u);t&&(fr[t[0]]=function(){return ni(u.apply(this,arguments),t[1],t[2])});i&&(fr[i]=function(){return this.localeData().ordinal(u.apply(this,arguments),n)})}function kv(n){return n.match(/\[[\s\S]/)?n.replace(/^\[|\]$/g,""):n.replace(/\\/g,"")}function dv(n){for(var t=n.match(as),i=0,r=t.length;i<r;i++)t[i]=fr[t[i]]?fr[t[i]]:kv(t[i]);return function(i){for(var f="",u=0;u<r;u++)f+=t[u]instanceof Function?t[u].call(i,n):t[u];return f}}function fe(n,t){return n.isValid()?(t=vs(t,n.localeData()),ue[t]=ue[t]||dv(t),ue[t](n)):n.localeData().invalidDate()}function vs(n,t){function r(n){return t.longDateFormat(n)||n}var i=5;for(yu.lastIndex=0;i>=0&&yu.test(n);)n=n.replace(yu,r),yu.lastIndex=0,i-=1;return n}function i(n,t,i){se[n]=vt(t)?t:function(n){return n&&i?i:t}}function ny(n,t){return l(se,n)?se[n](t._strict,t._locale):new RegExp(ty(n))}function ty(n){return wi(n.replace("\\","").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,function(n,t,i,r,u){return t||i||r||u}))}function wi(n){return n.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}function s(n,t){var i,r=t;for(typeof n=="string"&&(n=[n]),pi(t)&&(r=function(n,i){i[t]=f(n)}),i=0;i<n.length;i++)gu[n[i]]=r}function pr(n,t){s(n,function(n,i,r,u){r._w=r._w||{};t(n,r._w,r,u)})}function iy(n,t,i){t!=null&&l(gu,n)&&gu[n](t,i._a,i,n)}function he(n,t){return new Date(Date.UTC(n,t+1,0)).getUTCDate()}function fy(n,t){return n?fi(this._months)?this._months[n.month()]:this._months[(this._months.isFormat||ce).test(t)?"format":"standalone"][n.month()]:this._months}function ey(n,t){return n?fi(this._monthsShort)?this._monthsShort[n.month()]:this._monthsShort[ce.test(t)?"format":"standalone"][n.month()]:this._monthsShort}function oy(n,t,i){var u,r,e,f=n.toLocaleLowerCase();if(!this._monthsParse)for(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[],u=0;u<12;++u)e=at([2e3,u]),this._shortMonthsParse[u]=this.monthsShort(e,"").toLocaleLowerCase(),this._longMonthsParse[u]=this.months(e,"").toLocaleLowerCase();return i?t==="MMM"?(r=v.call(this._shortMonthsParse,f),r!==-1?r:null):(r=v.call(this._longMonthsParse,f),r!==-1?r:null):t==="MMM"?(r=v.call(this._shortMonthsParse,f),r!==-1)?r:(r=v.call(this._longMonthsParse,f),r!==-1?r:null):(r=v.call(this._longMonthsParse,f),r!==-1)?r:(r=v.call(this._shortMonthsParse,f),r!==-1?r:null)}function sy(n,t,i){var r,u,f;if(this._monthsParseExact)return oy.call(this,n,t,i);for(this._monthsParse||(this._monthsParse=[],this._longMonthsParse=[],this._shortMonthsParse=[]),r=0;r<12;r++)if((u=at([2e3,r]),i&&!this._longMonthsParse[r]&&(this._longMonthsParse[r]=new RegExp("^"+this.months(u,"").replace(".","")+"$","i"),this._shortMonthsParse[r]=new RegExp("^"+this.monthsShort(u,"").replace(".","")+"$","i")),i||this._monthsParse[r]||(f="^"+this.months(u,"")+"|^"+this.monthsShort(u,""),this._monthsParse[r]=new RegExp(f.replace(".",""),"i")),i&&t==="MMMM"&&this._longMonthsParse[r].test(n))||i&&t==="MMM"&&this._shortMonthsParse[r].test(n)||!i&&this._monthsParse[r].test(n))return r}function nh(n,t){var i;if(!n.isValid())return n;if(typeof t=="string")if(/^\d+$/.test(t))t=f(t);else if(t=n.localeData().monthsParse(t),!pi(t))return n;return i=Math.min(n.date(),he(n.year(),t)),n._d["set"+(n._isUTC?"UTC":"")+"Month"](t,i),n}function th(t){return t!=null?(nh(this,t),n.updateOffset(this,!0),this):vu(this,"Month")}function hy(){return he(this.year(),this.month())}function cy(n){return this._monthsParseExact?(l(this,"_monthsRegex")||uh.call(this),n?this._monthsShortStrictRegex:this._monthsShortRegex):(l(this,"_monthsShortRegex")||(this._monthsShortRegex=ih),this._monthsShortStrictRegex&&n?this._monthsShortStrictRegex:this._monthsShortRegex)}function ly(n){return this._monthsParseExact?(l(this,"_monthsRegex")||uh.call(this),n?this._monthsStrictRegex:this._monthsRegex):(l(this,"_monthsRegex")||(this._monthsRegex=rh),this._monthsStrictRegex&&n?this._monthsStrictRegex:this._monthsRegex)}function uh(){function f(n,t){return t.length-n.length}for(var i=[],r=[],t=[],u,n=0;n<12;n++)u=at([2e3,n]),i.push(this.monthsShort(u,"")),r.push(this.months(u,"")),t.push(this.months(u,"")),t.push(this.monthsShort(u,""));for(i.sort(f),r.sort(f),t.sort(f),n=0;n<12;n++)i[n]=wi(i[n]),r[n]=wi(r[n]);for(n=0;n<24;n++)t[n]=wi(t[n]);this._monthsRegex=new RegExp("^("+t.join("|")+")","i");this._monthsShortRegex=this._monthsRegex;this._monthsStrictRegex=new RegExp("^("+r.join("|")+")","i");this._monthsShortStrictRegex=new RegExp("^("+i.join("|")+")","i")}function wr(n){return fh(n)?366:365}function fh(n){return n%4==0&&n%100!=0||n%400==0}function ay(){return fh(this.year())}function vy(n,t,i,r,u,f,e){var o=new Date(n,t,i,r,u,f,e);return n<100&&n>=0&&isFinite(o.getFullYear())&&o.setFullYear(n),o}function nf(n){var t=new Date(Date.UTC.apply(null,arguments));return n<100&&n>=0&&isFinite(t.getUTCFullYear())&&t.setUTCFullYear(n),t}function tf(n,t,i){var r=7+t-i,u=(7+nf(n,0,r).getUTCDay()-t)%7;return-u+r-1}function eh(n,t,i,r,u){var s=(7+i-r)%7,h=tf(n,r,u),f=1+7*(t-1)+s+h,e,o;return f<=0?(e=n-1,o=wr(e)+f):f>wr(n)?(e=n+1,o=f-wr(n)):(e=n,o=f),{year:e,dayOfYear:o}}function br(n,t,i){var e=tf(n.year(),t,i),r=Math.floor((n.dayOfYear()-e-1)/7)+1,f,u;return r<1?(u=n.year()-1,f=r+ki(u,t,i)):r>ki(n.year(),t,i)?(f=r-ki(n.year(),t,i),u=n.year()+1):(u=n.year(),f=r),{week:f,year:u}}function ki(n,t,i){var r=tf(n,t,i),u=tf(n+1,t,i);return(wr(n)-r+u)/7}function yy(n){return br(n,this._week.dow,this._week.doy).week}function py(){return this._week.dow}function wy(){return this._week.doy}function by(n){var t=this.localeData().week(this);return n==null?t:this.add((n-t)*7,"d")}function ky(n){var t=br(this,1,4).week;return n==null?t:this.add((n-t)*7,"d")}function dy(n,t){return typeof n!="string"?n:isNaN(n)?(n=t.weekdaysParse(n),typeof n=="number")?n:null:parseInt(n,10)}function gy(n,t){return typeof n=="string"?t.weekdaysParse(n)%7||7:isNaN(n)?null:n}function np(n,t){return n?fi(this._weekdays)?this._weekdays[n.day()]:this._weekdays[this._weekdays.isFormat.test(t)?"format":"standalone"][n.day()]:this._weekdays}function tp(n){return n?this._weekdaysShort[n.day()]:this._weekdaysShort}function ip(n){return n?this._weekdaysMin[n.day()]:this._weekdaysMin}function rp(n,t,i){var f,r,e,u=n.toLocaleLowerCase();if(!this._weekdaysParse)for(this._weekdaysParse=[],this._shortWeekdaysParse=[],this._minWeekdaysParse=[],f=0;f<7;++f)e=at([2e3,1]).day(f),this._minWeekdaysParse[f]=this.weekdaysMin(e,"").toLocaleLowerCase(),this._shortWeekdaysParse[f]=this.weekdaysShort(e,"").toLocaleLowerCase(),this._weekdaysParse[f]=this.weekdays(e,"").toLocaleLowerCase();return i?t==="dddd"?(r=v.call(this._weekdaysParse,u),r!==-1?r:null):t==="ddd"?(r=v.call(this._shortWeekdaysParse,u),r!==-1?r:null):(r=v.call(this._minWeekdaysParse,u),r!==-1?r:null):t==="dddd"?(r=v.call(this._weekdaysParse,u),r!==-1)?r:(r=v.call(this._shortWeekdaysParse,u),r!==-1)?r:(r=v.call(this._minWeekdaysParse,u),r!==-1?r:null):t==="ddd"?(r=v.call(this._shortWeekdaysParse,u),r!==-1)?r:(r=v.call(this._weekdaysParse,u),r!==-1)?r:(r=v.call(this._minWeekdaysParse,u),r!==-1?r:null):(r=v.call(this._minWeekdaysParse,u),r!==-1)?r:(r=v.call(this._weekdaysParse,u),r!==-1)?r:(r=v.call(this._shortWeekdaysParse,u),r!==-1?r:null)}function up(n,t,i){var r,u,f;if(this._weekdaysParseExact)return rp.call(this,n,t,i);for(this._weekdaysParse||(this._weekdaysParse=[],this._minWeekdaysParse=[],this._shortWeekdaysParse=[],this._fullWeekdaysParse=[]),r=0;r<7;r++)if((u=at([2e3,1]).day(r),i&&!this._fullWeekdaysParse[r]&&(this._fullWeekdaysParse[r]=new RegExp("^"+this.weekdays(u,"").replace(".",".?")+"$","i"),this._shortWeekdaysParse[r]=new RegExp("^"+this.weekdaysShort(u,"").replace(".",".?")+"$","i"),this._minWeekdaysParse[r]=new RegExp("^"+this.weekdaysMin(u,"").replace(".",".?")+"$","i")),this._weekdaysParse[r]||(f="^"+this.weekdays(u,"")+"|^"+this.weekdaysShort(u,"")+"|^"+this.weekdaysMin(u,""),this._weekdaysParse[r]=new RegExp(f.replace(".",""),"i")),i&&t==="dddd"&&this._fullWeekdaysParse[r].test(n))||i&&t==="ddd"&&this._shortWeekdaysParse[r].test(n)||i&&t==="dd"&&this._minWeekdaysParse[r].test(n)||!i&&this._weekdaysParse[r].test(n))return r}function fp(n){if(!this.isValid())return n!=null?this:NaN;var t=this._isUTC?this._d.getUTCDay():this._d.getDay();return n!=null?(n=dy(n,this.localeData()),this.add(n-t,"d")):t}function ep(n){if(!this.isValid())return n!=null?this:NaN;var t=(this.day()+7-this.localeData()._week.dow)%7;return n==null?t:this.add(n-t,"d")}function op(n){if(!this.isValid())return n!=null?this:NaN;if(n!=null){var t=gy(n,this.localeData());return this.day(this.day()%7?t:t-7)}return this.day()||7}function sp(n){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||ae.call(this),n?this._weekdaysStrictRegex:this._weekdaysRegex):(l(this,"_weekdaysRegex")||(this._weekdaysRegex=lh),this._weekdaysStrictRegex&&n?this._weekdaysStrictRegex:this._weekdaysRegex)}function hp(n){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||ae.call(this),n?this._weekdaysShortStrictRegex:this._weekdaysShortRegex):(l(this,"_weekdaysShortRegex")||(this._weekdaysShortRegex=ah),this._weekdaysShortStrictRegex&&n?this._weekdaysShortStrictRegex:this._weekdaysShortRegex)}function cp(n){return this._weekdaysParseExact?(l(this,"_weekdaysRegex")||ae.call(this),n?this._weekdaysMinStrictRegex:this._weekdaysMinRegex):(l(this,"_weekdaysMinRegex")||(this._weekdaysMinRegex=vh),this._weekdaysMinStrictRegex&&n?this._weekdaysMinStrictRegex:this._weekdaysMinRegex)}function ae(){function u(n,t){return t.length-n.length}for(var e=[],i=[],r=[],t=[],f,o,s,h,n=0;n<7;n++)f=at([2e3,1]).day(n),o=this.weekdaysMin(f,""),s=this.weekdaysShort(f,""),h=this.weekdays(f,""),e.push(o),i.push(s),r.push(h),t.push(o),t.push(s),t.push(h);for(e.sort(u),i.sort(u),r.sort(u),t.sort(u),n=0;n<7;n++)i[n]=wi(i[n]),r[n]=wi(r[n]),t[n]=wi(t[n]);this._weekdaysRegex=new RegExp("^("+t.join("|")+")","i");this._weekdaysShortRegex=this._weekdaysRegex;this._weekdaysMinRegex=this._weekdaysRegex;this._weekdaysStrictRegex=new RegExp("^("+r.join("|")+")","i");this._weekdaysShortStrictRegex=new RegExp("^("+i.join("|")+")","i");this._weekdaysMinStrictRegex=new RegExp("^("+e.join("|")+")","i")}function ve(){return this.hours()%12||12}function lp(){return this.hours()||24}function yh(n,t){r(n,0,0,function(){return this.localeData().meridiem(this.hours(),this.minutes(),t)})}function ph(n,t){return t._meridiemParse}function ap(n){return(n+"").toLowerCase().charAt(0)==="p"}function vp(n,t,i){return n>11?i?"pm":"PM":i?"am":"AM"}function kh(n){return n?n.toLowerCase().replace("_","-"):n}function pp(n){for(var r=0,i,t,f,u;r<n.length;){for(u=kh(n[r]).split("-"),i=u.length,t=kh(n[r+1]),t=t?t.split("-"):null;i>0;){if(f=dh(u.slice(0,i).join("-")),f)return f;if(t&&t.length>=i&&go(u,t,!0)>=i-1)break;i--}r++}return null}function dh(n){var t=null;if(!a[n]&&typeof module!="undefined"&&module&&module.exports)try{t=rf._abbr;require("./locale/"+n);er(t)}catch(i){}return a[n]}function er(n,t){var i;return n&&(i=b(t)?si(n):ye(n,t),i&&(rf=i)),rf._abbr}function ye(n,t){if(t!==null){var i=bh;if(t.abbr=n,a[n]!=null)ts("defineLocaleOverride","use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."),i=a[n]._config;else if(t.parentLocale!=null)if(a[t.parentLocale]!=null)i=a[t.parentLocale]._config;else return kr[t.parentLocale]||(kr[t.parentLocale]=[]),kr[t.parentLocale].push({name:n,config:t}),null;return a[n]=new te(is(i,t)),kr[n]&&kr[n].forEach(function(n){ye(n.name,n.config)}),er(n),a[n]}return delete a[n],null}function wp(n,t){if(t!=null){var i,r=bh;a[n]!=null&&(r=a[n]._config);t=is(r,t);i=new te(t);i.parentLocale=a[n];a[n]=i;er(n)}else a[n]!=null&&(a[n].parentLocale!=null?a[n]=a[n].parentLocale:a[n]!=null&&delete a[n]);return a[n]}function si(n){var t;if(n&&n._locale&&n._locale._abbr&&(n=n._locale._abbr),!n)return rf;if(!fi(n)){if(t=dh(n),t)return t;n=[n]}return pp(n)}function bp(){return us(a)}function pe(n){var i,t=n._a;return t&&u(n).overflow===-2&&(i=t[ti]<0||t[ti]>11?ti:t[yt]<1||t[yt]>he(t[tt],t[ti])?yt:t[y]<0||t[y]>24||t[y]===24&&(t[it]!==0||t[ii]!==0||t[bi]!==0)?y:t[it]<0||t[it]>59?it:t[ii]<0||t[ii]>59?ii:t[bi]<0||t[bi]>999?bi:-1,u(n)._overflowDayOfYear&&(i<tt||i>yt)&&(i=yt),u(n)._overflowWeeks&&i===-1&&(i=ry),u(n)._overflowWeekday&&i===-1&&(i=uy),u(n).overflow=i),n}function gh(n){var t,r,o=n._i,i=kp.exec(o)||dp.exec(o),s,e,f,h;if(i){for(u(n).iso=!0,t=0,r=uf.length;t<r;t++)if(uf[t][1].exec(i[1])){e=uf[t][0];s=uf[t][2]!==!1;break}if(e==null){n._isValid=!1;return}if(i[3]){for(t=0,r=we.length;t<r;t++)if(we[t][1].exec(i[3])){f=(i[2]||" ")+we[t][0];break}if(f==null){n._isValid=!1;return}}if(!s&&f!=null){n._isValid=!1;return}if(i[4])if(gp.exec(i[4]))h="Z";else{n._isValid=!1;return}n._f=e+(f||"")+(h||"");ke(n)}else n._isValid=!1}function tw(t){var i=nw.exec(t._i);if(i!==null){t._d=new Date(+i[1]);return}gh(t);t._isValid===!1&&(delete t._isValid,n.createFromInputFallback(t))}function or(n,t,i){return n!=null?n:t!=null?t:i}function iw(t){var i=new Date(n.now());return t._useUTC?[i.getUTCFullYear(),i.getUTCMonth(),i.getUTCDate()]:[i.getFullYear(),i.getMonth(),i.getDate()]}function be(n){var t,i,r=[],f,e;if(!n._d){for(f=iw(n),n._w&&n._a[yt]==null&&n._a[ti]==null&&rw(n),n._dayOfYear&&(e=or(n._a[tt],f[tt]),n._dayOfYear>wr(e)&&(u(n)._overflowDayOfYear=!0),i=nf(e,0,n._dayOfYear),n._a[ti]=i.getUTCMonth(),n._a[yt]=i.getUTCDate()),t=0;t<3&&n._a[t]==null;++t)n._a[t]=r[t]=f[t];for(;t<7;t++)n._a[t]=r[t]=n._a[t]==null?t===2?1:0:n._a[t];n._a[y]===24&&n._a[it]===0&&n._a[ii]===0&&n._a[bi]===0&&(n._nextDay=!0,n._a[y]=0);n._d=(n._useUTC?nf:vy).apply(null,r);n._tzm!=null&&n._d.setUTCMinutes(n._d.getUTCMinutes()-n._tzm);n._nextDay&&(n._a[y]=24)}}function rw(n){var t,o,f,i,r,e,h,s,l;t=n._w;t.GG!=null||t.W!=null||t.E!=null?(r=1,e=4,o=or(t.GG,n._a[tt],br(c(),1,4).year),f=or(t.W,1),i=or(t.E,1),(i<1||i>7)&&(s=!0)):(r=n._locale._week.dow,e=n._locale._week.doy,l=br(c(),r,e),o=or(t.gg,n._a[tt],l.year),f=or(t.w,l.week),t.d!=null?(i=t.d,(i<0||i>6)&&(s=!0)):t.e!=null?(i=t.e+r,(t.e<0||t.e>6)&&(s=!0)):i=r);f<1||f>ki(o,r,e)?u(n)._overflowWeeks=!0:s!=null?u(n)._overflowWeekday=!0:(h=eh(o,f,i,r,e),n._a[tt]=h.year,n._dayOfYear=h.dayOfYear)}function ke(t){if(t._f===n.ISO_8601){gh(t);return}t._a=[];u(t).empty=!0;for(var i=""+t._i,r,f,s,c=i.length,h=0,o=vs(t._f,t._locale).match(as)||[],e=0;e<o.length;e++)f=o[e],r=(i.match(ny(f,t))||[])[0],r&&(s=i.substr(0,i.indexOf(r)),s.length>0&&u(t).unusedInput.push(s),i=i.slice(i.indexOf(r)+r.length),h+=r.length),fr[f]?(r?u(t).empty=!1:u(t).unusedTokens.push(f),iy(f,r,t)):t._strict&&!r&&u(t).unusedTokens.push(f);u(t).charsLeftOver=c-h;i.length>0&&u(t).unusedInput.push(i);t._a[y]<=12&&u(t).bigHour===!0&&t._a[y]>0&&(u(t).bigHour=undefined);u(t).parsedDateParts=t._a.slice(0);u(t).meridiem=t._meridiem;t._a[y]=uw(t._locale,t._a[y],t._meridiem);be(t);pe(t)}function uw(n,t,i){var r;return i==null?t:n.meridiemHour!=null?n.meridiemHour(t,i):n.isPM!=null?(r=n.isPM(i),r&&t<12&&(t+=12),r||t!==12||(t=0),t):t}function fw(n){var t,e,f,r,i;if(n._f.length===0){u(n).invalidFormat=!0;n._d=new Date(NaN);return}for(r=0;r<n._f.length;r++)(i=0,t=gf({},n),n._useUTC!=null&&(t._useUTC=n._useUTC),t._f=n._f[r],ke(t),df(t))&&(i+=u(t).charsLeftOver,i+=u(t).unusedTokens.length*10,u(t).score=i,(f==null||i<f)&&(f=i,e=t));ei(n,e||t)}function ew(n){if(!n._d){var t=ie(n._i);n._a=wo([t.year,t.month,t.day||t.date,t.hour,t.minute,t.second,t.millisecond],function(n){return n&&parseInt(n,10)});be(n)}}function ow(n){var t=new vr(pe(nc(n)));return t._nextDay&&(t.add(1,"d"),t._nextDay=undefined),t}function nc(n){var t=n._i,i=n._f;return(n._locale=n._locale||si(n._l),t===null||i===undefined&&t==="")?cu({nullInput:!0}):(typeof t=="string"&&(n._i=t=n._locale.preparse(t)),oi(t))?new vr(pe(t)):(hu(t)?n._d=t:fi(i)?fw(n):i?ke(n):sw(n),df(n)||(n._d=null),n)}function sw(t){var i=t._i;i===undefined?t._d=new Date(n.now()):hu(i)?t._d=new Date(i.valueOf()):typeof i=="string"?tw(t):fi(i)?(t._a=wo(i.slice(0),function(n){return parseInt(n,10)}),be(t)):typeof i=="object"?ew(t):pi(i)?t._d=new Date(i):n.createFromInputFallback(t)}function tc(n,t,i,r,u){var f={};return(i===!0||i===!1)&&(r=i,i=undefined),(su(n)&&ev(n)||fi(n)&&n.length===0)&&(n=undefined),f._isAMomentObject=!0,f._useUTC=f._isUTC=u,f._l=i,f._i=n,f._f=t,f._strict=r,ow(f)}function c(n,t,i,r){return tc(n,t,i,r,!1)}function uc(n,t){var r,i;if(t.length===1&&fi(t[0])&&(t=t[0]),!t.length)return c();for(r=t[0],i=1;i<t.length;++i)(!t[i].isValid()||t[i][n](r))&&(r=t[i]);return r}function hw(){var n=[].slice.call(arguments,0);return uc("isBefore",n)}function cw(){var n=[].slice.call(arguments,0);return uc("isAfter",n)}function ff(n){var t=ie(n),i=t.year||0,r=t.quarter||0,u=t.month||0,f=t.week||0,e=t.day||0,o=t.hour||0,s=t.minute||0,h=t.second||0,c=t.millisecond||0;this._milliseconds=+c+h*1e3+s*6e4+o*36e5;this._days=+e+f*7;this._months=+u+r*3+i*12;this._data={};this._locale=si();this._bubble()}function de(n){return n instanceof ff}function ge(n){return n<0?Math.round(-1*n)*-1:Math.round(n)}function ec(n,t){r(n,0,0,function(){var n=this.utcOffset(),i="+";return n<0&&(n=-n,i="-"),i+ni(~~(n/60),2)+t+ni(~~n%60,2)})}function no(n,t){var i=(t||"").match(n);if(i===null)return null;var e=i[i.length-1]||[],r=(e+"").match(oc)||["-",0,0],u=+(r[1]*60)+f(r[2]);return u===0?0:r[0]==="+"?u:-u}function to(t,i){var r,u;return i._isUTC?(r=i.clone(),u=(oi(t)||hu(t)?t.valueOf():c(t).valueOf())-r.valueOf(),r._d.setTime(r._d.valueOf()+u),n.updateOffset(r,!1),r):c(t).local()}function io(n){return-Math.round(n._d.getTimezoneOffset()/15)*15}function lw(t,i){var r=this._offset||0,u;if(!this.isValid())return t!=null?this:NaN;if(t!=null){if(typeof t=="string"){if(t=no(du,t),t===null)return this}else Math.abs(t)<16&&(t=t*60);return!this._isUTC&&i&&(u=io(this)),this._offset=t,this._isUTC=!0,u!=null&&this.add(u,"m"),r!==t&&(!i||this._changeInProgress?vc(this,hi(t-r,"m"),1,!1):this._changeInProgress||(this._changeInProgress=!0,n.updateOffset(this,!0),this._changeInProgress=null)),this}return this._isUTC?r:io(this)}function aw(n,t){return n!=null?(typeof n!="string"&&(n=-n),this.utcOffset(n,t),this):-this.utcOffset()}function vw(n){return this.utcOffset(0,n)}function yw(n){return this._isUTC&&(this.utcOffset(0,n),this._isUTC=!1,n&&this.subtract(io(this),"m")),this}function pw(){if(this._tzm!=null)this.utcOffset(this._tzm);else if(typeof this._i=="string"){var n=no(gv,this._i);n!=null?this.utcOffset(n):this.utcOffset(0,!0)}return this}function ww(n){return this.isValid()?(n=n?c(n).utcOffset():0,(this.utcOffset()-n)%60==0):!1}function bw(){return this.utcOffset()>this.clone().month(0).utcOffset()||this.utcOffset()>this.clone().month(5).utcOffset()}function kw(){var n,t;return b(this._isDSTShifted)?(n={},gf(n,this),n=nc(n),n._a?(t=n._isUTC?at(n._a):c(n._a),this._isDSTShifted=this.isValid()&&go(n._a,t.toArray())>0):this._isDSTShifted=!1,this._isDSTShifted):this._isDSTShifted}function dw(){return this.isValid()?!this._isUTC:!1}function gw(){return this.isValid()?this._isUTC:!1}function sc(){return this.isValid()?this._isUTC&&this._offset===0:!1}function hi(n,t){var i=n,r=null,u,e,o;return de(n)?i={ms:n._milliseconds,d:n._days,M:n._months}:pi(n)?(i={},t?i[t]=n:i.milliseconds=n):(r=hc.exec(n))?(u=r[1]==="-"?-1:1,i={y:0,d:f(r[yt])*u,h:f(r[y])*u,m:f(r[it])*u,s:f(r[ii])*u,ms:f(ge(r[bi]*1e3))*u}):(r=cc.exec(n))?(u=r[1]==="-"?-1:1,i={y:di(r[2],u),M:di(r[3],u),w:di(r[4],u),d:di(r[5],u),h:di(r[6],u),m:di(r[7],u),s:di(r[8],u)}):i==null?i={}:typeof i=="object"&&("from"in i||"to"in i)&&(o=nb(c(i.from),c(i.to)),i={},i.ms=o.milliseconds,i.M=o.months),e=new ff(i),de(n)&&l(n,"_locale")&&(e._locale=n._locale),e}function di(n,t){var i=n&&parseFloat(n.replace(",","."));return(isNaN(i)?0:i)*t}function lc(n,t){var i={milliseconds:0,months:0};return i.months=t.month()-n.month()+(t.year()-n.year())*12,n.clone().add(i.months,"M").isAfter(t)&&--i.months,i.milliseconds=+t-+n.clone().add(i.months,"M"),i}function nb(n,t){var i;return(n.isValid()&&t.isValid())?(t=to(t,n),n.isBefore(t)?i=lc(n,t):(i=lc(t,n),i.milliseconds=-i.milliseconds,i.months=-i.months),i):{milliseconds:0,months:0}}function ac(n,t){return function(i,r){var u,f;return r===null||isNaN(+r)||(ts(t,"moment()."+t+"(period, number) is deprecated. Please use moment()."+t+"(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),f=i,i=r,r=f),i=typeof i=="string"?+i:i,u=hi(i,r),vc(this,u,n),this}}function vc(t,i,r,u){var o=i._milliseconds,f=ge(i._days),e=ge(i._months);t.isValid()&&(u=u==null?!0:u,o&&t._d.setTime(t._d.valueOf()+o*r),f&&ls(t,"Date",vu(t,"Date")+f*r),e&&nh(t,vu(t,"Month")+e*r),u&&n.updateOffset(t,f||e))}function tb(n,t){var i=n.diff(t,"days",!0);return i<-6?"sameElse":i<-1?"lastWeek":i<0?"lastDay":i<1?"sameDay":i<2?"nextDay":i<7?"nextWeek":"sameElse"}function ib(t,i){var u=t||c(),f=to(u,this).startOf("day"),r=n.calendarFormat(this,f)||"sameElse",e=i&&(vt(i[r])?i[r].call(this,u):i[r]);return this.format(e||this.localeData().calendar(r,this,c(u)))}function rb(){return new vr(this)}function ub(n,t){var i=oi(n)?n:c(n);return(this.isValid()&&i.isValid())?(t=g(b(t)?"millisecond":t),t==="millisecond"?this.valueOf()>i.valueOf():i.valueOf()<this.clone().startOf(t).valueOf()):!1}function fb(n,t){var i=oi(n)?n:c(n);return(this.isValid()&&i.isValid())?(t=g(b(t)?"millisecond":t),t==="millisecond"?this.valueOf()<i.valueOf():this.clone().endOf(t).valueOf()<i.valueOf()):!1}function eb(n,t,i,r){return r=r||"()",(r[0]==="("?this.isAfter(n,i):!this.isBefore(n,i))&&(r[1]===")"?this.isBefore(t,i):!this.isAfter(t,i))}function ob(n,t){var i=oi(n)?n:c(n),r;return(this.isValid()&&i.isValid())?(t=g(t||"millisecond"),t==="millisecond"?this.valueOf()===i.valueOf():(r=i.valueOf(),this.clone().startOf(t).valueOf()<=r&&r<=this.clone().endOf(t).valueOf())):!1}function sb(n,t){return this.isSame(n,t)||this.isAfter(n,t)}function hb(n,t){return this.isSame(n,t)||this.isBefore(n,t)}function cb(n,t,i){var f,e,u,r;return this.isValid()?(f=to(n,this),!f.isValid())?NaN:(e=(f.utcOffset()-this.utcOffset())*6e4,t=g(t),t==="year"||t==="month"||t==="quarter"?(r=lb(this,f),t==="quarter"?r=r/3:t==="year"&&(r=r/12)):(u=this-f,r=t==="second"?u/1e3:t==="minute"?u/6e4:t==="hour"?u/36e5:t==="day"?(u-e)/864e5:t==="week"?(u-e)/6048e5:u),i?r:k(r)):NaN}function lb(n,t){var r=(t.year()-n.year())*12+(t.month()-n.month()),i=n.clone().add(r,"months"),u,f;return t-i<0?(u=n.clone().add(r-1,"months"),f=(t-i)/(i-u)):(u=n.clone().add(r+1,"months"),f=(t-i)/(u-i)),-(r+f)||0}function ab(){return this.clone().locale("en").format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")}function vb(){var n=this.clone().utc();return 0<n.year()&&n.year()<=9999?vt(Date.prototype.toISOString)?this.toDate().toISOString():fe(n,"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"):fe(n,"YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")}function yb(){var n,t;if(!this.isValid())return"moment.invalid(/* "+this._i+" */)";n="moment";t="";this.isLocal()||(n=this.utcOffset()===0?"moment.utc":"moment.parseZone",t="Z");var i="["+n+'("]',r=0<this.year()&&this.year()<=9999?"YYYY":"YYYYYY",u=t+'[")]';return this.format(i+r+"-MM-DD[T]HH:mm:ss.SSS"+u)}function pb(t){t||(t=this.isUtc()?n.defaultFormatUtc:n.defaultFormat);var i=fe(this,t);return this.localeData().postformat(i)}function wb(n,t){return this.isValid()&&(oi(n)&&n.isValid()||c(n).isValid())?hi({to:this,from:n}).locale(this.locale()).humanize(!t):this.localeData().invalidDate()}function bb(n){return this.from(c(),n)}function kb(n,t){return this.isValid()&&(oi(n)&&n.isValid()||c(n).isValid())?hi({from:this,to:n}).locale(this.locale()).humanize(!t):this.localeData().invalidDate()}function db(n){return this.to(c(),n)}function wc(n){var t;return n===undefined?this._locale._abbr:(t=si(n),t!=null&&(this._locale=t),this)}function bc(){return this._locale}function gb(n){n=g(n);switch(n){case"year":this.month(0);case"quarter":case"month":this.date(1);case"week":case"isoWeek":case"day":case"date":this.hours(0);case"hour":this.minutes(0);case"minute":this.seconds(0);case"second":this.milliseconds(0)}return n==="week"&&this.weekday(0),n==="isoWeek"&&this.isoWeekday(1),n==="quarter"&&this.month(Math.floor(this.month()/3)*3),this}function nk(n){return(n=g(n),n===undefined||n==="millisecond")?this:(n==="date"&&(n="day"),this.startOf(n).add(1,n==="isoWeek"?"week":n).subtract(1,"ms"))}function tk(){return this._d.valueOf()-(this._offset||0)*6e4}function ik(){return Math.floor(this.valueOf()/1e3)}function rk(){return new Date(this.valueOf())}function uk(){var n=this;return[n.year(),n.month(),n.date(),n.hour(),n.minute(),n.second(),n.millisecond()]}function fk(){var n=this;return{years:n.year(),months:n.month(),date:n.date(),hours:n.hours(),minutes:n.minutes(),seconds:n.seconds(),milliseconds:n.milliseconds()}}function ek(){return this.isValid()?this.toISOString():null}function ok(){return df(this)}function sk(){return ei({},u(this))}function hk(){return u(this).overflow}function ck(){return{input:this._i,format:this._f,locale:this._locale,isUTC:this._isUTC,strict:this._strict}}function ef(n,t){r(0,[n,n.length],0,t)}function lk(n){return kc.call(this,n,this.week(),this.weekday(),this.localeData()._week.dow,this.localeData()._week.doy)}function ak(n){return kc.call(this,n,this.isoWeek(),this.isoWeekday(),1,4)}function vk(){return ki(this.year(),1,4)}function yk(){var n=this.localeData()._week;return ki(this.year(),n.dow,n.doy)}function kc(n,t,i,r,u){var f;return n==null?br(this,r,u).year:(f=ki(n,r,u),t>f&&(t=f),pk.call(this,n,t,i,r,u))}function pk(n,t,i,r,u){var e=eh(n,t,i,r,u),f=nf(e.year,0,e.dayOfYear);return this.year(f.getUTCFullYear()),this.month(f.getUTCMonth()),this.date(f.getUTCDate()),this}function wk(n){return n==null?Math.ceil((this.month()+1)/3):this.month((n-1)*3+this.month()%3)}function bk(n){var t=Math.round((this.clone().startOf("day")-this.clone().startOf("year"))/864e5)+1;return n==null?t:this.add(n-t,"d")}function kk(n,t){t[bi]=f(("0."+n)*1e3)}function dk(){return this._isUTC?"UTC":""}function gk(){return this._isUTC?"Coordinated Universal Time":""}function nd(n){return c(n*1e3)}function td(){return c.apply(null,arguments).parseZone()}function tl(n){return n}function of(n,t,i,r){var u=si(),f=at().set(r,t);return u[i](f,n)}function il(n,t,i){if(pi(n)&&(t=n,n=undefined),n=n||"",t!=null)return of(n,t,i,"month");for(var u=[],r=0;r<12;r++)u[r]=of(n,r,i,"month");return u}function fo(n,t,i,r){var o,f,u,e;if(typeof n=="boolean"?(pi(t)&&(i=t,t=undefined),t=t||""):(t=n,i=t,n=!1,pi(t)&&(i=t,t=undefined),t=t||""),o=si(),f=n?o._week.dow:0,i!=null)return of(t,(i+f)%7,r,"day");for(e=[],u=0;u<7;u++)e[u]=of(t,(u+f)%7,r,"day");return e}function id(n,t){return il(n,t,"months")}function rd(n,t){return il(n,t,"monthsShort")}function ud(n,t,i){return fo(n,t,i,"weekdays")}function fd(n,t,i){return fo(n,t,i,"weekdaysShort")}function ed(n,t,i){return fo(n,t,i,"weekdaysMin")}function od(){var n=this._data;return this._milliseconds=pt(this._milliseconds),this._days=pt(this._days),this._months=pt(this._months),n.milliseconds=pt(n.milliseconds),n.seconds=pt(n.seconds),n.minutes=pt(n.minutes),n.hours=pt(n.hours),n.months=pt(n.months),n.years=pt(n.years),this}function rl(n,t,i,r){var u=hi(t,i);return n._milliseconds+=r*u._milliseconds,n._days+=r*u._days,n._months+=r*u._months,n._bubble()}function sd(n,t){return rl(this,n,t,1)}function hd(n,t){return rl(this,n,t,-1)}function ul(n){return n<0?Math.floor(n):Math.ceil(n)}function cd(){var r=this._milliseconds,n=this._days,t=this._months,i=this._data,u,f,e,s,o;return r>=0&&n>=0&&t>=0||r<=0&&n<=0&&t<=0||(r+=ul(eo(t)+n)*864e5,n=0,t=0),i.milliseconds=r%1e3,u=k(r/1e3),i.seconds=u%60,f=k(u/60),i.minutes=f%60,e=k(f/60),i.hours=e%24,n+=k(e/24),o=k(fl(n)),t+=o,n-=ul(eo(o)),s=k(t/12),t%=12,i.days=n,i.months=t,i.years=s,this}function fl(n){return n*4800/146097}function eo(n){return n*146097/4800}function ld(n){var t,r,i=this._milliseconds;if(n=g(n),n==="month"||n==="year")return t=this._days+i/864e5,r=this._months+fl(t),n==="month"?r:r/12;t=this._days+Math.round(eo(this._months));switch(n){case"week":return t/7+i/6048e5;case"day":return t+i/864e5;case"hour":return t*24+i/36e5;case"minute":return t*1440+i/6e4;case"second":return t*86400+i/1e3;case"millisecond":return Math.floor(t*864e5)+i;default:throw new Error("Unknown unit "+n);}}function ad(){return this._milliseconds+this._days*864e5+this._months%12*2592e6+f(this._months/12)*31536e6}function li(n){return function(){return this.as(n)}}function ng(n){return n=g(n),this[n+"s"]()}function gi(n){return function(){return this._data[n]}}function sg(){return k(this.days()/7)}function hg(n,t,i,r,u){return u.relativeTime(t||1,!!i,n,r)}function cg(n,t,i){var r=hi(n).abs(),h=ri(r.as("s")),f=ri(r.as("m")),e=ri(r.as("h")),o=ri(r.as("d")),s=ri(r.as("M")),c=ri(r.as("y")),u=h<ui.s&&["s",h]||f<=1&&["m"]||f<ui.m&&["mm",f]||e<=1&&["h"]||e<ui.h&&["hh",e]||o<=1&&["d"]||o<ui.d&&["dd",o]||s<=1&&["M"]||s<ui.M&&["MM",s]||c<=1&&["y"]||["yy",c];return u[2]=t,u[3]=+n>0,u[4]=i,hg.apply(null,u)}function lg(n){return n===undefined?ri:typeof n=="function"?(ri=n,!0):!1}function ag(n,t){return ui[n]===undefined?!1:t===undefined?ui[n]:(ui[n]=t,!0)}function vg(n){var t=this.localeData(),i=cg(this,!n,t);return n&&(i=t.pastFuture(+this,i)),t.postformat(i)}function hf(){var t=sf(this._milliseconds)/1e3,a=sf(this._days),i=sf(this._months),n,e,o;n=k(t/60);e=k(n/60);t%=60;n%=60;o=k(i/12);i%=12;var s=o,h=i,c=a,r=e,u=n,f=t,l=this.asSeconds();return l?(l<0?"-":"")+"P"+(s?s+"Y":"")+(h?h+"M":"")+(c?c+"D":"")+(r||u||f?"T":"")+(r?r+"H":"")+(u?u+"M":"")+(f?f+"S":""):"P0D"}function dg(n,t){var i=n.split("_");return t%10==1&&t%100!=11?i[0]:t%10>=2&&t%10<=4&&(t%100<10||t%100>=20)?i[1]:i[2]}function nr(n,t,i){var r={mm:t?"хвіліна_хвіліны_хвілін":"хвіліну_хвіліны_хвілін",hh:t?"гадзіна_гадзіны_гадзін":"гадзіну_гадзіны_гадзін",dd:"дзень_дні_дзён",MM:"месяц_месяцы_месяцаў",yy:"год_гады_гадоў"};return i==="m"?t?"хвіліна":"хвіліну":i==="h"?t?"гадзіна":"гадзіну":n+" "+dg(r[i],+n)}function oo(n,t,i){return n+" "+tn({mm:"munutenn",MM:"miz",dd:"devezh"}[i],n)}function gg(n){switch(nn(n)){case 1:case 3:case 4:case 5:case 9:return n+" bloaz";default:return n+" vloaz"}}function nn(n){var i=!0,t;n:while(i){if(t=n,i=!1,t>9){n=t%10;i=!0;continue n}return t}}function tn(n,t){return t===2?rn(n):n}function rn(n){var t={m:"v",b:"v",d:"z"};return t[n.charAt(0)]===undefined?n:t[n.charAt(0)]+n.substring(1)}function tr(n,t,i){var r=n+" ";switch(i){case"m":return t?"jedna minuta":"jedne minute";case"mm":return r+(n===1?"minuta":n===2||n===3||n===4?"minute":"minuta");case"h":return t?"jedan sat":"jednog sata";case"hh":return r+(n===1?"sat":n===2||n===3||n===4?"sata":"sati");case"dd":return r+(n===1?"dan":"dana");case"MM":return r+(n===1?"mjesec":n===2||n===3||n===4?"mjeseca":"mjeseci");case"yy":return r+(n===1?"godina":n===2||n===3||n===4?"godine":"godina")}}function dr(n){return n>1&&n<5&&~~(n/10)!=1}function ft(n,t,i,r){var u=n+" ";switch(i){case"s":return t||r?"pár sekund":"pár sekundami";case"m":return t?"minuta":r?"minutu":"minutou";case"mm":return t||r?u+(dr(n)?"minuty":"minut"):u+"minutami";case"h":return t?"hodina":r?"hodinu":"hodinou";case"hh":return t||r?u+(dr(n)?"hodiny":"hodin"):u+"hodinami";case"d":return t||r?"den":"dnem";case"dd":return t||r?u+(dr(n)?"dny":"dní"):u+"dny";case"M":return t||r?"měsíc":"měsícem";case"MM":return t||r?u+(dr(n)?"měsíce":"měsíců"):u+"měsíci";case"y":return t||r?"rok":"rokem";case"yy":return t||r?u+(dr(n)?"roky":"let"):u+"lety"}}function ai(n,t,i){var r={m:["eine Minute","einer Minute"],h:["eine Stunde","einer Stunde"],d:["ein Tag","einem Tag"],dd:[n+" Tage",n+" Tagen"],M:["ein Monat","einem Monat"],MM:[n+" Monate",n+" Monaten"],y:["ein Jahr","einem Jahr"],yy:[n+" Jahre",n+" Jahren"]};return t?r[i][0]:r[i][1]}function vi(n,t,i){var r={m:["eine Minute","einer Minute"],h:["eine Stunde","einer Stunde"],d:["ein Tag","einem Tag"],dd:[n+" Tage",n+" Tagen"],M:["ein Monat","einem Monat"],MM:[n+" Monate",n+" Monaten"],y:["ein Jahr","einem Jahr"],yy:[n+" Jahre",n+" Jahren"]};return t?r[i][0]:r[i][1]}function wt(n,t,i,r){var u={s:["mõne sekundi","mõni sekund","paar sekundit"],m:["ühe minuti","üks minut"],mm:[n+" minuti",n+" minutit"],h:["ühe tunni","tund aega","üks tund"],hh:[n+" tunni",n+" tundi"],d:["ühe päeva","üks päev"],M:["kuu aja","kuu aega","üks kuu"],MM:[n+" kuu",n+" kuud"],y:["ühe aasta","aasta","üks aasta"],yy:[n+" aasta",n+" aastat"]};return t?u[i][2]?u[i][2]:u[i][1]:r?u[i][0]:u[i][1]}function et(n,t,i,r){var u="";switch(i){case"s":return r?"muutaman sekunnin":"muutama sekunti";case"m":return r?"minuutin":"minuutti";case"mm":u=r?"minuutin":"minuuttia";break;case"h":return r?"tunnin":"tunti";case"hh":u=r?"tunnin":"tuntia";break;case"d":return r?"päivän":"päivä";case"dd":u=r?"päivän":"päivää";break;case"M":return r?"kuukauden":"kuukausi";case"MM":u=r?"kuukauden":"kuukautta";break;case"y":return r?"vuoden":"vuosi";case"yy":u=r?"vuoden":"vuotta"}return un(n,r)+" "+u}function un(n,t){return n<10?t?ta[n]:gr[n]:n}function ir(n,t,i){var r=n+" ";switch(i){case"m":return t?"jedna minuta":"jedne minute";case"mm":return r+(n===1?"minuta":n===2||n===3||n===4?"minute":"minuta");case"h":return t?"jedan sat":"jednog sata";case"hh":return r+(n===1?"sat":n===2||n===3||n===4?"sata":"sati");case"dd":return r+(n===1?"dan":"dana");case"MM":return r+(n===1?"mjesec":n===2||n===3||n===4?"mjeseca":"mjeseci");case"yy":return r+(n===1?"godina":n===2||n===3||n===4?"godine":"godina")}}function ot(n,t,i,r){var u=n;switch(i){case"s":return r||t?"néhány másodperc":"néhány másodperce";case"m":return"egy"+(r||t?" perc":" perce");case"mm":return u+(r||t?" perc":" perce");case"h":return"egy"+(r||t?" óra":" órája");case"hh":return u+(r||t?" óra":" órája");case"d":return"egy"+(r||t?" nap":" napja");case"dd":return u+(r||t?" nap":" napja");case"M":return"egy"+(r||t?" hónap":" hónapja");case"MM":return u+(r||t?" hónap":" hónapja");case"y":return"egy"+(r||t?" év":" éve");case"yy":return u+(r||t?" év":" éve")}return""}function oa(n){return(n?"":"[múlt] ")+"["+ea[this.day()]+"] LT[-kor]"}function nu(n){return n%100==11?!0:n%10==1?!1:!0}function bt(n,t,i,r){var u=n+" ";switch(i){case"s":return t||r?"nokkrar sekúndur":"nokkrum sekúndum";case"m":return t?"mínúta":"mínútu";case"mm":return nu(n)?u+(t||r?"mínútur":"mínútum"):t?u+"mínúta":u+"mínútu";case"hh":return nu(n)?u+(t||r?"klukkustundir":"klukkustundum"):u+"klukkustund";case"d":return t?"dagur":r?"dag":"degi";case"dd":return nu(n)?t?u+"dagar":u+(r?"daga":"dögum"):t?u+"dagur":u+(r?"dag":"degi");case"M":return t?"mánuður":r?"mánuð":"mánuði";case"MM":return nu(n)?t?u+"mánuðir":u+(r?"mánuði":"mánuðum"):t?u+"mánuður":u+(r?"mánuð":"mánuði");case"y":return t||r?"ár":"ári";case"yy":return nu(n)?u+(t||r?"ár":"árum"):u+(t||r?"ár":"ári")}}function tu(n,t,i){var r={m:["eng Minutt","enger Minutt"],h:["eng Stonn","enger Stonn"],d:["een Dag","engem Dag"],M:["ee Mount","engem Mount"],y:["ee Joer","engem Joer"]};return t?r[i][0]:r[i][1]}function fn(n){var t=n.substr(0,n.indexOf(" "));return sa(t)?"a "+n:"an "+n}function en(n){var t=n.substr(0,n.indexOf(" "));return sa(t)?"viru "+n:"virun "+n}function sa(n){var r=!0,t,i,u;n:while(r){if(t=n,r=!1,t=parseInt(t,10),isNaN(t))return!1;if(t<0)return!0;if(t<10)return 4<=t&&t<=7?!0:!1;if(t<100){if(i=t%10,u=t/10,i===0){n=u;r=!0;i=u=undefined;continue n}n=i;r=!0;i=u=undefined;continue n}else if(t<1e4){while(t>=10)t=t/10;n=t;r=!0;i=u=undefined;continue n}else{t=t/1e3;n=t;r=!0;i=u=undefined;continue n}}}function on(n,t,i,r){return t?"kelios sekundės":r?"kelių sekundžių":"kelias sekundes"}function sr(n,t,i,r){return t?yi(i)[0]:r?yi(i)[1]:yi(i)[2]}function ca(n){return n%10==0||n>10&&n<20}function yi(n){return ha[n].split("_")}function iu(n,t,i,r){var u=n+" ";return n===1?u+sr(n,t,i[0],r):t?u+(ca(n)?yi(i)[1]:yi(i)[0]):r?u+yi(i)[1]:u+(ca(n)?yi(i)[1]:yi(i)[2])}function la(n,t,i){return i?t%10==1&&t%100!=11?n[2]:n[3]:t%10==1&&t%100!=11?n[0]:n[1]}function ru(n,t,i){return n+" "+la(co[i],n,t)}function uu(n,t,i){return la(co[i],n,t)}function sn(n,t){return t?"dažas sekundes":"dažām sekundēm"}function st(n,t,i){var r="";if(t)switch(i){case"s":r="काही सेकंद";break;case"m":r="एक मिनिट";break;case"mm":r="%d मिनिटे";break;case"h":r="एक तास";break;case"hh":r="%d तास";break;case"d":r="एक दिवस";break;case"dd":r="%d दिवस";break;case"M":r="एक महिना";break;case"MM":r="%d महिने";break;case"y":r="एक वर्ष";break;case"yy":r="%d वर्षे"}else switch(i){case"s":r="काही सेकंदां";break;case"m":r="एका मिनिटा";break;case"mm":r="%d मिनिटां";break;case"h":r="एका तासा";break;case"hh":r="%d तासां";break;case"d":r="एका दिवसा";break;case"dd":r="%d दिवसां";break;case"M":r="एका महिन्या";break;case"MM":r="%d महिन्यां";break;case"y":r="एका वर्षा";break;case"yy":r="%d वर्षां"}return r.replace(/%d/i,n)}function pf(n){return n%10<5&&n%10>1&&~~(n/10)%10!=1}function hr(n,t,i){var r=n+" ";switch(i){case"m":return t?"minuta":"minutę";case"mm":return r+(pf(n)?"minuty":"minut");case"h":return t?"godzina":"godzinę";case"hh":return r+(pf(n)?"godziny":"godzin");case"MM":return r+(pf(n)?"miesiące":"miesięcy");case"yy":return r+(pf(n)?"lata":"lat")}}function fu(n,t,i){var r=" ";return(n%100>=20||n>=100&&n%100==0)&&(r=" de "),n+r+{mm:"minute",hh:"ore",dd:"zile",MM:"luni",yy:"ani"}[i]}function vn(n,t){var i=n.split("_");return t%10==1&&t%100!=11?i[0]:t%10>=2&&t%10<=4&&(t%100<10||t%100>=20)?i[1]:i[2]}function cr(n,t,i){var r={mm:t?"минута_минуты_минут":"минуту_минуты_минут",hh:"час_часа_часов",dd:"день_дня_дней",MM:"месяц_месяца_месяцев",yy:"год_года_лет"};return i==="m"?t?"минута":"минуту":n+" "+vn(r[i],+n)}function eu(n){return n>1&&n<5}function ht(n,t,i,r){var u=n+" ";switch(i){case"s":return t||r?"pár sekúnd":"pár sekundami";case"m":return t?"minúta":r?"minútu":"minútou";case"mm":return t||r?u+(eu(n)?"minúty":"minút"):u+"minútami";case"h":return t?"hodina":r?"hodinu":"hodinou";case"hh":return t||r?u+(eu(n)?"hodiny":"hodín"):u+"hodinami";case"d":return t||r?"deň":"dňom";case"dd":return t||r?u+(eu(n)?"dni":"dní"):u+"dňami";case"M":return t||r?"mesiac":"mesiacom";case"MM":return t||r?u+(eu(n)?"mesiace":"mesiacov"):u+"mesiacmi";case"y":return t||r?"rok":"rokom";case"yy":return t||r?u+(eu(n)?"roky":"rokov"):u+"rokmi"}}function ct(n,t,i,r){var u=n+" ";switch(i){case"s":return t||r?"nekaj sekund":"nekaj sekundami";case"m":return t?"ena minuta":"eno minuto";case"mm":return u+(n===1?t?"minuta":"minuto":n===2?t||r?"minuti":"minutama":n<5?t||r?"minute":"minutami":t||r?"minut":"minutami");case"h":return t?"ena ura":"eno uro";case"hh":return u+(n===1?t?"ura":"uro":n===2?t||r?"uri":"urama":n<5?t||r?"ure":"urami":t||r?"ur":"urami");case"d":return t||r?"en dan":"enim dnem";case"dd":return u+(n===1?t||r?"dan":"dnem":n===2?t||r?"dni":"dnevoma":t||r?"dni":"dnevi");case"M":return t||r?"en mesec":"enim mesecem";case"MM":return u+(n===1?t||r?"mesec":"mesecem":n===2?t||r?"meseca":"mesecema":n<5?t||r?"mesece":"meseci":t||r?"mesecev":"meseci");case"y":return t||r?"eno leto":"enim letom";case"yy":return u+(n===1?t||r?"leto":"letom":n===2?t||r?"leti":"letoma":n<5?t||r?"leta":"leti":t||r?"let":"leti")}}function yn(n){var t=n;return n.indexOf("jaj")!==-1?t.slice(0,-3)+"leS":n.indexOf("jar")!==-1?t.slice(0,-3)+"waQ":n.indexOf("DIS")!==-1?t.slice(0,-3)+"nem":t+" pIq"}function pn(n){var t=n;return n.indexOf("jaj")!==-1?t.slice(0,-3)+"Hu’":n.indexOf("jar")!==-1?t.slice(0,-3)+"wen":n.indexOf("DIS")!==-1?t.slice(0,-3)+"ben":t+" ret"}function ou(n,t,i){var r=wn(n);switch(i){case"mm":return r+" tup";case"hh":return r+" rep";case"dd":return r+" jaj";case"MM":return r+" jar";case"yy":return r+" DIS"}}function wn(n){var i=Math.floor(n%1e3/100),r=Math.floor(n%100/10),u=n%10,t="";return i>0&&(t+=bf[i]+"vatlh"),r>0&&(t+=(t!==""?" ":"")+bf[r]+"maH"),u>0&&(t+=(t!==""?" ":"")+bf[u]),t===""?"pagh":t}function lt(n,t,i,r){var u={s:["viensas secunds","'iensas secunds"],m:["'n míut","'iens míut"],mm:[n+" míuts",""+n+" míuts"],h:["'n þora","'iensa þora"],hh:[n+" þoras",""+n+" þoras"],d:["'n ziua","'iensa ziua"],dd:[n+" ziuas",""+n+" ziuas"],M:["'n mes","'iens mes"],MM:[n+" mesen",""+n+" mesen"],y:["'n ar","'iens ar"],yy:[n+" ars",""+n+" ars"]};return r?u[i][0]:t?u[i][0]:u[i][1]}function bn(n,t){var i=n.split("_");return t%10==1&&t%100!=11?i[0]:t%10>=2&&t%10<=4&&(t%100<10||t%100>=20)?i[1]:i[2]}function lr(n,t,i){var r={mm:t?"хвилина_хвилини_хвилин":"хвилину_хвилини_хвилин",hh:t?"година_години_годин":"годину_години_годин",dd:"день_дні_днів",MM:"місяць_місяці_місяців",yy:"рік_роки_років"};return i==="m"?t?"хвилина":"хвилину":i==="h"?t?"година":"годину":n+" "+bn(r[i],+n)}function kn(n,t){var i={nominative:"неділя_понеділок_вівторок_середа_четвер_п’ятниця_субота".split("_"),accusative:"неділю_понеділок_вівторок_середу_четвер_п’ятницю_суботу".split("_"),genitive:"неділі_понеділка_вівторка_середи_четверга_п’ятниці_суботи".split("_")},r=/(\[[ВвУу]\]) ?dddd/.test(t)?"accusative":/\[?(?:минулої|наступної)? ?\] ?dddd/.test(t)?"genitive":"nominative";return i[r][n.day()]}function ar(n){return function(){return n+"о"+(this.hours()===11?"б":"")+"] LT"}}var po,bo,ko,lu,au,ne,rs,us,fs,es,os,ss,hs,cs,rr,re,gu,v,ce,ds,gs,ih,rh,le,oh,sh,hh,ch,lh,ah,vh,wh,ic,rc,fc,oc,hc,cc,yc,pc,ro,uo,dc,gc,ci,nl,t,o,pt,ri,ui,sf,e,sl,hl,cf,al,vl,yl,pl,lf,af,so,ho,wl,bl,kl,dl,gl,na,gr,ta,ia,ra,ua,fa,ea,vf,yf,ha,co,kt,aa,va,ya,pa,wa,ba,ga,nv,vo,yo,wf,tv,iv,dt,gt,rv,uv,bf,kf;bo=Array.prototype.some?Array.prototype.some:function(n){for(var i=Object(this),r=i.length>>>0,t=0;t<r;t++)if(t in i&&n.call(this,i[t],t,i))return!0;return!1};ko=bo;lu=n.momentProperties=[];au=!1;ne={};n.suppressDeprecationWarnings=!1;n.deprecationHandler=null;rs=Object.keys?Object.keys:function(n){var t,i=[];for(t in n)l(n,t)&&i.push(t);return i};us=rs;fs={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"};es={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"};os="Invalid date";ss="%d";hs=/\d{1,2}/;cs={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"};rr={};re={};var as=/(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,yu=/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g,ue={},fr={};var ys=/\d/,nt=/\d\d/,ps=/\d{3}/,ee=/\d{4}/,pu=/[+-]?\d{6}/,h=/\d\d?/,ws=/\d\d\d\d?/,bs=/\d\d\d\d\d\d?/,wu=/\d{1,3}/,oe=/\d{1,4}/,bu=/[+-]?\d{1,6}/,ku=/[+-]?\d+/,gv=/Z|[+-]\d\d:?\d\d/gi,du=/Z|[+-]\d\d(?::?\d\d)?/gi,yr=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,se={};gu={};var tt=0,ti=1,yt=2,y=3,it=4,ii=5,bi=6,ry=7,uy=8,ks;ks=Array.prototype.indexOf?Array.prototype.indexOf:function(n){for(var t=0;t<this.length;++t)if(this[t]===n)return t;return-1};v=ks;r("M",["MM",2],"Mo",function(){return this.month()+1});r("MMM",0,0,function(n){return this.localeData().monthsShort(this,n)});r("MMMM",0,0,function(n){return this.localeData().months(this,n)});p("month","M");w("month",8);i("M",h);i("MM",h,nt);i("MMM",function(n,t){return t.monthsShortRegex(n)});i("MMMM",function(n,t){return t.monthsRegex(n)});s(["M","MM"],function(n,t){t[ti]=f(n)-1});s(["MMM","MMMM"],function(n,t,i,r){var f=i._locale.monthsParse(n,r,i._strict);f!=null?t[ti]=f:u(i).invalidMonth=n});ce=/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/;ds="January_February_March_April_May_June_July_August_September_October_November_December".split("_");gs="Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_");ih=yr;rh=yr;r("Y",0,0,function(){var n=this.year();return n<=9999?""+n:"+"+n});r(0,["YY",2],0,function(){return this.year()%100});r(0,["YYYY",4],0,"year");r(0,["YYYYY",5],0,"year");r(0,["YYYYYY",6,!0],0,"year");p("year","y");w("year",1);i("Y",ku);i("YY",h,nt);i("YYYY",oe,ee);i("YYYYY",bu,pu);i("YYYYYY",bu,pu);s(["YYYYY","YYYYYY"],tt);s("YYYY",function(t,i){i[tt]=t.length===2?n.parseTwoDigitYear(t):f(t)});s("YY",function(t,i){i[tt]=n.parseTwoDigitYear(t)});s("Y",function(n,t){t[tt]=parseInt(n,10)});n.parseTwoDigitYear=function(n){return f(n)+(f(n)>68?1900:2e3)};le=ur("FullYear",!0);r("w",["ww",2],"wo","week");r("W",["WW",2],"Wo","isoWeek");p("week","w");p("isoWeek","W");w("week",5);w("isoWeek",5);i("w",h);i("ww",h,nt);i("W",h);i("WW",h,nt);pr(["w","ww","W","WW"],function(n,t,i,r){t[r.substr(0,1)]=f(n)});oh={dow:0,doy:6};r("d",0,"do","day");r("dd",0,0,function(n){return this.localeData().weekdaysMin(this,n)});r("ddd",0,0,function(n){return this.localeData().weekdaysShort(this,n)});r("dddd",0,0,function(n){return this.localeData().weekdays(this,n)});r("e",0,0,"weekday");r("E",0,0,"isoWeekday");p("day","d");p("weekday","e");p("isoWeekday","E");w("day",11);w("weekday",11);w("isoWeekday",11);i("d",h);i("e",h);i("E",h);i("dd",function(n,t){return t.weekdaysMinRegex(n)});i("ddd",function(n,t){return t.weekdaysShortRegex(n)});i("dddd",function(n,t){return t.weekdaysRegex(n)});pr(["dd","ddd","dddd"],function(n,t,i,r){var f=i._locale.weekdaysParse(n,r,i._strict);f!=null?t.d=f:u(i).invalidWeekday=n});pr(["d","e","E"],function(n,t,i,r){t[r]=f(n)});sh="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_");hh="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");ch="Su_Mo_Tu_We_Th_Fr_Sa".split("_");lh=yr;ah=yr;vh=yr;r("H",["HH",2],0,"hour");r("h",["hh",2],0,ve);r("k",["kk",2],0,lp);r("hmm",0,0,function(){return""+ve.apply(this)+ni(this.minutes(),2)});r("hmmss",0,0,function(){return""+ve.apply(this)+ni(this.minutes(),2)+ni(this.seconds(),2)});r("Hmm",0,0,function(){return""+this.hours()+ni(this.minutes(),2)});r("Hmmss",0,0,function(){return""+this.hours()+ni(this.minutes(),2)+ni(this.seconds(),2)});yh("a",!0);yh("A",!1);p("hour","h");w("hour",13);i("a",ph);i("A",ph);i("H",h);i("h",h);i("HH",h,nt);i("hh",h,nt);i("hmm",ws);i("hmmss",bs);i("Hmm",ws);i("Hmmss",bs);s(["H","HH"],y);s(["a","A"],function(n,t,i){i._isPm=i._locale.isPM(n);i._meridiem=n});s(["h","hh"],function(n,t,i){t[y]=f(n);u(i).bigHour=!0});s("hmm",function(n,t,i){var r=n.length-2;t[y]=f(n.substr(0,r));t[it]=f(n.substr(r));u(i).bigHour=!0});s("hmmss",function(n,t,i){var r=n.length-4,e=n.length-2;t[y]=f(n.substr(0,r));t[it]=f(n.substr(r,2));t[ii]=f(n.substr(e));u(i).bigHour=!0});s("Hmm",function(n,t){var i=n.length-2;t[y]=f(n.substr(0,i));t[it]=f(n.substr(i))});s("Hmmss",function(n,t){var i=n.length-4,r=n.length-2;t[y]=f(n.substr(0,i));t[it]=f(n.substr(i,2));t[ii]=f(n.substr(r))});wh=/[ap]\.?m?\.?/i;var yp=ur("Hours",!0),bh={calendar:fs,longDateFormat:es,invalidDate:os,ordinal:ss,ordinalParse:hs,relativeTime:cs,months:ds,monthsShort:gs,week:oh,weekdays:sh,weekdaysMin:ch,weekdaysShort:hh,meridiemParse:wh},a={},kr={},rf;var kp=/^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,dp=/^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,gp=/Z|[+-]\d\d(?::?\d\d)?/,uf=[["YYYYYY-MM-DD",/[+-]\d{6}-\d\d-\d\d/],["YYYY-MM-DD",/\d{4}-\d\d-\d\d/],["GGGG-[W]WW-E",/\d{4}-W\d\d-\d/],["GGGG-[W]WW",/\d{4}-W\d\d/,!1],["YYYY-DDD",/\d{4}-\d{3}/],["YYYY-MM",/\d{4}-\d\d/,!1],["YYYYYYMMDD",/[+-]\d{10}/],["YYYYMMDD",/\d{8}/],["GGGG[W]WWE",/\d{4}W\d{3}/],["GGGG[W]WW",/\d{4}W\d{2}/,!1],["YYYYDDD",/\d{7}/]],we=[["HH:mm:ss.SSSS",/\d\d:\d\d:\d\d\.\d+/],["HH:mm:ss,SSSS",/\d\d:\d\d:\d\d,\d+/],["HH:mm:ss",/\d\d:\d\d:\d\d/],["HH:mm",/\d\d:\d\d/],["HHmmss.SSSS",/\d\d\d\d\d\d\.\d+/],["HHmmss,SSSS",/\d\d\d\d\d\d,\d+/],["HHmmss",/\d\d\d\d\d\d/],["HHmm",/\d\d\d\d/],["HH",/\d\d/]],nw=/^\/?Date\((\-?\d+)/i;for(n.createFromInputFallback=d("value provided is not in a recognized ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.",function(n){n._d=new Date(n._i+(n._useUTC?" UTC":""))}),n.ISO_8601=function(){},ic=d("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var n=c.apply(null,arguments);return this.isValid()&&n.isValid()?n<this?this:n:cu()}),rc=d("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/",function(){var n=c.apply(null,arguments);return this.isValid()&&n.isValid()?n>this?this:n:cu()}),fc=function(){return Date.now?Date.now():+new Date},ec("Z",":"),ec("ZZ",""),i("Z",du),i("ZZ",du),s(["Z","ZZ"],function(n,t,i){i._useUTC=!0;i._tzm=no(du,n)}),oc=/([\+\-]|\d\d)/gi,n.updateOffset=function(){},hc=/^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/,cc=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/,hi.fn=ff.prototype,yc=ac(1,"add"),pc=ac(-1,"subtract"),n.defaultFormat="YYYY-MM-DDTHH:mm:ssZ",n.defaultFormatUtc="YYYY-MM-DDTHH:mm:ss[Z]",ro=d("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.",function(n){return n===undefined?this.localeData():this.locale(n)}),r(0,["gg",2],0,function(){return this.weekYear()%100}),r(0,["GG",2],0,function(){return this.isoWeekYear()%100}),ef("gggg","weekYear"),ef("ggggg","weekYear"),ef("GGGG","isoWeekYear"),ef("GGGGG","isoWeekYear"),p("weekYear","gg"),p("isoWeekYear","GG"),w("weekYear",1),w("isoWeekYear",1),i("G",ku),i("g",ku),i("GG",h,nt),i("gg",h,nt),i("GGGG",oe,ee),i("gggg",oe,ee),i("GGGGG",bu,pu),i("ggggg",bu,pu),pr(["gggg","ggggg","GGGG","GGGGG"],function(n,t,i,r){t[r.substr(0,2)]=f(n)}),pr(["gg","GG"],function(t,i,r,u){i[u]=n.parseTwoDigitYear(t)}),r("Q",0,"Qo","quarter"),p("quarter","Q"),w("quarter",7),i("Q",ys),s("Q",function(n,t){t[ti]=(f(n)-1)*3}),r("D",["DD",2],"Do","date"),p("date","D"),w("date",9),i("D",h),i("DD",h,nt),i("Do",function(n,t){return n?t._ordinalParse:t._ordinalParseLenient}),s(["D","DD"],yt),s("Do",function(n,t){t[yt]=f(n.match(h)[0],10)}),uo=ur("Date",!0),r("DDD",["DDDD",3],"DDDo","dayOfYear"),p("dayOfYear","DDD"),w("dayOfYear",4),i("DDD",wu),i("DDDD",ps),s(["DDD","DDDD"],function(n,t,i){i._dayOfYear=f(n)}),r("m",["mm",2],0,"minute"),p("minute","m"),w("minute",14),i("m",h),i("mm",h,nt),s(["m","mm"],it),dc=ur("Minutes",!1),r("s",["ss",2],0,"second"),p("second","s"),w("second",15),i("s",h),i("ss",h,nt),s(["s","ss"],ii),gc=ur("Seconds",!1),r("S",0,0,function(){return~~(this.millisecond()/100)}),r(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),r(0,["SSS",3],0,"millisecond"),r(0,["SSSS",4],0,function(){return this.millisecond()*10}),r(0,["SSSSS",5],0,function(){return this.millisecond()*100}),r(0,["SSSSSS",6],0,function(){return this.millisecond()*1e3}),r(0,["SSSSSSS",7],0,function(){return this.millisecond()*1e4}),r(0,["SSSSSSSS",8],0,function(){return this.millisecond()*1e5}),r(0,["SSSSSSSSS",9],0,function(){return this.millisecond()*1e6}),p("millisecond","ms"),w("millisecond",16),i("S",wu,ys),i("SS",wu,nt),i("SSS",wu,ps),ci="SSSS";ci.length<=9;ci+="S")i(ci,/\d+/);for(ci="S";ci.length<=9;ci+="S")s(ci,kk);nl=ur("Milliseconds",!1);r("z",0,0,"zoneAbbr");r("zz",0,0,"zoneName");t=vr.prototype;t.add=yc;t.calendar=ib;t.clone=rb;t.diff=cb;t.endOf=nk;t.format=pb;t.from=wb;t.fromNow=bb;t.to=kb;t.toNow=db;t.get=wv;t.invalidAt=hk;t.isAfter=ub;t.isBefore=fb;t.isBetween=eb;t.isSame=ob;t.isSameOrAfter=sb;t.isSameOrBefore=hb;t.isValid=ok;t.lang=ro;t.locale=wc;t.localeData=bc;t.max=rc;t.min=ic;t.parsingFlags=sk;t.set=bv;t.startOf=gb;t.subtract=pc;t.toArray=uk;t.toObject=fk;t.toDate=rk;t.toISOString=vb;t.inspect=yb;t.toJSON=ek;t.toString=ab;t.unix=ik;t.valueOf=tk;t.creationData=ck;t.year=le;t.isLeapYear=ay;t.weekYear=lk;t.isoWeekYear=ak;t.quarter=t.quarters=wk;t.month=th;t.daysInMonth=hy;t.week=t.weeks=by;t.isoWeek=t.isoWeeks=ky;t.weeksInYear=yk;t.isoWeeksInYear=vk;t.date=uo;t.day=t.days=fp;t.weekday=ep;t.isoWeekday=op;t.dayOfYear=bk;t.hour=t.hours=yp;t.minute=t.minutes=dc;t.second=t.seconds=gc;t.millisecond=t.milliseconds=nl;t.utcOffset=lw;t.utc=vw;t.local=yw;t.parseZone=pw;t.hasAlignedHourOffset=ww;t.isDST=bw;t.isLocal=dw;t.isUtcOffset=gw;t.isUtc=sc;t.isUTC=sc;t.zoneAbbr=dk;t.zoneName=gk;t.dates=d("dates accessor is deprecated. Use date instead.",uo);t.months=d("months accessor is deprecated. Use month instead",th);t.years=d("years accessor is deprecated. Use year instead",le);t.zone=d("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/",aw);t.isDSTShifted=d("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information",kw);o=te.prototype;o.calendar=hv;o.longDateFormat=cv;o.invalidDate=lv;o.ordinal=av;o.preparse=tl;o.postformat=tl;o.relativeTime=vv;o.pastFuture=yv;o.set=sv;o.months=fy;o.monthsShort=ey;o.monthsParse=sy;o.monthsRegex=ly;o.monthsShortRegex=cy;o.week=yy;o.firstDayOfYear=wy;o.firstDayOfWeek=py;o.weekdays=np;o.weekdaysMin=ip;o.weekdaysShort=tp;o.weekdaysParse=up;o.weekdaysRegex=sp;o.weekdaysShortRegex=hp;o.weekdaysMinRegex=cp;o.isPM=ap;o.meridiem=vp;er("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(n){var t=n%10,i=f(n%100/10)===1?"th":t===1?"st":t===2?"nd":t===3?"rd":"th";return n+i}});n.lang=d("moment.lang is deprecated. Use moment.locale instead.",er);n.langData=d("moment.langData is deprecated. Use moment.localeData instead.",si);pt=Math.abs;var vd=li("ms"),yd=li("s"),pd=li("m"),wd=li("h"),bd=li("d"),kd=li("w"),dd=li("M"),gd=li("y");var tg=gi("milliseconds"),ig=gi("seconds"),rg=gi("minutes"),ug=gi("hours"),fg=gi("days"),eg=gi("months"),og=gi("years");ri=Math.round;ui={s:45,m:45,h:22,d:26,M:11};sf=Math.abs;e=ff.prototype;e.abs=od;e.add=sd;e.subtract=hd;e.as=ld;e.asMilliseconds=vd;e.asSeconds=yd;e.asMinutes=pd;e.asHours=wd;e.asDays=bd;e.asWeeks=kd;e.asMonths=dd;e.asYears=gd;e.valueOf=ad;e._bubble=cd;e.get=ng;e.milliseconds=tg;e.seconds=ig;e.minutes=rg;e.hours=ug;e.days=fg;e.weeks=sg;e.months=eg;e.years=og;e.humanize=vg;e.toISOString=hf;e.toString=hf;e.toJSON=hf;e.locale=wc;e.localeData=bc;e.toIsoString=d("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",hf);e.lang=ro;r("X",0,0,"unix");r("x",0,0,"valueOf");i("x",ku);i("X",/[+-]?\d+(\.\d{1,3})?/);s("X",function(n,t,i){i._d=new Date(parseFloat(n,10)*1e3)});s("x",function(n,t,i){i._d=new Date(f(n))});
//! moment.js
//! version : 2.17.1
//! authors : Tim Wood, Iskren Chernev, Moment.js contributors
//! license : MIT
//! momentjs.com
n.version="2.17.1";fv(c);n.fn=t;n.min=hw;n.max=cw;n.now=fc;n.utc=at;n.unix=nd;n.months=id;n.isDate=hu;n.locale=er;n.invalid=cu;n.duration=hi;n.isMoment=oi;n.weekdays=ud;n.parseZone=td;n.localeData=si;n.isDuration=de;n.monthsShort=rd;n.weekdaysMin=ed;n.defineLocale=ye;n.updateLocale=wp;n.locales=bp;n.weekdaysShort=fd;n.normalizeUnits=g;n.relativeTimeRounding=lg;n.relativeTimeThreshold=ag;n.calendarFormat=tb;n.prototype=t;
...
var wg={"1":"١","2":"٢","3":"٣","4":"٤","5":"٥","6":"٦","7":"٧","8":"٨","9":"٩","0":"٠"},bg={"١":"1","٢":"2","٣":"3","٤":"4","٥":"5","٦":"6","٧":"7","٨":"8","٩":"9","٠":"0"},cl=function(n){return n===0?0:n===1?1:n===2?2:n%100>=3&&n%100<=10?3:n%100>=11?4:5},kg={s:["أقل من ثانية","ثانية واحدة",["ثانيتان","ثانيتين"],"%d ثوان","%d ثانية","%d ثانية"],m:["أقل من دقيقة","دقيقة واحدة",["دقيقتان","دقيقتين"],"%d دقائق","%d دقيقة","%d دقيقة"],h:["أقل من ساعة","ساعة واحدة",["ساعتان","ساعتين"],"%d ساعات","%d ساعة","%d ساعة"],d:["أقل من يوم","يوم واحد",["يومان","يومين"],"%d أيام","%d يومًا","%d يوم"],M:["أقل من شهر","شهر واحد",["شهران","شهرين"],"%d أشهر","%d شهرا","%d شهر"],y:["أقل من عام","عام واحد",["عامان","عامين"],"%d أعوام","%d عامًا","%d عام"]},ut=function(n){return function(t,i){var u=cl(t),r=kg[n][cl(t)];return u===2&&(r=r[i?0:1]),r.replace(/%d/i,t)}},ll=["كانون الثاني يناير","شباط فبراير","آذار مارس","نيسان أبريل","أيار مايو","حزيران يونيو","تموز يوليو","آب أغسطس","أيلول سبتمبر","تشرين الأول أكتوبر","تشرين الثاني نوفمبر","كانون الأول ديسمبر"];n.defineLocale("ar",{months:ll,monthsShort:ll,weekdays:"الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),weekdaysShort:"أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"),weekdaysMin:"ح_ن_ث_ر_خ_ج_س".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"D/‏M/‏YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D MMMM YYYY HH:mm"},meridiemParse:/ص|م/,isPM:function(n){return"م"===n},meridiem:function(n){return n<12?"ص":"م"},calendar:{sameDay:"[اليوم عند الساعة] LT",nextDay:"[غدًا عند الساعة] LT",nextWeek:"dddd [عند الساعة] LT",lastDay:"[أمس عند الساعة] LT",lastWeek:"dddd [عند الساعة] LT",sameElse:"L"},relativeTime:{future:"بعد %s",past:"منذ %s",s:ut("s"),m:ut("m"),mm:ut("m"),h:ut("h"),hh:ut("h"),d:ut("d"),dd:ut("d"),M:ut("M"),MM:ut("M"),y:ut("y"),yy:ut("y")},preparse:function(n){return n.replace(/\u200f/g,"").replace(/[١٢٣٤٥٦٧٨٩٠]/g,function(n){return bg[n]}).replace(/،/g,",")},postformat:function(n){return n.replace(/\d/g,function(n){return wg[n]}).replace(/,/g,"،")},week:{dow:6,doy:12}});
//! moment.js locale configuration
//! locale : Azerbaijani [az]
//! author : topchiyev : https://github.com/topchiyev
cf={1:"-inci",5:"-inci",8:"-inci",70:"-inci",80:"-inci",2:"-nci",7:"-nci",20:"-nci",50:"-nci",3:"-üncü",4:"-üncü",100:"-üncü",6:"-ncı",9:"-uncu",10:"-uncu",30:"-uncu",60:"-ıncı",90:"-ıncı"};n.defineLocale("az",{months:"yanvar_fevral_mart_aprel_may_iyun_iyul_avqust_sentyabr_oktyabr_noyabr_dekabr".split("_"),monthsShort:"yan_fev_mar_apr_may_iyn_iyl_avq_sen_okt_noy_dek".split("_"),weekdays:"Bazar_Bazar ertəsi_Çərşənbə axşamı_Çərşənbə_Cümə axşamı_Cümə_Şənbə".split("_"),weekdaysShort:"Baz_BzE_ÇAx_Çər_CAx_Cüm_Şən".split("_"),weekdaysMin:"Bz_BE_ÇA_Çə_CA_Cü_Şə".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[bugün saat] LT",nextDay:"[sabah saat] LT",nextWeek:"[gələn həftə] dddd [saat] LT",lastDay:"[dünən] LT",lastWeek:"[keçən həftə] dddd [saat] LT",sameElse:"L"},relativeTime:{future:"%s sonra",past:"%s əvvəl",s:"birneçə saniyyə",m:"bir dəqiqə",mm:"%d dəqiqə",h:"bir saat",hh:"%d saat",d:"bir gün",dd:"%d gün",M:"bir ay",MM:"%d ay",y:"bir il",yy:"%d il"},meridiemParse:/gecə|səhər|gündüz|axşam/,isPM:function(n){return/^(gündüz|axşam)$/.test(n)},meridiem:function(n){return n<4?"gecə":n<12?"səhər":n<17?"gündüz":"axşam"},ordinalParse:/\d{1,2}-(ıncı|inci|nci|üncü|ncı|uncu)/,ordinal:function(n){if(n===0)return n+"-ıncı";var t=n%10,i=n%100-t,r=n>=100?100:null;return n+(cf[t]||cf[i]||cf[r])},week:{dow:1,doy:7}});
//! moment.js locale configuration
...
lf="leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_");af="led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_");n.defineLocale("cs",{months:lf,monthsShort:af,monthsParse:function(n,t){for(var r=[],i=0;i<12;i++)r[i]=new RegExp("^"+n[i]+"$|^"+t[i]+"$","i");return r}(lf,af),shortMonthsParse:function(n){for(var i=[],t=0;t<12;t++)i[t]=new RegExp("^"+n[t]+"$","i");return i}(af),longMonthsParse:function(n){for(var i=[],t=0;t<12;t++)i[t]=new RegExp("^"+n[t]+"$","i");return i}(lf),weekdays:"neděle_pondělí_úterý_středa_čtvrtek_pátek_sobota".split("_"),weekdaysShort:"ne_po_út_st_čt_pá_so".split("_"),weekdaysMin:"ne_po_út_st_čt_pá_so".split("_"),longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY H:mm",LLLL:"dddd D. MMMM YYYY H:mm",l:"D. M. YYYY"},calendar:{sameDay:"[dnes v] LT",nextDay:"[zítra v] LT",nextWeek:function(){switch(this.day()){case 0:return"[v neděli v] LT";case 1:case 2:return"[v] dddd [v] LT";case 3:return"[ve středu v] LT";case 4:return"[ve čtvrtek v] LT";case 5:return"[v pátek v] LT";case 6:return"[v sobotu v] LT"}},lastDay:"[včera v] LT",lastWeek:function(){switch(this.day()){case 0:return"[minulou neděli v] LT";case 1:case 2:return"[minulé] dddd [v] LT";case 3:return"[minulou středu v] LT";case 4:case 5:return"[minulý] dddd [v] LT";case 6:return"[minulou sobotu v] LT"}},sameElse:"L"},relativeTime:{future:"za %s",past:"před %s",s:ft,m:ft,mm:ft,h:ft,hh:ft,d:ft,dd:ft,M:ft,MM:ft,y:ft,yy:ft},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
//! locale : Chuvash [cv]
...
so=["ޖެނުއަރީ","ފެބްރުއަރީ","މާރިޗު","އޭޕްރީލު","މޭ","ޖޫން","ޖުލައި","އޯގަސްޓު","ސެޕްޓެމްބަރު","އޮކްޓޯބަރު","ނޮވެމްބަރު","ޑިސެމްބަރު"];ho=["އާދިއްތަ","ހޯމަ","އަންގާރަ","ބުދަ","ބުރާސްފަތި","ހުކުރު","ހޮނިހިރު"];n.defineLocale("dv",{months:so,monthsShort:so,weekdays:ho,weekdaysShort:ho,weekdaysMin:"އާދި_ހޯމަ_އަން_ބުދަ_ބުރާ_ހުކު_ހޮނި".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"D/M/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D MMMM YYYY HH:mm"},meridiemParse:/މކ|މފ/,isPM:function(n){return"މފ"===n},meridiem:function(n){return n<12?"މކ":"މފ"},calendar:{sameDay:"[މިއަދު] LT",nextDay:"[މާދަމާ] LT",nextWeek:"dddd LT",lastDay:"[އިއްޔެ] LT",lastWeek:"[ފާއިތުވި] dddd LT",sameElse:"L"},relativeTime:{future:"ތެރޭގައި %s",past:"ކުރިން %s",s:"ސިކުންތުކޮޅެއް",m:"މިނިޓެއް",mm:"މިނިޓު %d",h:"ގަޑިއިރެއް",hh:"ގަޑިއިރު %d",d:"ދުވަހެއް",dd:"ދުވަސް %d",M:"މަހެއް",MM:"މަސް %d",y:"އަހަރެއް",yy:"އަހަރު %d"},preparse:function(n){return n.replace(/،/g,",")},postformat:function(n){return n.replace(/,/g,"،")},week:{dow:7,doy:12}});
//! moment.js locale configuration
//! locale : Greek [el]
...
ia="jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_");ra="jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");n.defineLocale("fy",{months:"jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),monthsShort:function(n,t){return/-MMM-/.test(t)?ra[n.month()]:ia[n.month()]},monthsParseExact:!0,weekdays:"snein_moandei_tiisdei_woansdei_tongersdei_freed_sneon".split("_"),weekdaysShort:"si._mo._ti._wo._to._fr._so.".split("_"),weekdaysMin:"Si_Mo_Ti_Wo_To_Fr_So".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD-MM-YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd D MMMM YYYY HH:mm"},calendar:{sameDay:"[hjoed om] LT",nextDay:"[moarn om] LT",nextWeek:"dddd [om] LT",lastDay:"[juster om] LT",lastWeek:"[ôfrûne] dddd [om] LT",sameElse:"L"},relativeTime:{future:"oer %s",past:"%s lyn",s:"in pear sekonden",m:"ien minút",mm:"%d minuten",h:"ien oere",hh:"%d oeren",d:"ien dei",dd:"%d dagen",M:"ien moanne",MM:"%d moannen",y:"ien jier",yy:"%d jierren"},ordinalParse:/\d{1,2}(ste|de)/,ordinal:function(n){return n+(n===1||n===8||n>=20?"ste":"de")},week:{dow:1,doy:4}});
//! moment.js locale configuration
...
ea="vasárnap hétfőn kedden szerdán csütörtökön pénteken szombaton".split(" ");n.defineLocale("hu",{months:"január_február_március_április_május_június_július_augusztus_szeptember_október_november_december".split("_"),monthsShort:"jan_feb_márc_ápr_máj_jún_júl_aug_szept_okt_nov_dec".split("_"),weekdays:"vasárnap_hétfő_kedd_szerda_csütörtök_péntek_szombat".split("_"),weekdaysShort:"vas_hét_kedd_sze_csüt_pén_szo".split("_"),weekdaysMin:"v_h_k_sze_cs_p_szo".split("_"),longDateFormat:{LT:"H:mm",LTS:"H:mm:ss",L:"YYYY.MM.DD.",LL:"YYYY. MMMM D.",LLL:"YYYY. MMMM D. H:mm",LLLL:"YYYY. MMMM D., dddd H:mm"},meridiemParse:/de|du/i,isPM:function(n){return n.charAt(1).toLowerCase()==="u"},meridiem:function(n,t,i){return n<12?i===!0?"de":"DE":i===!0?"du":"DU"},calendar:{sameDay:"[ma] LT[-kor]",nextDay:"[holnap] LT[-kor]",nextWeek:function(){return oa.call(this,!0)},lastDay:"[tegnap] LT[-kor]",lastWeek:function(){return oa.call(this,!1)},sameElse:"L"},relativeTime:{future:"%s múlva",past:"%s",s:ot,m:ot,mm:ot,h:ot,hh:ot,d:ot,dd:ot,M:ot,MM:ot,y:ot,yy:ot},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
...
vf={0:"-ші",1:"-ші",2:"-ші",3:"-ші",4:"-ші",5:"-ші",6:"-шы",7:"-ші",8:"-ші",9:"-шы",10:"-шы",20:"-шы",30:"-шы",40:"-шы",50:"-ші",60:"-шы",70:"-ші",80:"-ші",90:"-шы",100:"-ші"};n.defineLocale("kk",{months:"қаңтар_ақпан_наурыз_сәуір_мамыр_маусым_шілде_тамыз_қыркүйек_қазан_қараша_желтоқсан".split("_"),monthsShort:"қаң_ақп_нау_сәу_мам_мау_шіл_там_қыр_қаз_қар_жел".split("_"),weekdays:"жексенбі_дүйсенбі_сейсенбі_сәрсенбі_бейсенбі_жұма_сенбі".split("_"),weekdaysShort:"жек_дүй_сей_сәр_бей_жұм_сен".split("_"),weekdaysMin:"жк_дй_сй_ср_бй_жм_сн".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Бүгін сағат] LT",nextDay:"[Ертең сағат] LT",nextWeek:"dddd [сағат] LT",lastDay:"[Кеше сағат] LT",lastWeek:"[Өткен аптаның] dddd [сағат] LT",sameElse:"L"},relativeTime:{future:"%s ішінде",past:"%s бұрын",s:"бірнеше секунд",m:"бір минут",mm:"%d минут",h:"бір сағат",hh:"%d сағат",d:"бір күн",dd:"%d күн",M:"бір ай",MM:"%d ай",y:"бір жыл",yy:"%d жыл"},ordinalParse:/\d{1,2}-(ші|шы)/,ordinal:function(n){var t=n%10,i=n>=100?100:null;return n+(vf[n]||vf[t]||vf[i])},week:{dow:1,doy:7}});
//! moment.js locale configuration
//! locale : Cambodian [km]
...
yf={0:"-чү",1:"-чи",2:"-чи",3:"-чү",4:"-чү",5:"-чи",6:"-чы",7:"-чи",8:"-чи",9:"-чу",10:"-чу",20:"-чы",30:"-чу",40:"-чы",50:"-чү",60:"-чы",70:"-чи",80:"-чи",90:"-чу",100:"-чү"};n.defineLocale("ky",{months:"январь_февраль_март_апрель_май_июнь_июль_август_сентябрь_октябрь_ноябрь_декабрь".split("_"),monthsShort:"янв_фев_март_апр_май_июнь_июль_авг_сен_окт_ноя_дек".split("_"),weekdays:"Жекшемби_Дүйшөмбү_Шейшемби_Шаршемби_Бейшемби_Жума_Ишемби".split("_"),weekdaysShort:"Жек_Дүй_Шей_Шар_Бей_Жум_Ише".split("_"),weekdaysMin:"Жк_Дй_Шй_Шр_Бй_Жм_Иш".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Бүгүн саат] LT",nextDay:"[Эртең саат] LT",nextWeek:"dddd [саат] LT",lastDay:"[Кече саат] LT",lastWeek:"[Өткен аптанын] dddd [күнү] [саат] LT",sameElse:"L"},relativeTime:{future:"%s ичинде",past:"%s мурун",s:"бирнече секунд",m:"бир мүнөт",mm:"%d мүнөт",h:"бир саат",hh:"%d саат",d:"бир күн",dd:"%d күн",M:"бир ай",MM:"%d ай",y:"бир жыл",yy:"%d жыл"},ordinalParse:/\d{1,2}-(чи|чы|чү|чу)/,ordinal:function(n){var t=n%10,i=n>=100?100:null;return n+(yf[n]||yf[t]||yf[i])},week:{dow:1,doy:7}});
//! moment.js locale configuration
//! locale : Luxembourgish [lb]
//! author : mweimerskirch : https://github.com/mweimerskirch
//! author : David Raison : https://github.com/kwisatz
n.defineLocale("lb",{months:"Januar_Februar_Mäerz_Abrëll_Mee_Juni_Juli_August_September_Oktober_November_Dezember".split("_"),monthsShort:"Jan._Febr._Mrz._Abr._Mee_Jun._Jul._Aug._Sept._Okt._Nov._Dez.".split("_"),monthsParseExact:!0,weekdays:"Sonndeg_Méindeg_Dënschdeg_Mëttwoch_Donneschdeg_Freideg_Samschdeg".split("_"),weekdaysShort:"So._Mé._Dë._Më._Do._Fr._Sa.".split("_"),weekdaysMin:"So_Mé_Dë_Më_Do_Fr_Sa".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"H:mm [Auer]",LTS:"H:mm:ss [Auer]",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY H:mm [Auer]",LLLL:"dddd, D. MMMM YYYY H:mm [Auer]"},calendar:{sameDay:"[Haut um] LT",sameElse:"L",nextDay:"[Muer um] LT",nextWeek:"dddd [um] LT",lastDay:"[Gëschter um] LT",lastWeek:function(){switch(this.day()){case 2:case 4:return"[Leschten] dddd [um] LT";default:return"[Leschte] dddd [um] LT"}}},relativeTime:{future:fn,past:en,s:"e puer Sekonnen",m:tu,mm:"%d Minutten",h:tu,hh:"%d Stonnen",d:tu,dd:"%d Deeg",M:tu,MM:"%d Méint",y:tu,yy:"%d Joer"},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
//! locale : Lao [lo]
...
ha={m:"minutė_minutės_minutę",mm:"minutės_minučių_minutes",h:"valanda_valandos_valandą",hh:"valandos_valandų_valandas",d:"diena_dienos_dieną",dd:"dienos_dienų_dienas",M:"mėnuo_mėnesio_mėnesį",MM:"mėnesiai_mėnesių_mėnesius",y:"metai_metų_metus",yy:"metai_metų_metus"};n.defineLocale("lt",{months:{format:"sausio_vasario_kovo_balandžio_gegužės_birželio_liepos_rugpjūčio_rugsėjo_spalio_lapkričio_gruodžio".split("_"),standalone:"sausis_vasaris_kovas_balandis_gegužė_birželis_liepa_rugpjūtis_rugsėjis_spalis_lapkritis_gruodis".split("_"),isFormat:/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?|MMMM?(\[[^\[\]]*\]|\s)+D[oD]?/},monthsShort:"sau_vas_kov_bal_geg_bir_lie_rgp_rgs_spa_lap_grd".split("_"),weekdays:{format:"sekmadienį_pirmadienį_antradienį_trečiadienį_ketvirtadienį_penktadienį_šeštadienį".split("_"),standalone:"sekmadienis_pirmadienis_antradienis_trečiadienis_ketvirtadienis_penktadienis_šeštadienis".split("_"),isFormat:/dddd HH:mm/},weekdaysShort:"Sek_Pir_Ant_Tre_Ket_Pen_Šeš".split("_"),weekdaysMin:"S_P_A_T_K_Pn_Š".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"YYYY-MM-DD",LL:"YYYY [m.] MMMM D [d.]",LLL:"YYYY [m.] MMMM D [d.], HH:mm [val.]",LLLL:"YYYY [m.] MMMM D [d.], dddd, HH:mm [val.]",l:"YYYY-MM-DD",ll:"YYYY [m.] MMMM D [d.]",lll:"YYYY [m.] MMMM D [d.], HH:mm [val.]",llll:"YYYY [m.] MMMM D [d.], ddd, HH:mm [val.]"},calendar:{sameDay:"[Šiandien] LT",nextDay:"[Rytoj] LT",nextWeek:"dddd LT",lastDay:"[Vakar] LT",lastWeek:"[Praėjusį] dddd LT",sameElse:"L"},relativeTime:{future:"po %s",past:"prieš %s",s:on,m:sr,mm:iu,h:sr,hh:iu,d:sr,dd:iu,M:sr,MM:iu,y:sr,yy:iu},ordinalParse:/\d{1,2}-oji/,ordinal:function(n){return n+"-oji"},week:{dow:1,doy:4}});
//! moment.js locale configuration
//! locale : Latvian [lv]
//! author : Kristaps Karlsons : https://github.com/skakri
//! author : Jānis Elmeris : https://github.com/JanisE
co={m:"minūtes_minūtēm_minūte_minūtes".split("_"),mm:"minūtes_minūtēm_minūte_minūtes".split("_"),h:"stundas_stundām_stunda_stundas".split("_"),hh:"stundas_stundām_stunda_stundas".split("_"),d:"dienas_dienām_diena_dienas".split("_"),dd:"dienas_dienām_diena_dienas".split("_"),M:"mēneša_mēnešiem_mēnesis_mēneši".split("_"),MM:"mēneša_mēnešiem_mēnesis_mēneši".split("_"),y:"gada_gadiem_gads_gadi".split("_"),yy:"gada_gadiem_gads_gadi".split("_")};n.defineLocale("lv",{months:"janvāris_februāris_marts_aprīlis_maijs_jūnijs_jūlijs_augusts_septembris_oktobris_novembris_decembris".split("_"),monthsShort:"jan_feb_mar_apr_mai_jūn_jūl_aug_sep_okt_nov_dec".split("_"),weekdays:"svētdiena_pirmdiena_otrdiena_trešdiena_ceturtdiena_piektdiena_sestdiena".split("_"),weekdaysShort:"Sv_P_O_T_C_Pk_S".split("_"),weekdaysMin:"Sv_P_O_T_C_Pk_S".split("_"),weekdaysParseExact:!0,longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY.",LL:"YYYY. [gada] D. MMMM",LLL:"YYYY. [gada] D. MMMM, HH:mm",LLLL:"YYYY. [gada] D. MMMM, dddd, HH:mm"},calendar:{sameDay:"[Šodien pulksten] LT",nextDay:"[Rīt pulksten] LT",nextWeek:"dddd [pulksten] LT",lastDay:"[Vakar pulksten] LT",lastWeek:"[Pagājušā] dddd [pulksten] LT",sameElse:"L"},relativeTime:{future:"pēc %s",past:"pirms %s",s:sn,m:uu,mm:ru,h:uu,hh:ru,d:uu,dd:ru,M:uu,MM:ru,y:uu,yy:ru},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
...
ga={"1":"੧","2":"੨","3":"੩","4":"੪","5":"੫","6":"੬","7":"੭","8":"੮","9":"੯","0":"੦"};nv={"੧":"1","੨":"2","੩":"3","੪":"4","੫":"5","੬":"6","੭":"7","੮":"8","੯":"9","੦":"0"};n.defineLocale("pa-in",{months:"ਜਨਵਰੀ_ਫ਼ਰਵਰੀ_ਮਾਰਚ_ਅਪ੍ਰੈਲ_ਮਈ_ਜੂਨ_ਜੁਲਾਈ_ਅਗਸਤ_ਸਤੰਬਰ_ਅਕਤੂਬਰ_ਨਵੰਬਰ_ਦਸੰਬਰ".split("_"),monthsShort:"ਜਨਵਰੀ_ਫ਼ਰਵਰੀ_ਮਾਰਚ_ਅਪ੍ਰੈਲ_ਮਈ_ਜੂਨ_ਜੁਲਾਈ_ਅਗਸਤ_ਸਤੰਬਰ_ਅਕਤੂਬਰ_ਨਵੰਬਰ_ਦਸੰਬਰ".split("_"),weekdays:"ਐਤਵਾਰ_ਸੋਮਵਾਰ_ਮੰਗਲਵਾਰ_ਬੁਧਵਾਰ_ਵੀਰਵਾਰ_ਸ਼ੁੱਕਰਵਾਰ_ਸ਼ਨੀਚਰਵਾਰ".split("_"),weekdaysShort:"ਐਤ_ਸੋਮ_ਮੰਗਲ_ਬੁਧ_ਵੀਰ_ਸ਼ੁਕਰ_ਸ਼ਨੀ".split("_"),weekdaysMin:"ਐਤ_ਸੋਮ_ਮੰਗਲ_ਬੁਧ_ਵੀਰ_ਸ਼ੁਕਰ_ਸ਼ਨੀ".split("_"),longDateFormat:{LT:"A h:mm ਵਜੇ",LTS:"A h:mm:ss ਵਜੇ",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, A h:mm ਵਜੇ",LLLL:"dddd, D MMMM YYYY, A h:mm ਵਜੇ"},calendar:{sameDay:"[ਅਜ] LT",nextDay:"[ਕਲ] LT",nextWeek:"dddd, LT",lastDay:"[ਕਲ] LT",lastWeek:"[ਪਿਛਲੇ] dddd, LT",sameElse:"L"},relativeTime:{future:"%s ਵਿੱਚ",past:"%s ਪਿਛਲੇ",s:"ਕੁਝ ਸਕਿੰਟ",m:"ਇਕ ਮਿੰਟ",mm:"%d ਮਿੰਟ",h:"ਇੱਕ ਘੰਟਾ",hh:"%d ਘੰਟੇ",d:"ਇੱਕ ਦਿਨ",dd:"%d ਦਿਨ",M:"ਇੱਕ ਮਹੀਨਾ",MM:"%d ਮਹੀਨੇ",y:"ਇੱਕ ਸਾਲ",yy:"%d ਸਾਲ"},preparse:function(n){return n.replace(/[੧੨੩੪੫੬੭੮੯੦]/g,function(n){return nv[n]})},postformat:function(n){return n.replace(/\d/g,function(n){return ga[n]})},meridiemParse:/ਰਾਤ|ਸਵੇਰ|ਦੁਪਹਿਰ|ਸ਼ਾਮ/,meridiemHour:function(n,t){return(n===12&&(n=0),t==="ਰਾਤ")?n<4?n:n+12:t==="ਸਵੇਰ"?n:t==="ਦੁਪਹਿਰ"?n>=10?n:n+12:t==="ਸ਼ਾਮ"?n+12:void 0},meridiem:function(n){return n<4?"ਰਾਤ":n<10?"ਸਵੇਰ":n<17?"ਦੁਪਹਿਰ":n<20?"ਸ਼ਾਮ":"ਰਾਤ"},week:{dow:0,doy:6}});
//! moment.js locale configuration
//! locale : Polish [pl]
//! author : Rafal Hirsz : https://github.com/evoL
vo="styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_");yo="stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_");n.defineLocale("pl",{months:function(n,t){return t===""?"("+yo[n.month()]+"|"+vo[n.month()]+")":/D MMMM/.test(t)?yo[n.month()]:vo[n.month()]},monthsShort:"sty_lut_mar_kwi_maj_cze_lip_sie_wrz_paź_lis_gru".split("_"),weekdays:"niedziela_poniedziałek_wtorek_środa_czwartek_piątek_sobota".split("_"),weekdaysShort:"ndz_pon_wt_śr_czw_pt_sob".split("_"),weekdaysMin:"Nd_Pn_Wt_Śr_Cz_Pt_So".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"dddd, D MMMM YYYY HH:mm"},calendar:{sameDay:"[Dziś o] LT",nextDay:"[Jutro o] LT",nextWeek:"[W] dddd [o] LT",lastDay:"[Wczoraj o] LT",lastWeek:function(){switch(this.day()){case 0:return"[W zeszłą niedzielę o] LT";case 3:return"[W zeszłą środę o] LT";case 6:return"[W zeszłą sobotę o] LT";default:return"[W zeszły] dddd [o] LT"}},sameElse:"L"},relativeTime:{future:"za %s",past:"%s temu",s:"kilka sekund",m:hr,mm:hr,h:hr,hh:hr,d:"1 dzień",dd:"%d dni",M:"miesiąc",MM:hr,y:"rok",yy:hr},ordinalParse:/\d{1,2}\./,ordinal:"%d.",week:{dow:1,doy:4}});
//! moment.js locale configuration
...
rv={"1":"௧","2":"௨","3":"௩","4":"௪","5":"௫","6":"௬","7":"௭","8":"௮","9":"௯","0":"௦"};uv={"௧":"1","௨":"2","௩":"3","௪":"4","௫":"5","௬":"6","௭":"7","௮":"8","௯":"9","௦":"0"};n.defineLocale("ta",{months:"ஜனவரி_பிப்ரவரி_மார்ச்_ஏப்ரல்_மே_ஜூன்_ஜூலை_ஆகஸ்ட்_செப்டெம்பர்_அக்டோபர்_நவம்பர்_டிசம்பர்".split("_"),monthsShort:"ஜனவரி_பிப்ரவரி_மார்ச்_ஏப்ரல்_மே_ஜூன்_ஜூலை_ஆகஸ்ட்_செப்டெம்பர்_அக்டோபர்_நவம்பர்_டிசம்பர்".split("_"),weekdays:"ஞாயிற்றுக்கிழமை_திங்கட்கிழமை_செவ்வாய்கிழமை_புதன்கிழமை_வியாழக்கிழமை_வெள்ளிக்கிழமை_சனிக்கிழமை".split("_"),weekdaysShort:"ஞாயிறு_திங்கள்_செவ்வாய்_புதன்_வியாழன்_வெள்ளி_சனி".split("_"),weekdaysMin:"ஞா_தி_செ_பு_வி_வெ_ச".split("_"),longDateFormat:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY, HH:mm",LLLL:"dddd, D MMMM YYYY, HH:mm"},calendar:{sameDay:"[இன்று] LT",nextDay:"[நாளை] LT",nextWeek:"dddd, LT",lastDay:"[நேற்று] LT",lastWeek:"[கடந்த வாரம்] dddd, LT",sameElse:"L"},relativeTime:{future:"%s இல்",past:"%s முன்",s:"ஒரு சில விநாடிகள்",m:"ஒரு நிமிடம்",mm:"%d நிமிடங்கள்",h:"ஒரு மணி நேரம்",hh:"%d மணி நேரம்",d:"ஒரு நாள்",dd:"%d நாட்கள்",M:"ஒரு மாதம்",MM:"%d மாதங்கள்",y:"ஒரு வருடம்",yy:"%d ஆண்டுகள்"},ordinalParse:/\d{1,2}வது/,ordinal:function(n){return n+"வது"},preparse:function(n){return n.replace(/[௧௨௩௪௫௬௭௮௯௦]/g,function(n){return uv[n]})},postformat:function(n){return n.replace(/\d/g,function(n){return rv[n]})},meridiemParse:/யாமம்|வைகறை|காலை|நண்பகல்|எற்பாடு|மாலை/,meridiem:function(n){return n<2?" யாமம்":n<6?" வைகறை":n<10?" காலை":n<14?" நண்பகல்":n<18?" எற்பாடு":n<22?" மாலை":" யாமம்"},meridiemHour:function(n,t){return n===12&&(n=0),t==="யாமம்"?n<2?n:n+12:t==="வைகறை"||t==="காலை"?n:t==="நண்பகல்"?n>=10?n:n+12:n+12},week:{dow:0,doy:6}});
//! moment.js locale configuration
//! locale : Telugu [te]
