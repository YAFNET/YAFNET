var yafEditor=function(e,t,o,n,i,a,l,s,r){this.Name=e,this.InsertNote=s,this.TypeTitle=r,this.UrlTitle=t,this.UrlDescription=o,this.UrlImageTitle=n,this.UrlImageDescription=i,this.Description=a,this.MediaTitle=l,document.querySelector(".BBCodeEditor").addEventListener("keydown",function(e){!e.ctrlKey||e.altKey||66!=e.which&&73!=e.which&&85!=e.which&&81!=e.which&&13!=e.which||(66==e.which?wrapSelection(this,"[b]","[/b]"):73==e.which?wrapSelection(this,"[i]","[/i]"):85==e.which?wrapSelection(this,"[u]","[/u]"):81==e.which?wrapSelection(this,"[quote]","[/quote]"):13==e.which&&(null!=document.querySelector('[id*="QuickReply"]')?document.querySelector('[id*="QuickReply"]').click():null!=document.querySelector('[id*="PostReply"]')&&(window.location.href=document.querySelector('[id*="PostReply"]').href)))})},doc,bod,I,StateMaker;function removeFormat(e){var t,o,n,i,a;e.setSelectionRange&&(t=e.selectionStart,i=(n=e.value.substring(t,o=e.selectionEnd)).replace(/\[.*?\]/g,""),a=n.length-i.length,e.value=e.value.replace(n,i),setSelectionRange(e,t,o-a))}function setSelectionRange(e,t,o){e.setSelectionRange?(e.focus(),e.setSelectionRange(t,o)):e.createTextRange&&((e=e.createTextRange()).collapse(!0),e.moveEnd("character",o),e.moveStart("character",t),e.select())}function setCaretToPos(e,t){setSelectionRange(e,t,t)}function replaceSelection(e,t){var o,n;e.setSelectionRange?(o=e.selectionStart,n=e.selectionEnd,e.value=e.value.substring(0,o)+t+e.value.substring(n),o!=n?setSelectionRange(e,o,o+t.length):setCaretToPos(e,o+t.length)):(e.value+=t,e.focus())}function removeFromSelection(e,t,o){var n,i,a;e.setSelectionRange&&(n=e.selectionStart,-1!=(a=e.value.substring(n,i=e.selectionEnd)).indexOf(t))&&-1!=a.indexOf(o)&&(e.value=e.value.substring(0,n)+e.value.substring(n+t.length,i-o.length)+e.value.substring(i),n!=i?setSelectionRange(e,n,i-o.length-t.length):setCaretToPos(e,n+t.length))}function wrapSelection(e,t,o){var n,i;e.setSelectionRange?(n=e.selectionStart,i=e.selectionEnd,e.value=e.value.substring(0,n)+t+e.value.substring(n,i)+o+e.value.substring(i),n!=i?setSelectionRange(e,n,t.length+o.length+i):setCaretToPos(e,n+t.length)):(e.value+=t,e.focus(),e.value+=o),e.dispatchEvent(new Event("change"))}function getCurrentSelection(e){return!!e.setSelectionRange&&e.selectionStart!=e.selectionEnd}yafEditor.prototype.FormatText=function(e,t){var o=document.getElementById(this.Name);switch(e){case"bold":wrapSelection(o,"[b]","[/b]");break;case"italic":wrapSelection(o,"[i]","[/i]");break;case"underline":wrapSelection(o,"[u]","[/u]");break;case"highlight":wrapSelection(o,"[h]","[/h]");break;case"code":wrapSelection(o,"[code]","[/code]");break;case"codelang":wrapSelection(o,`[code=${t}]`,"[/code]");break;case"media":getCurrentSelection(o)?wrapSelection(o,"[media]","[/media]"):bootbox.prompt({title:this.MediaTitle,placeholder:"https://",callback:function(e){replaceSelection(o,`[media]${e}[/media]`)}});break;case"createNote":bootbox.confirm({title:this.InsertNote,message:`<form><div class="mb-3">
