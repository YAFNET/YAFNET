...
namespace YAF.Pages.Admin
{
    ...
    public partial class eventloggroupaccess : AdminPage
  {
    ...
    protected override void CreatePageLinks()
    {
     ...
     // parent page
     this.PageLinks.AddLink(this.GetText("ADMIN_EVENTLOGGROUPS", "TITLE"), YafBuildLink.GetLink(ForumPages.admin_eventloggroups));
    ...
    protected void GrantAllDelete_Click([NotNull] object sender, [NotNull] EventArgs e)
    {
        ...
        if (this.Request.QueryString.GetFirstOrDefault("r") != null)
        {
            ...
            foreach (RepeaterItem ri in this.AccessList.Items)
            {
                if (!((CheckBox) ri.FindControl("ViewAccess")).Checked) continue;
                ...
                // save it
                LegacyDb.eventloggroupaccess_save(
                    groupId, eventTypeId.ToType<int>(), etn, true);
            }
        }
    ...
    protected void RevokeAllDelete_Click([NotNull] object sender, [NotNull] EventArgs e)
    {
        ...
        if (this.Request.QueryString.GetFirstOrDefault("r") != null)
        {
            ...
            foreach (RepeaterItem ri in this.AccessList.Items)
            {
                ...
                // save it
                LegacyDb.eventloggroupaccess_save(
                    groupId, eventTypeId.ToType<int>(), 
                    etn, false);
            }
        }
    ...
    private void BindData()
    {
        ...
        if (this.Request.QueryString.GetFirstOrDefault("r") != null)
        {
            ...
            var dt = LegacyDb.eventloggroupaccess_list(
                this.Request.QueryString.GetFirstOrDefault("r"),null);
            ...
            foreach (int eventValue in listEnumValues)
            {
                ...
                foreach (var dr in dt.Rows.Cast<DataRow>().Where(dr => dr["EventTypeID"].ToType<int>() == eventTypeId))
                {
                    found = true; 
                    adminPageAccesses.Add(new GroupEventLogAccess
                                              {
            ...
            {
                this.GroupName.Text =
                    this.HtmlEncode(dt.Rows[0]["GroupName"]);
            }
    ...
    protected void AccessList_OnItemDataBound([NotNull] object source, [NotNull] RepeaterItemEventArgs e)
   {
       ...
       eventText.Text = this.GetText("ADMIN_EVENTLOGROUPACCESS", "LT_{0}".FormatWith(drowv.EventTypeName.ToUpperInvariant()));
