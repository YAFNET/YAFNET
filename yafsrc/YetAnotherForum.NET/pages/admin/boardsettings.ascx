...
<YAF:AdminMenu runat="server" ID="Adminmenu1">
	<table class="content" cellspacing="1" cellpadding="0" width="100%">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel4" runat="server" LocalizedTag="BOARD_THREADED" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel6" runat="server" LocalizedTag="BOARD_MOBILE_THEME" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel7" runat="server" LocalizedTag="BOARD_THEME_LOGO" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
        ...
        <tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel8" runat="server" LocalizedTag="BOARD_JQ_THEME" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
        ...
        <tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel9" runat="server" LocalizedTag="BOARD_CDN_HOSTED" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel10" runat="server" LocalizedTag="BOARD_CULTURE" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel11" runat="server" LocalizedTag="BOARD_TOPIC_DEFAULT" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel12" runat="server" LocalizedTag="BOARD_FILE_EXTENSIONS" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
       ...
       <tr id="PollGroupList" runat="server" visible="false">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel13" runat="server" LocalizedTag="BOARD_EMAIL_ONREGISTER" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel14" runat="server" LocalizedTag="BOARD_EMAIL_MODS" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel15" runat="server" LocalizedTag="BOARD_ALLOW_DIGEST" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				<YAF:HelpLabel ID="LocalizedLabel16" runat="server" LocalizedTag="BOARD_DIGEST_NEWUSERS" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
				 <YAF:HelpLabel ID="LocalizedLabel17" runat="server" LocalizedTag="BOARD_DEFAULT_NOTIFICATION" LocalizedPage="ADMIN_BOARDSETTINGS" />
            </td>
			<td class="post">
