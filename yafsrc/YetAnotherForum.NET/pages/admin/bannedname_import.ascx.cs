...
namespace YAF.Pages.Admin
{
    ...
    /// <summary>
    /// The Admin Banned Name Import List Page.
    /// </summary>
    public partial class bannedname_import : AdminPage
    {
        #region Methods
        ...
        protected void Page_Load([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            this.PageLinks.AddLink(this.GetText("ADMIN_BANNEDNAME_IMPORT", "TITLE"), string.Empty);

            this.Page.Header.Title = "{0} - {1} - {2}".FormatWith(
                this.GetText("ADMIN_ADMIN", "Administration"),
                this.GetText("ADMIN_BANNEDNAME", "TITLE"),
                this.GetText("ADMIN_BANNEDNAME_IMPORT", "TITLE"));

            this.Import.Text = this.GetText("ADMIN_BANNEDNAME_IMPORT", "IMPORT");
