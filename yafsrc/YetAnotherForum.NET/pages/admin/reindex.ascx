    ...
    <table class="content" width="100%" cellspacing="1" cellpadding="0">
        ...
        <tr class="footer1">
            <td>
                ...
                <asp:Button ID="btnShrink" runat="server" Text="Shrink YAF Database" OnClientClick="return confirm('Are you sure you want to Shrink database? The operation may make the DB inaccessible and may take a little while.');"
