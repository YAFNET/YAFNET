	...
	<table cellpadding="0" cellspacing="1" class="content" width="100%">
		...
		<tr class="footer1">
			...
			<asp:Placeholder ID="PanelRecoveryMode" runat="server" Visible="False">
				<td rowspan="3">
					<asp:Button ID="btnRecoveryMode" runat="server" OnClick="btnRecoveryMode_Click" Text="Set Recovery Mode" Width="200px" />
		...
		<tr class="footer1">
			<asp:Placeholder ID="PanelReindex" runat="server" Visible="False">
				<td valign="top">
					<asp:Button ID="btnReindex" runat="server" OnClick="btnReindex_Click" Text="Reindex Tables" Width="200px" />
					<br />
		...
		<tr class="footer1">
			<asp:Placeholder ID="PanelShrink" runat="server" Visible="False">
				<td valign="top">
					<asp:Button ID="btnShrink" runat="server" OnClick="btnShrink_Click" Text="Shrink Database" Width="200px" />
					<br />
