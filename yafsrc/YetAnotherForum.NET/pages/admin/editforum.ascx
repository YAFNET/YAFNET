...
<YAF:adminmenu runat="server" id="Adminmenu1">
	<table class="content" cellspacing="1" cellpadding="0" width="100%">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel1" runat="server" LocalizedTag="CATEGORY" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel2" runat="server" LocalizedTag="PARENT_FORUM" LocalizedPage="ADMIN_EDITCATEGORY" />
              <strong></strong><br />
				</td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel3" runat="server" LocalizedTag="NAME" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel4" runat="server" LocalizedTag="DESCRIPTION" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel14" runat="server" LocalizedTag="REMOTE_URL" LocalizedPage="ADMIN_EDITCATEGORY" />
              <strong></strong><br />
				</td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel13" runat="server" LocalizedTag="THEME" LocalizedPage="ADMIN_EDITCATEGORY" />
              </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel12" runat="server" LocalizedTag="SORT_ORDER" LocalizedPage="ADMIN_EDITCATEGORY" />
              <strong></strong><br />
				</td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel11" runat="server" LocalizedTag="HIDE_NOACESS" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel10" runat="server" LocalizedTag="LOCKED" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel9" runat="server" LocalizedTag="NO_POSTSCOUNT" LocalizedPage="ADMIN_EDITCATEGORY" />
              </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel8" runat="server" LocalizedTag="PRE_MODERATED" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
		...
		<tr>
			<td class="postheader">
			  <YAF:HelpLabel ID="HelpLabel7" runat="server" LocalizedTag="FORUM_IMAGE" LocalizedPage="ADMIN_EDITCATEGORY" />
			</td>			
			<td class="post">
		...
		<tr visible="false" runat="server">
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel6" runat="server" LocalizedTag="STYLES" LocalizedPage="ADMIN_EDITCATEGORY" />
            <strong></strong><br />
				</td>
			<td class="post">
		...
		<tr id="NewGroupRow" runat="server">
			<td class="postheader">
              <YAF:HelpLabel ID="HelpLabel5" runat="server" LocalizedTag="INITAL_MASK" LocalizedPage="ADMIN_EDITCATEGORY" />
            </td>
			<td class="post">
