...
namespace YAF.Pages.Admin
{
    ...
    public partial class nntpretrieve : AdminPage
    {
        ...
        protected void Page_Load([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            this.Retrieve.Text =
                "<i class=\"fa fa-get-pocket fa-fw\"></i>&nbsp;{0}".FormatWith(
                    this.GetText("ADMIN_NNTPRETRIEVE", "RETRIEVE"));
        ...
        protected void Retrieve_Click([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            int nArticleCount = this.Get<INewsreader>()
                .ReadArticles(
            ...
            this.PageContext.AddLoadMessage(
                this.GetText("ADMIN_NNTPRETRIEVE", "Retrieved")
                    .FormatWith(nArticleCount, (double)nArticleCount / nSeconds));
            this.BindData();
        }
