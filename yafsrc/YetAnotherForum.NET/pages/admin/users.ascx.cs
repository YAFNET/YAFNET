    ...
    public partial class users : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.Since.SelectedIndex = Since.Items.Count - 1;
        ...
        protected void SyncUsers_Click(object sender, EventArgs e)
        {
            ...
            // show blocking ui...
            this.PageContext.PageElements.RegisterJsBlockStartup("BlockUIExecuteJs", JavaScriptBlocks.BlockUIExecuteJs("SyncUsersMessage"));
        }
