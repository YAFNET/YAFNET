        ...
        if (!PageContext.IsGuest)
        {
            ...
            string tagButtonHTML =
                string.Format(
                    ...
                    PageContext.Localization.GetText("BUTTON_TAGFAVORITE_TT"),
                    PageContext.Localization.GetText("BUTTON_TAGFAVORITE"));
            string untagButtonHTML =
                string.Format(
                    ...
                    PageContext.Localization.GetText("BUTTON_UNTAGFAVORITE_TT"),
                    PageContext.Localization.GetText("BUTTON_UNTAGFAVORITE"));
