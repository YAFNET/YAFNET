...
namespace YAF.Pages
{
    ...
    public partial class posts : ForumPage
    {
        ...
        private void BindData()
        {
           ...
           !this.PageContext.IsAdmin && !this.PageContext.IsForumModerator)
            ...
            if (this._topic["LastPosted"] != DBNull.Value)
            {
                ...
                {
                    lastRead = this.Get<IYafSession>().GetTopicRead(this.PageContext.PageTopicID);
                    lastReadForum = this.Get<IYafSession>().GetForumRead(this.PageContext.PageForumID); 
                }
        ...
        /// <summary>
        /// Handle Topic Read Tracking for the Current User
        /// </summary>
        private void HandleTopicReadTracking()
        {
            ...
            {
                this.Get<IYafSession>().SetTopicRead(this.PageContext.PageTopicID, DateTime.UtcNow);
            }
        }
