...
<asp:Repeater ID="repLastPosts" runat="server" Visible="true">
	...
	<ItemTemplate>
		<tr class="postheader">
			<td width="140">
				<b><YAF:UserLink ID="ProfileLink" runat="server" UserID='<%# Convert.ToInt32(Eval( "UserID" )) %>'
					UserName='<%# Eval( "UserName" ).ToString() %>' BlankTarget="true" /></b>
			</td>
	...
	<AlternatingItemTemplate>
		<tr class="postheader">
			<td width="140">
				<b><YAF:UserLink ID="ProfileLinkAlt" runat="server" UserID='<%# Convert.ToInt32(Eval( "UserID" )) %>'
					UserName='<%# Eval( "UserName" ).ToString() %>' BlankTarget="true" /></b>
			</td>
			<td width="80%" class="small" align="left">
				<b>
