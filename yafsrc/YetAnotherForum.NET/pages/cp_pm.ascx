        ...
        <asp:Panel id="PmTabs" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="card-header">
                    <i class="fa fa-envelope fa-fw"></i>&nbsp;<YAF:LocalizedLabel ID="LocalizedLabel6" runat="server" LocalizedTag="INBOX" />
                </div>
                <div class="card-body">
            ...
            <ContentTemplate>
                <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-envelope fa-fw"></i>&nbsp;<YAF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="SENTITEMS" />
                </div>
                <div class="card-body">
            ...
            <ContentTemplate>
                <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-envelope fa-fw"></i>&nbsp;<YAF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="ARCHIVE" />
                </div>
                <div class="card-body">
