...
<table class='command' width='100%'>
    <tr>
        ...
        <td>
            <YAF:ThemeButton ID="MoveTopic1" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_MOVETOPIC"
                TitleLocalizedTag="BUTTON_MOVETOPIC_TT" OnClick="MoveTopic_Click" />
            <YAF:ThemeButton ID="UnlockTopic1" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_UNLOCKTOPIC"
                TitleLocalizedTag="BUTTON_UNLOCKTOPIC_TT" OnClick="UnlockTopic_Click" />
            <YAF:ThemeButton ID="LockTopic1" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_LOCKTOPIC"
                TitleLocalizedTag="BUTTON_LOCKTOPIC_TT" OnClick="LockTopic_Click" />
            <YAF:ThemeButton ID="DeleteTopic1" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_DELETETOPIC"
            ...
            <YAF:ThemeButton ID="PostReplyLink1" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_POSTREPLY"
...
<table class="command" cellspacing="0" cellpadding="0" width="100%">
    <tr>
        ...
        <td>
            <YAF:ThemeButton ID="MoveTopic2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_MOVETOPIC"
                TitleLocalizedTag="BUTTON_MOVETOPIC_TT" OnClick="MoveTopic_Click" />
            <YAF:ThemeButton ID="UnlockTopic2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_UNLOCKTOPIC"
                TitleLocalizedTag="BUTTON_UNLOCKTOPIC_TT" OnClick="UnlockTopic_Click" />
            <YAF:ThemeButton ID="LockTopic2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_LOCKTOPIC"
                TitleLocalizedTag="BUTTON_LOCKTOPIC_TT" OnClick="LockTopic_Click" />
            <YAF:ThemeButton ID="DeleteTopic2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_DELETETOPIC"
                TitleLocalizedTag="BUTTON_DELETETOPIC_TT" OnClick="DeleteTopic_Click" OnLoad="DeleteTopic_Load" />
            <YAF:ThemeButton ID="NewTopic2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_NEWTOPIC"
                TitleLocalizedTag="BUTTON_NEWTOPIC_TT" OnClick="NewTopic_Click" />
            <YAF:ThemeButton ID="PostReplyLink2" runat="server" CssClass="yafcssbigbutton rightItem" TextLocalizedTag="BUTTON_POSTREPLY"
                TitleLocalizedTag="BUTTON_POSTREPLY_TT" OnClick="PostReplyLink_Click" />
        </td>
    </tr>
</table>
