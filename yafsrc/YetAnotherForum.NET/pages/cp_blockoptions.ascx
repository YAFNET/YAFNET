<%@ Control Language="c#" AutoEventWireup="True" Inherits="YAF.Pages.cp_blockoptions"CodeBehind="cp_blockoptions.ascx.cs" %>

<YAF:PageLinks runat="server" ID="PageLinks" />

<div class="row">
    <div class="col-xl-12">
        <h2><YAF:LocalizedLabel ID="LocalizedLabel11" runat="server" LocalizedTag="TITLE" LocalizedPage="CP_BLOCKOPTIONS" /></h2>
    </div>
</div>
