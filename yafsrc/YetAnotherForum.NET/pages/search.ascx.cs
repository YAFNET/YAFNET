...
namespace YAF.Pages
{
    ...
    public partial class search : ForumPage
    {
            ...
            if (searchTooSmall)
            {
                this.PageContext.AddLoadMessage(
                    this.GetTextFormatted(
                        "SEARCH_CRITERIA_ERROR_MIN", this.PageContext.BoardSettings.SearchStringMinLength));
            }
            else if (searchTooLarge)
            {
                this.PageContext.AddLoadMessage(
                    this.GetTextFormatted(
                        "SEARCH_CRITERIA_ERROR_MAX", this.PageContext.BoardSettings.SearchStringMaxLength));
            }
      ...
      try
      {
            ...
            var pagedData =
                YafContext.Current.Get<YafSession>().SearchData.AsEnumerable().Skip(this.Pager.SkipIndex).Take(
                    this.Pager.PageSize);
