...
namespace YAF.Pages.moderate
{
  ...
  /// </summary>
  public partial class reportedspam : ForumPage
  {
    #region Constructors & Overriden Methods

    /// <summary>
    /// Initializes a new instance of the <see cref="reportedspam"/> class. 
    /// Default constructor.
    /// </summary>
    public reportedspam()
      : base("MODERATE_FORUM")
    ...
    private void BindData()
    {
      ...
      this.List.DataSource = DB.message_listreported(8, PageContext.PageForumID);
