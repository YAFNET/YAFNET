...
namespace YAF.Pages
{
    ...
    public partial class attachments : ForumPage
    {
        ...
        {
            DataTable dt = this.GetRepository<Attachment>().List(
                this.Get<HttpRequestBase>().QueryString.GetFirstOrDefaultAs<int>("m"), null, null, 0, 1000);
        ...
        private void SaveAttachment([NotNull] object messageID, [NotNull] HtmlInputFile file)
        {
            ...
            {
                this.GetRepository<Attachment>().Save(
            ...
            else
            {
                ...
                this.GetRepository<Attachment>().Save(messageID.ToType<int>(), filename, file.PostedFile.ContentLength, file.PostedFile.ContentType);
            }
        }
