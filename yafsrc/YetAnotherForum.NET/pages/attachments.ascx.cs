...
namespace YAF.Pages
{
    ...
    public partial class attachments : ForumPage
    {
        ...
        private void SaveAttachment(object messageID, HtmlInputFile file)
        {
            ...
            {
                PageContext.AddLoadMessage(PageContext.Localization.GetTextFormatted("UPLOAD_TOOBIG", (file.PostedFile.ContentLength / 1024), (PageContext.BoardSettings.MaxFileSize / 1024)));
