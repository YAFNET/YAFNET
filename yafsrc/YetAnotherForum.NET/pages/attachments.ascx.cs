...
namespace YAF.Pages // YAF.Pages
{
	...
	public partial class attachments : YAF.Classes.Core.ForumPage
	{
		...
		protected void List_ItemCommand( object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e )
		{
		...
		private void SaveAttachment( object messageID, HtmlInputFile file )
		{
			...
			string sUpDir = Request.MapPath( String.Concat( UrlBuilder.FileRoot, YafBoardFolders.Current.Uploads ) );
