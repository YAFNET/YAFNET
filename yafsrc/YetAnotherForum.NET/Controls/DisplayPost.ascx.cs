...
public partial class DisplayPost : BaseUserControl
{
    ...
    private void FormatThanksRow()
    {
        ...
        // Register Javascript
        var addThankBoxHTML =
            "'<a class=\"btn btn-link\" href=\"javascript:addThanks(' + response.MessageID + ');\" onclick=\"this.blur();\" title=' + response.Title + '><i class=\"fas fa-heart text-danger\"></i><span class=\"ms-1 d-none d-lg-inline-block\">' + response.Text + '</span></a>'";

        var removeThankBoxHTML =
            "'<a class=\"btn btn-link\" href=\"javascript:removeThanks(' + response.MessageID + ');\" onclick=\"this.blur();\" title=' + response.Title + '><i class=\"far fa-heart\"></i><span class=\"ms-1 d-none d-lg-inline-block\">' + response.Text + '</span></a>'";
