    ...
    public partial class PollList : BaseUserControl
    {
            ...
            if (this.pollAndChoices.Any())
            {
                ...
                else if (daysToRun == 0)
                {
                    ...
                    this.PollClosed.Text =
                        $"<span class=\"badge badge-danger ml-1\"><i class=\"fa fa-lock fa-fw\"></i>&nbsp;{this.GetText("POLLEDIT", "POLL_CLOSED")}</span>";
        ...
        private void LoadData()
        {
            ...
            if (this.PollId > 0)
            {
                ...
                if (!this.canChange && this.PageContext.ForumPageType == ForumPages.PostMessage)
                {
