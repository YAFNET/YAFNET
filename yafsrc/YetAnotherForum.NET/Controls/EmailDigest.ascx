                    ...
                    <asp:Repeater runat="server" ID="NewTopicsRepeater">
                        <ItemTemplate>
                            <h6 class="card-subtitle">
                                <a href="<%# this.Get<LinkBuilder>().GetLink(ForumPages.Posts, true, "m={0}&name={1}", ((SimpleTopic)Container.DataItem).LastMessageID, ((SimpleTopic)Container.DataItem).Subject) %>"
                                   target="_blank">
                            ...
                            <a class="btn btn-primary btn-sm mx-auto mt-2"
                               href="<%# this.Get<LinkBuilder>().GetLink(ForumPages.Posts, true, "m={0}&name={1}", ((SimpleTopic)Container.DataItem).LastMessageID, ((SimpleTopic)Container.DataItem).Subject) %>"
                               target="_blank">
                                <%# this.GetText("LINK") %></a>
                        </ItemTemplate>
                    </asp:Repeater>
