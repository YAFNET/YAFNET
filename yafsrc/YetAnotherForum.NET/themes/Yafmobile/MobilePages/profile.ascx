...
<%@ Register TagPrefix="YAF" TagName="BuddyList" Src="buddylist.ascx" %>
...
<table class="content" width="100%" cellspacing="1" cellpadding="0">
	...
	<tr class="post">
		<td colspan="2">
			<YAF:ThemeButton ID="PM" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="PM" />
			<YAF:ThemeButton ID="Email" runat="server" TextLocalizedPage="POSTS"
				TextLocalizedTag="EMAIL"  />
			<YAF:ThemeButton ID="Home" runat="server" TextLocalizedPage="POSTS"
				TextLocalizedTag="HOME" />
			<YAF:ThemeButton ID="Blog" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="BLOG" />
			<YAF:ThemeButton ID="MSN" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="MSN" />
			<YAF:ThemeButton ID="AIM" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="AIM"  />
			<YAF:ThemeButton ID="YIM" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="YIM"  />
			<YAF:ThemeButton ID="ICQ" runat="server"  TextLocalizedPage="POSTS"
				TextLocalizedTag="ICQ"  />
			<YAF:ThemeButton ID="Skype" runat="server"  TextLocalizedPage="POSTS"
