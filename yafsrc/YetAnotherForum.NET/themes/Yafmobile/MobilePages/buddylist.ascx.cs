...
namespace YAF.Controls
{
    ...
    /// </summary>
    public partial class BuddyListMobile : BaseUserControl
    {
        /// <summary>
        /// the control mode.
        /// </summary>
        ...
        protected void rptBuddy_ItemCommand(object sender, CommandEventArgs e)
        {
            ...
            UpdateBuddyList(ControlHelper.FindControlRecursiveAs<BuddyListMobile>(Container, "BuddyList1"), 2);
            UpdateBuddyList(ControlHelper.FindControlRecursiveAs<BuddyListMobile>(Container, "PendingBuddyList"), 3);
            UpdateBuddyList(ControlHelper.FindControlRecursiveAs<BuddyListMobile>(Container, "BuddyRequested"), 4);
        }
        ...
        /// </param>
        private void UpdateBuddyList(BuddyListMobile customBuddyList, int BuddyListMode)
        {
