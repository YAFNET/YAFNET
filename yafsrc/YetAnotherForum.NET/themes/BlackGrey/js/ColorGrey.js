        ...
        if (jQuery('img.avatarimage').length) {
            jQuery('img.avatarimage').onImagesLoaded(function(_this) {
                jQuery(_this).wrap(function() {
                    return '<span class="AvatarWrap" style="position:relative; display:inline-block; background:url(' +
                        jQuery(_this).attr('src') + ') no-repeat center center; width: auto; height: auto;" />';
                });
