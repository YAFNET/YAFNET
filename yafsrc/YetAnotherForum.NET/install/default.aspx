        ...
        <asp:Wizard ID="InstallWizard" runat="server" ActiveStepIndex="1" 
            ...
            <WizardSteps>
                ...
                <asp:WizardStep runat="server" Title="Upgrade Database" ID="WizInitDatabase">
                    <strong><%# IsInstalled ? "Upgrade" : "Initialize" %> Database</strong><br />
                    <br />
                    Clicking next will <%# IsInstalled ? "upgrade" : "initialize" %> your database to the latest version.<br />
                    <br />
                    <asp:CheckBox ID="FullTextSupport" runat="server" Text="Attempt to Install FullText Search Support" />
                    <br />
                    <asp:CheckBox ID="UpgradeExtensions" Checked="True" Visible="<%# IsInstalled %>" runat="server" Text="Upgrade BBCode Extensions, File Extensions and Topic Status Lists" />
                </asp:WizardStep>
