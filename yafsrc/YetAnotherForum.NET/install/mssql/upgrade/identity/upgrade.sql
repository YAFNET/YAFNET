...
/****/
 ...
 /* Migrate users yaf.net provider */
  ...
  SELECT  
      ...
      [{databaseOwner}].[{objectQualifier}prov_Membership].Joined,
      [{databaseOwner}].[{objectQualifier}prov_Membership].IsApproved, 0, 
      [{databaseOwner}].[{objectQualifier}prov_Membership].Joined,
      [{databaseOwner}].[{objectQualifier}prov_Membership].Joined,cast('1753-1-1' as datetime),cast('1753-1-1' as datetime),
      0,
