...
if exists(select top 1 1 from sys.indexes where name=N'IX_{objectQualifier}CheckEmail' and object_id=object_id(N'[{databaseOwner}].[{objectQualifier}CheckEmail]'))
