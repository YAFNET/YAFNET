...
BEGIN
		...
		a.EditReason,
		a.Position,
		EditedByUserName = (SELECT Name FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = a.EditedBy),
		EditedByDisplayName = (SELECT DisplayName FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = a.EditedBy),
...
SELECT
		...
		m.EditReason,
		m.Position,
		EditedByUserName = (SELECT Name FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = m.EditedBy),
		EditedByDisplayName = (SELECT DisplayName FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = m.EditedBy),
...
BEGIN
		...
		b.[Flags],
		EditedByUserName = (SELECT Name FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = b.EditedBy),
		EditedByDisplayName = (SELECT DisplayName FROM [{databaseOwner}].[{objectQualifier}User] WHERE UserID = b.EditedBy),
