...
begin
	...
	begin
		DROP INDEX [{databaseOwner}].[{objectQualifier}prov_RoleMembership].[IX_{objectQualifier}prov_RoleMembership_UserID] ON [{databaseOwner}].[{objectQualifier}prov_RoleMembership]
	end
	-- alter the column
