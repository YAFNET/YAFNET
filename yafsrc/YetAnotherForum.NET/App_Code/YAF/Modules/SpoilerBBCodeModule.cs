...
namespace YAF.Modules
{
  ...
  public class SpoilerBBCodeModule : YafBBCodeControl
  {
    ...
    protected override void Render(HtmlTextWriter writer)
    {
      ...
      string spoilerTitle = HtmlEncode(LocalizedString("SPOILERMOD_TOOLTIP", "Click here to show or hide the hidden text (also known as a spoiler)"));
      ...
      sb.AppendFormat(
        ...
        GetUniqueID("spoilerBtn"), 
        GetUniqueID("spoil_"), 
        HtmlEncode(LocalizedString("SPOILERMOD_SHOW", "Show Spoiler")), 
        spoilerTitle);
