                                ...
                                <div class="list-group list-group-flush small">
                                    <div class="list-group-item list-group-item-action">
                                        ...
                                        <YAF:ThemeButton ID="ViewUnapprovedPostsBtn" runat="server" 
                                            ...
                                            <span class="badge text-light-emphasis bg-light-subtle"><%# ((ModerateForum)Container.DataItem).MessageCount %></span>
                                        </YAF:ThemeButton>
                                        ...
                                        <YAF:ThemeButton ID="ViewReportedBtn" runat="server" 
                                            ...
                                            <span class="badge text-light-emphasis bg-light-subtle"><%# ((ModerateForum)Container.DataItem).ReportedCount %></span>
                                        </YAF:ThemeButton>
