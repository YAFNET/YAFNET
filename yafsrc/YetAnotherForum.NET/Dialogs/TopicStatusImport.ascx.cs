...
namespace YAF.Dialogs
{
    ...
    /// <summary>
    /// The Admin Topic Status Import Dialog.
    /// </summary>
    public partial class TopicStatusImport : BaseUserControl
    {
        #region Methods
        ...
        protected void Import_OnClick([NotNull] object sender, [NotNull] EventArgs e)
        {
            ...
            try
            {
                var importedCount = DataImport.TopicStatusImport(
            ...
            {
                this.PageContext.AddLoadMessage(
                    this.GetText("ADMIN_TOPICSTATUS_IMPORT", "IMPORT_FAILED").FormatWith(x.Message), MessageTypes.danger);
            }
        }
