...
module.exports = [
	{
		entry: {
			...
			'forum-index': './wwwroot/lib/pages/forum-index.ts',
			messages: './wwwroot/lib/pages/messages.ts',
			myaccount: './wwwroot/lib/pages/myaccount.ts',
			notification: './wwwroot/lib/pages/notification.ts',
			...
			topics: './wwwroot/lib/pages/topics.ts',
