...
namespace YAF
{
	...
	public class Forum : UserControl, IHaveServiceLocator
	{
		...
		protected override void Render([NotNull] HtmlTextWriter writer)
		{
			...
			writer.Write(
				@"<div id=""yafpage_{0}"" class=""{1}"">".FormatWith(this._page.ToString(), this._page.ToString().Replace(".", "_")));
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			try
			{
				...
				this._header = this.LoadControl("{0}controls/{1}.ascx".FormatWith(YafForumInfo.ForumServerFileRoot, "YafHeader"));
			...
			{
				this.Controls.Add(this.LoadControl("{0}controls/{1}.ascx".FormatWith(YafForumInfo.ForumServerFileRoot, "LoginBox")));
			}
