<%@ Page language="c#" Codebehind="cp_sentitems.aspx.cs" AutoEventWireup="false" Inherits="yaf.cp_sentitems" %>
...
<HeaderTemplate>
	...
	<tr>
		<td class=header1 colspan=2><%= GetText("cp_sentitems_title") %></td>
	</tr>
</HeaderTemplate>
<FooterTemplate>
	</table>
...
<ItemTemplate>
	...
	<tr>
		<td class=postheader><%# DataBinder.Eval(Container.DataItem,"ToUser") %></td>
		<td class=postheader>
			<table cellspacing=0 cellpadding=0 width=100%><tr>
			<td>
				<b><%= GetText("cp_sentitems_posted") %>:</b> <%# FormatDateTime((System.DateTime)((System.Data.DataRowView)Container.DataItem)["Created"]) %>
			</td>
			<td align=right>
