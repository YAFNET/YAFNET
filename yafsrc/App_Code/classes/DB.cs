...
namespace yaf
{
	...
	static public class DB
	{
		...
		#region yaf_Group
		static public int group_get(int nBoardID,string role) 
		{
			using(SqlCommand cmd = new SqlCommand("select GroupID from dbo.yaf_Group where BoardID=@BoardID and [Name]=@Role")) 
			{
				cmd.CommandType = CommandType.Text;
		...
		static public long group_save(object GroupID,object boardID,object Name,object IsAdmin,object IsStart,object isModerator,object accessMaskID) 
		{
        ...
        static public bool user_register(pages.ForumPage page, object boardID, object userName, object password, object email, object location, object homePage, object timeZone, bool emailVerification, object providerUserKey) 
		{
