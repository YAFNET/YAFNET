...
<table class=content cellSpacing=1 cellPadding=0 width="100%">
  ...
  <tr>
    <td class=postheader colspan=4><b>Is Ladder Group:</b><br/>If this is checked, this group should be part of the ladder system where users advance as they post messages.</td>
    <td class=post colspan=7><asp:checkbox id="IsLadder" runat="server"></asp:checkbox></td></tr>

	<tr>
		<td class=postheader colspan=4><b>Minimum Posts:</b><br/>Minimum number of posts before users are advanced to this group.</td>
		<td class=post colspan=7><asp:textbox id="MinPosts" runat="server"/></td>
	</tr>
	<tr>
		<td class=postheader colspan=4><b>Rank Image:</b><br/>This image will be shown next to members of this group.</td>
