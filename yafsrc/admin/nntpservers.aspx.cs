...
namespace yaf.admin
{
	...
	public class nntpservers : AdminPage
	{
		...
		{
			RankList.DataSource = DB.nntpserver_list(null);
			DataBind();
		}
		...
		private void RankList_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
		{
			...
			{
				case "edit":
					Response.Redirect(String.Format("editnntpserver.aspx?s={0}",e.CommandArgument));
					break;
				case "delete":
		...
		{
			Response.Redirect("editnntpserver.aspx");
		}
	}
}
