...
namespace YAF.Configuration
{
    ...
    public class BoardFolders
    {
        ...
        /// Gets Current.
        /// </summary>
        public static BoardFolders Current => PageSingleton<BoardFolders>.Instance;

        /// <summary>
        /// Gets BoardFolder.
        /// </summary>
        public string BoardFolder =>
            Config.MultiBoardFolders ? $"{Config.BoardRoot}{ControlSettings.Current.BoardID}/" : Config.BoardRoot;
