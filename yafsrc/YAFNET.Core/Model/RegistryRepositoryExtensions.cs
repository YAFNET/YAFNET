...
public static class RegistryRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<Registry> repository)
    {
        /// <summary>
        ...
        /// The board id.
        /// </param>
        public void UpdateMaxStats(int boardId)
        {
        ...
        /// </summary>
        public void IncrementDeniedRegistrations()
        {
        ...
        /// </summary>
        public void IncrementBannedUsers()
        {
        ...
        /// </summary>
        public void IncrementReportedSpammers()
        {
        ...
        /// The board id.
        /// </param>
        public List<Registry> List(int? boardId = null)
        {
        ...
        ///     The app version.
        /// </param>
        public DbVersionType ValidateVersion(int appVersion)
        {
            try
            {
