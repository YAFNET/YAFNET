...
public static class MedalRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<Medal> repository)
    {
        /// <summary>
        ...
        /// The user Id.
        /// </param>
        public List<(int MedalID, string Name, string Message, string MedalURL, byte SortOrder, bool Hide, int Flags, DateTime DateAwarded)>
            ListUserMedals(int userId)
        {
