...
public static class UserRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<User> repository)
    {
        /// <summary>
        ...
        /// The board id.
        /// </param>
        public async Task UpdateStylesAsync(int boardId)
        {
        ...
        /// The user Id.
        /// </param>
        public async Task UpdateStyleAsync(int userId)
        {
        ...
        /// The <see cref="long"/>.
        /// </returns>
        public Task<long> BoardMembersAsync(int boardId)
        {
        ...
        /// </returns>
        public Task<List<Tuple<MessageReportedAudit, User>>> MessageReportersAsync(int messageId)
        {
        ...
        /// </returns>
        public Task<List<Tuple<User, MessageReportedAudit>>> MessageReporterAsync(int messageId,
            int userId)
        {
            var expression = OrmLiteConfig.DialectProvider.SqlExpression<User>();
        ...
        /// </returns>
        public async Task<List<LastActive>> LastActiveAsync(int boardId,
            int guestUserId,
            DateTime startDate,
            int displayNumber)
        {
        ...
        /// The points.
        /// </param>
        public async Task AddPointsAsync(int userId,
            int? fromUserId,
            int points)
        {
        ...
        /// The points.
        /// </param>
        public async Task RemovePointsAsync(int userId,
            int? fromUserId,
            int points)
        {
            await repository.UpdateAddAsync(() => new User { Points = -points }, u => u.ID == userId);
        ...
        /// The rank id.
        /// </param>
        public Task AdminSaveAsync(int boardId,
            int userId,
            int flags,
            int rankId)
        {
        ...
        /// The user.
        /// </param>
        public async Task ApproveAsync(User user)
        {
        ...
        /// The <see cref="int"/>.
        /// </returns>
        public async Task<int> AspNetAsync(int boardId,
            string userName,
            string displayName,
            string email,
        ...
        /// List of the Users
        /// </returns>
        public async Task<List<User>> WatchMailListAsync(int topicId,
            int userId)
        {
        ...
        /// </returns>
        public Task<List<string>> GroupEmailsAsync(int groupId)
        {
            var expression = OrmLiteConfig.DialectProvider.SqlExpression<User>();
        ...
        /// Returns the User Id
        /// </returns>
        public async Task<User> GetUserByProviderKeyAsync(int? boardId, string providerUserKey)
        {
            return boardId == null
        ...
        /// Returns the Stats.
        /// </returns>
        public async Task<dynamic> MaxAlbumDataAsync(int userId,
            int boardId)
        {
        ...
        /// Returns the Stats
        /// </returns>
        public async Task<dynamic> SignatureDataAsync(int userId,
            int boardId)
        {
        ...
        /// </returns>
        public Task<UserLazyData> LazyDataAsync(int userId,
            int boardId,
        ...
        /// The display name.
        /// </param>
        public async Task UpdateDisplayNameAsync(User user,
            string displayName)
        {
        ...
        /// </param>
        public async Task SaveAvatarAsync(int userId,
            string avatarUrl,
            Stream stream,
        ...
        /// The daily Digest.
        /// </param>
        public Task SaveNotificationAsync(int userId,
        ...
        /// </returns>
        public Task<List<User>> ListAdminsAsync(int? boardId = null)
        {
            var expression = OrmLiteConfig.DialectProvider.SqlExpression<User>();
        ...
        /// </returns>
        public Task<List<User>> GetUnApprovedUsersAsync(int boardId)
        {
        ...
        public Task SaveSignatureAsync(int userId,
            string signature)
        {
        ...
        public Task SetPointsAsync(int userId, int points)
        {
        ...
        public Task SuspendAsync(int userId,
        ...
        /// The flags.
        /// </param>
        public Task UpdateBlockFlagsAsync(int userId, int flags)
        {
        ...
        /// The list of users.
        /// </returns>
        public async Task<List<ActiveUser>> GetRecentUsersAsync()
        {
        ...
        /// </returns>
        public async Task<List<SimpleModerator>> GetForumModeratorsAsync()
        {
        ...
        public Task<List<User>> GetRegisteredUsersByMonthAsync(int boardId)
        {
