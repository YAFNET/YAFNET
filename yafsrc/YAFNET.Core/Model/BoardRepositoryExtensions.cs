...
public static class BoardRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<Board> repository)
    {
        /// <summary>
        ...
        /// The <see cref="int"/>.
        /// </returns>
        public async Task<int> CreateAsync(string boardName,
        ...
        /// </returns>
        public async Task<BoardStat> PostStatsAsync(int boardId, bool showNoCountPosts)
        {
        ...
        /// The <see cref="BoardStat"/>.
        /// </returns>
        public Task<BoardStat> StatsAsync(int boardId)
        {
        ...
        public Task<List<int>> GetAllBoardIdsAsync()
        {
            return repository.DbAccess.ExecuteAsync(
                db =>
                {
