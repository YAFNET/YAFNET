...
public static class PollVoteRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<PollVote> repository)
    {
        /// <summary>
        ...
        /// The user id.
        /// </param>
        public List<PollVote> VoteCheck(int pollId,
            int userId)
        {
        ...
        /// The poll id.
        /// </param>
        public List<Tuple<PollVote, User>> Voters(int pollId)
        {
