...
public static class ForumAccessRepositoryExtensions
{
    ...
    /// The repository.
    /// </param>
    extension(IRepository<ForumAccess> repository)
    {
        /// <summary>
        ...
        /// The group identifier.
        /// </param>
        public List<(int ForumID, string ForumName, int? ParentID, int AccessMaskID)> ListByGroups(int groupId)
        {
        ...
        public Task SaveAsync(int forumId,
            int groupId,
            int accessMaskId)
        {
        ...
        /// The access mask id.
        /// </param>
        public void Create(int forumId,
            int groupId,
            int accessMaskId)
        {
        ...
        /// The forum id.
        /// </param>
        public List<Tuple<ForumAccess, Group>> GetForumAccessList(int forumId)
        {
            var expression = OrmLiteConfig.DialectProvider.SqlExpression<ForumAccess>();
