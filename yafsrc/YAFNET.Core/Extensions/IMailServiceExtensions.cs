...
public static class IMailServiceExtensions
{
    ...
    extension(IMailService sendMail)
    {
        /// <summary>
        /// The send.
        /// </summary>
        ...
        public Task SendAsync(string fromEmail,
            string toEmail,
            string senderEmail,
            string subject,
            string body)
        ...
        /// <param name="subject">The subject.</param>
        /// <param name="bodyText">The body text.</param>
        public Task SendAsync(MailboxAddress fromAddress,
        ...
        /// </returns>
        public MimeMessage CreateMessage(MailboxAddress fromAddress,
            MailboxAddress toAddress,
            MailboxAddress senderAddress,
            string subject,
            string bodyText,
