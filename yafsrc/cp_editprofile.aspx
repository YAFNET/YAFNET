...
<asp:TextBox id=HomePage runat="server"></asp:TextBox></td>
	...
	<tr>
		...
		<td class=post>
<asp:DropDownList id=TimeZones runat="server" DataTextField="Name" DataValueField="Value"></asp:DropDownList></td>
	</tr>
...
<tr>
	...
	<td class=post><asp:textbox cssclass=edit id=Avatar runat=server></asp:textbox></td>
</tr>
