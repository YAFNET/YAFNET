...
internal class WebmanifestTagHelperComponent : TagHelperComponent
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.PostContent.AppendHtml(this.CreateLink("apple-touch-startup-image",
        ...
        output.PostContent.AppendHtml(this.CreateLink("apple-touch-icon", $"{this._options.BaseRoute}assets/apple-icon-180.webp"));
