...
namespace YAF.Core.Services
{
    ...
    /// </summary>
    public class YafActivityStream : IActivityStream, IHaveServiceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YafActivityStream"/> class.
        /// </summary>
        /// <param name="serviceLocator">
        /// The service locator.
        /// </param>
        public YafActivityStream([NotNull] IServiceLocator serviceLocator)
        {
