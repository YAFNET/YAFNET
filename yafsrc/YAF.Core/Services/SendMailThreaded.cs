...
namespace YAF.Core.Services
{
    ...
    ///     instance.
    /// </summary>
    public class SendMailThreaded : ISendMailThreaded, IHaveServiceLocator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SendMailThreaded" /> class.
        /// </summary>
        /// <param name="sendMail">The send mail.</param>
        /// <param name="logger">The logger.</param>
        /// <param name="serviceLocator">The service locator.</param>
        public SendMailThreaded([NotNull] ISendMail sendMail, ILogger logger, IServiceLocator serviceLocator)
        {
        ...
        public void SendThreaded()
        {
            ...
            try
            {
                ...
                mailList.ForEach(n => this.Logger.Debug("Process Id {0} to User {1}", this.UniqueProcessId, n.ToUser));
...
#else
                    this.Logger.Log(null, this, $"Invalid Email Address: {ex.ToString()}", EventLogTypes.Warning);
#endif
                }
            }
        }
