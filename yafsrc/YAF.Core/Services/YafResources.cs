...
namespace YAF.Core.Services
{
    ...
    /// The YAF Resources
    /// </summary>
    public class YafResources : IResources, IHaveServiceLocator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YafResources"/> class.
        /// </summary>
        /// <param name="serviceLocator">
        /// The service locator.
        /// </param>
        public YafResources([NotNull] IServiceLocator serviceLocator)
        {
