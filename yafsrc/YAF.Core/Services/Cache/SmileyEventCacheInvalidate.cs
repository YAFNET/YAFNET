...
namespace YAF.Core.Services.Cache
{
    ...
    /// <summary>
    ///     The smiley event cache invalidate.
    /// </summary>
    [ExportService(ServiceLifetimeScope.OwnedByContainer)]
    public class SmileyEventCacheInvalidate : IHandleEvent<RepositoryEvent<Smiley>>
    {
        #region Fields
        ...
        /// The object store.
        /// </param>
        public SmileyEventCacheInvalidate(IDataCache dataCache, IObjectStore objectStore)
        {
