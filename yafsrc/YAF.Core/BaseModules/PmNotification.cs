...
public class PmNotification : BaseForumModule, IHandleEvent<ForumPagePostLoadEvent>
{
    /// <summary>
    /// Gets Order.
    /// </summary>
    ...
    public void Handle(ForumPagePostLoadEvent @event)
    {
        ...
        if (this.DisplayPmPopup() && this.PageContext.CurrentForumPage.PageName != ForumPages.MyMessages)
        {
            ...
            this.Get<ISessionService>().LastPm = this.PageContext.LastUnreadPm;
    ...
    protected bool DisplayPmPopup()
    {
        return this.PageContext.UnreadPrivate > 0
               && this.PageContext.LastUnreadPm > this.Get<ISessionService>().LastPm;
    }
