        ...
        public class Identity : IEquatable<Identity>
        {
            ...
            private Identity(string sql, CommandType? commandType, string connectionString, Type type, Type parametersType, Type[] otherTypes, int gridIndex)
            {
                ...
                unchecked
                {
                    ...
                    hashCode = this.hashCode * 23 + commandType.GetHashCode();
                    hashCode = this.hashCode * 23 + gridIndex.GetHashCode();
                    hashCode = this.hashCode * 23 + (sql?.GetHashCode() ?? 0);
                    hashCode = this.hashCode * 23 + (type?.GetHashCode() ?? 0);
                    if (otherTypes != null)
                    {
