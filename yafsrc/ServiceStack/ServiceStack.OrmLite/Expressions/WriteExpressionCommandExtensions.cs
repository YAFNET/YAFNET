...
static internal class WriteExpressionCommandExtensions
{
    ...
    extension(IDbCommand dbCmd)
    {
        ...
        public int UpdateOnlyFields<T>(T model,
        ...
        /// <param name="model">The model.</param>
        /// <param name="onlyFields">The only fields.</param>
        internal void UpdateOnlySql<T>(T model, SqlExpression<T> onlyFields)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        internal int UpdateOnlyFields<T>(T obj,
        ...
        /// <param name="commandFilter">The command filter.</param>
        /// <returns>System.Int32.</returns>
        internal int UpdateOnlyFields<T>(Expression<Func<T>> updateFields,
            SqlExpression<T> q,
            Action<IDbCommand> commandFilter = null)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        /// <param name="commandFilter">The command filter.</param>
        /// <returns>System.Int32.</returns>
        internal int UpdateOnly<T>(Expression<Func<T>> updateFields,
            SqlExpression<T> q,
            Action<IDbCommand> commandFilter = null)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        internal IDbCommand InitUpdateOnly<T>(Expression<Func<T>> updateFields, SqlExpression<T> q)
        {
        ...
        /// <returns>IDbCommand.</returns>
        /// <exception cref="System.ArgumentNullException">updateFields</exception>
        internal IDbCommand InitUpdateOnly<T>(Expression<Func<T>> updateFields, string whereExpression, IEnumerable<IDbDataParameter> sqlParams)
        {
            ArgumentNullException.ThrowIfNull(updateFields);
        ...
        /// <returns>IDbCommand.</returns>
        /// <exception cref="System.ArgumentNullException">updateFields</exception>
        internal IDbCommand InitUpdateAdd<T>(Expression<Func<T>> updateFields, SqlExpression<T> q)
        {
            ArgumentNullException.ThrowIfNull(updateFields);
        ...
        /// <returns>System.Int32.</returns>
        /// <exception cref="System.ArgumentNullException">updateFields</exception>
        public int UpdateOnlyFields<T>(Dictionary<string, object> updateFields,
    ...
    extension(IDbCommand dbCmd)
    {
        ...
        /// <exception cref="System.ArgumentNullException">updateFields</exception>
        public int UpdateOnlyReferences<T>(Dictionary<string, object> updateFields, Func<Dictionary<string, object>, int> fn)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        /// <param name="whereParams">The where parameters.</param>
        /// <exception cref="System.ArgumentNullException">updateFields</exception>
        internal void PrepareUpdateOnly<T>(Dictionary<string, object> updateFields, string whereExpression, object[] whereParams)
        {
            ArgumentNullException.ThrowIfNull(updateFields);
        ...
        /// <param name="where">The where.</param>
        /// <returns>System.Int32.</returns>
        public int UpdateNonDefaults<T>(T item, Expression<Func<T, bool>> where)
        {
        ...
        /// <param name="commandFilter">The command filter.</param>
        /// <returns>System.Int32.</returns>
        public int Update<T>(T item, Expression<Func<T, bool>> expression, Action<IDbCommand> commandFilter = null)
        {
            OrmLiteConfig.UpdateFilter?.Invoke(dbCmd, item);
        ...
        /// <param name="commandFilter">The command filter.</param>
        /// <returns>System.Int32.</returns>
        public int Update<T>(object updateOnly, Expression<Func<T, bool>> where = null, Action<IDbCommand> commandFilter = null)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        internal bool PrepareUpdateAnonSql<T>(IOrmLiteDialectProvider dialectProvider, object updateOnly, string whereSql)
        {
        ...
        public long InsertOnly<T>(T obj, string[] onlyFields, bool selectIdentity)
        {
        ...
        /// <param name="selectIdentity">if set to <c>true</c> [select identity].</param>
        /// <returns>System.Int64.</returns>
        public long InsertOnly<T>(Expression<Func<T>> insertFields, bool selectIdentity)
        {
        ...
        /// <param name="q">The q.</param>
        /// <returns>IDbCommand.</returns>
        internal IDbCommand InitUpsert<T>(T model, SqlExpression<T> q)
        {
            OrmLiteUtils.AssertNotAnonType<T>();
        ...
        internal IDbCommand InitInsertOnly<T>(Expression<Func<T>> insertFields)
        {
