...
public static class OrmLiteReadExpressionsApiAsync
{
    ...
    extension(IDbConnection dbConn)
    {
        ...
        public Task<List<T>> SelectAsync<T>(Expression<Func<T, bool>> predicate, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> SelectAsync<T>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Into>> SelectAsync<Into, From>(SqlExpression<From> expression, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> SelectAsync<T>(ISqlExpression expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2>>> SelectMultiAsync<T, T2>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2, T3>>> SelectMultiAsync<T, T2, T3>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2, T3, T4>>> SelectMultiAsync<T, T2, T3, T4>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2, T3, T4, T5>>> SelectMultiAsync<T, T2, T3, T4, T5>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2, T3, T4, T5, T6>>> SelectMultiAsync<T, T2, T3, T4, T5, T6>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        public Task<List<Tuple<T, T2, T3, T4, T5, T6, T7>>> SelectMultiAsync<T, T2, T3, T4, T5, T6, T7>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2>>> SelectMultiAsync<T, T2>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2, T3&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2, T3>>> SelectMultiAsync<T, T2, T3>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2, T3, T4&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2, T3, T4>>> SelectMultiAsync<T, T2, T3, T4>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2, T3, T4, T5&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2, T3, T4, T5>>> SelectMultiAsync<T, T2, T3, T4, T5>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2, T3, T4, T5, T6&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2, T3, T4, T5, T6>>> SelectMultiAsync<T, T2, T3, T4, T5, T6>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Tuple&lt;T, T2, T3, T4, T5, T6, T7&gt;&gt;&gt;.</returns>
        public Task<List<Tuple<T, T2, T3, T4, T5, T6, T7>>> SelectMultiAsync<T, T2, T3, T4, T5, T6, T7>(SqlExpression<T> expression, string[] tableSelects, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;T&gt;.</returns>
        public Task<T> SingleAsync<T>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;T&gt;.</returns>
        public Task<T> SingleAsync<T>(ISqlExpression expression, CancellationToken token = default)
        {
        ...
        public Task<TKey> ScalarAsync<T, TKey>(Expression<Func<T, object>> field, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;TKey&gt;.</returns>
        public Task<TKey> ScalarAsync<T, TKey>(Expression<Func<T, object>> field, Expression<Func<T, bool>> predicate, CancellationToken token = default)
        {
        ...
        public Task<long> CountAsync<T>(Expression<Func<T, bool>> expression, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;System.Int64&gt;.</returns>
        public Task<long> CountAsync<T>(SqlExpression<T> expression, CancellationToken token = default)
        {
            return dbConn.Exec(dbCmd => dbCmd.CountAsync(expression, token));
        }
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;System.Int64&gt;.</returns>
        public Task<long> RowCountAsync<T>(SqlExpression<T> expression, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;System.Int64&gt;.</returns>
        public Task<long> RowCountAsync(string sql, object anonType = null, CancellationToken token = default)
        {
        ...
        /// </summary>
        public Task<long> RowCountAsync<T>()
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> LoadSelectAsync<T>(Expression<Func<T, bool>> predicate, string[] include = null, CancellationToken token = default)
        {
        ...
        /// <param name="include">The include.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> LoadSelectAsync<T>(Expression<Func<T, bool>> predicate, Expression<Func<T, object>> include)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> LoadSelectAsync<T>(SqlExpression<T> expression, string[] include = null, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;T&gt;&gt;.</returns>
        public Task<List<T>> LoadSelectAsync<T>(SqlExpression<T> expression, IEnumerable<string> include, CancellationToken token = default)
        {
            return dbConn.Exec(dbCmd => dbCmd.LoadSelectAsync(expression, include, token));
        }
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Into&gt;&gt;.</returns>
        public Task<List<Into>> LoadSelectAsync<Into, From>(SqlExpression<From> expression, string[] include = null, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;List&lt;Into&gt;&gt;.</returns>
        public Task<List<Into>> LoadSelectAsync<Into, From>(SqlExpression<From> expression, IEnumerable<string> include, CancellationToken token = default)
        {
            return dbConn.Exec(dbCmd => dbCmd.LoadSelectAsync<Into, From>(expression, include, token));
        }
        ...
        /// <param name="include">The include.</param>
        /// <returns>Task&lt;List&lt;Into&gt;&gt;.</returns>
        public Task<List<Into>> LoadSelectAsync<Into, From>(SqlExpression<From> expression, Expression<Func<Into, object>> include)
        {
        ...
        public Task<DataTable> GetSchemaTableAsync(string sql, CancellationToken token = default)
        {
        ...
        public Task<ColumnSchema[]> GetTableColumnsAsync<T>(CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;ColumnSchema[]&gt;.</returns>
        public Task<ColumnSchema[]> GetTableColumnsAsync(Type type, CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task&lt;ColumnSchema[]&gt;.</returns>
        public Task<ColumnSchema[]> GetTableColumnsAsync(string sql, CancellationToken token = default)
        {
        ...
        public Task EnableForeignKeysCheckAsync(CancellationToken token = default)
        {
        ...
        /// <param name="token">The cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Task.</returns>
        public Task DisableForeignKeysCheckAsync(CancellationToken token = default)
        {
