...
namespace ServiceStack.OrmLite.Base.Text
{
    ...
    public class HttpResultsFilter : IHttpResultsFilter
    {
        ...
        {
            return this.StringResultFn != null ? this.StringResultFn(webReq, reqBody) : this.StringResult;
        }

        public byte[] GetBytes(HttpWebRequest webReq, byte[] reqBody)
        {
            return this.BytesResultFn != null ? this.BytesResultFn(webReq, reqBody) : this.BytesResult;
        }
