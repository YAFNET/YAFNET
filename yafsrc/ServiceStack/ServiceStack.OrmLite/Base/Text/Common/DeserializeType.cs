    ...
    where TSerializer : ITypeSerializer
{
    ...
    internal struct StringToTypeContext
    {
        ...
        internal object DeserializeJson(ReadOnlySpan<char> value) => DeserializeTypeRefJson.StringToType(value, this.typeConfig, this.ctorFn, this.accessors);
        ...
        /// <param name="value">The value.</param>
        /// <returns>System.Object.</returns>
        internal object DeserializeJsv(ReadOnlySpan<char> value) => DeserializeTypeRefJsv.StringToType(value, this.typeConfig, this.ctorFn, this.accessors);
    }
