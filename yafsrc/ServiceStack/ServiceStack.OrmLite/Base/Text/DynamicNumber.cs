...
public class DynamicSByte : IDynamicNumber
{
    ...
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object mod(object lhs, object rhs) => this.Convert(lhs) % this.Convert(rhs);
    /// <summary>
    /// Minimums the specified LHS.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object min(object lhs, object rhs) => Math.Min(this.Convert(lhs), this.Convert(rhs));
    /// <summary>
    /// Maximums the specified LHS.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object max(object lhs, object rhs) => Math.Max(this.Convert(lhs), this.Convert(rhs));
    /// <summary>
    /// Pows the specified LHS.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object pow(object lhs, object rhs) => Math.Pow(this.Convert(lhs), this.Convert(rhs));
    /// <summary>
    /// Logs the specified LHS.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object log(object lhs, object rhs) => Math.Log(this.Convert(lhs), this.Convert(rhs));
    /// <summary>
    /// Compares to.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Int32.</returns>
    public int compareTo(object lhs, object rhs) => this.Convert(lhs).CompareTo(this.Convert(rhs));
    ...
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseAnd(object lhs, object rhs) => this.Convert(lhs) & this.Convert(rhs);
    /// <summary>
    /// Bitwises the or.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseOr(object lhs, object rhs) => this.Convert(lhs) | this.Convert(rhs);
    /// <summary>
    /// Bitwises the x or.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseXOr(object lhs, object rhs) => this.Convert(lhs) ^ this.Convert(rhs);
    /// <summary>
    /// Bitwises the left shift.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseLeftShift(object lhs, object rhs) => this.Convert(lhs) << this.Convert(rhs);
    /// <summary>
    /// Bitwises the right shift.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseRightShift(object lhs, object rhs) => this.Convert(lhs) >> this.Convert(rhs);
}
...
public class DynamicUInt : IDynamicNumber
{
    ...
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseLeftShift(object lhs, object rhs) => this.Convert(lhs) << (int)this.Convert(rhs);
    /// <summary>
    /// Bitwises the right shift.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object bitwiseRightShift(object lhs, object rhs) => this.Convert(lhs) >> (int)this.Convert(rhs);
}
...
public class DynamicDecimal : IDynamicNumber
{
    ...
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object pow(object lhs, object rhs) => Math.Pow((double)this.Convert(lhs), (double)this.Convert(rhs));
    /// <summary>
    /// Logs the specified LHS.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
    /// <param name="rhs">The RHS.</param>
    /// <returns>System.Object.</returns>
    public object log(object lhs, object rhs) => Math.Log((double)this.Convert(lhs), (double)this.Convert(rhs));
    /// <summary>
    /// Compares to.
    /// </summary>
    /// <param name="lhs">The LHS.</param>
