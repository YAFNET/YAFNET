...
namespace ServiceStack.Templates
{
    ...
    public partial class TemplateDefaultFilters
    {
        public List<object> step(IEnumerable target, object scopeOptions)
        {
            ...
            var from = scopedParams.TryGetValue("from", out var oFrom) ? (int)oFrom : 0;

            var by = scopedParams.TryGetValue("by", out var oBy) ? (int)oBy : 1;
        ...
        public bool contains(object target, object needle)
        {
            ...
            throw new NotSupportedException(
                $"'{nameof(contains)}' requires a string or IEnumerable but received a '{target.GetType()?.Name}' instead");
        }

        public IEnumerable<object>
            take(TemplateScopeContext scope, IEnumerable<object> original, object countOrBinding) =>
            original.Take(scope.GetValueOrEvaluateBinding<int>(countOrBinding));

        public IEnumerable<object>
            skip(TemplateScopeContext scope, IEnumerable<object> original, object countOrBinding) =>
            original.Skip(scope.GetValueOrEvaluateBinding<int>(countOrBinding));

        public IEnumerable<object> limit(
            TemplateScopeContext scope,
            IEnumerable<object> original,
            object skipOrBinding,
            object takeOrBinding)
        {
        ...
        public int count(TemplateScopeContext scope, object target, object expression) =>
            count(scope, target, expression, null);
        ...
        public object sum(TemplateScopeContext scope, object target, object expression) =>
            sum(scope, target, expression, null);
        ...
        public object min(TemplateScopeContext scope, object target, object expression) =>
            min(scope, target, expression, null);
        ...
        public object max(TemplateScopeContext scope, object target, object expression) =>
            max(scope, target, expression, null);
        ...
        public double average(TemplateScopeContext scope, object target, object expression) =>
            average(scope, target, expression, null);

        public double average(TemplateScopeContext scope, object target, object expression, object scopeOptions) =>
            applyInternal(nameof(average), scope, target, expression, scopeOptions, (a, b) => a + b).ConvertTo<double>()
            / target.AssertEnumerable(nameof(average)).Count();

        private object applyInternal(
            string filterName,
            TemplateScopeContext scope,
            object target,
            object expression,
            ...
            Func<double, double, double> fn)
        {
            ...
            var total = filterName == nameof(min) ? double.MaxValue : 0;
            Type itemType = null;
            if (expression != null)
            {
            ...
            return itemType == null || itemType == typeof(double) ? total : total.ConvertTo(itemType);
        }

        public object reduce(TemplateScopeContext scope, object target, object expression) =>
            reduce(scope, target, expression, null);
        ...
        public object let(TemplateScopeContext scope, object target, object scopeBindings)
        {
            // from filter
            if (target is IEnumerable objs)
            {
                var scopedParams = scope.GetParamsWithItemBindingOnly(
                    nameof(let),
                    null,
                    scopeBindings,
                    out var itemBinding);
                ...
                foreach (var item in objs)
                {
                    ...
                    foreach (var entry in scopedParams)
                    {
                        ...
                        if (!(entry.Value is string bindToLiteral))
                            throw new NotSupportedException(
                                $"'{nameof(let)}' in '{scope.Page.VirtualPath}' expects a string Expression for its value but received '{entry.Value}' instead");
            ...
            if (target != null)
                throw new NotSupportedException(
                    $"'{nameof(let)}' in '{scope.Page.VirtualPath}' requires an IEnumerable but received a '{target.GetType()?.Name}' instead");

            return null;
        }

        public object first(TemplateScopeContext scope, object target) =>
            target.AssertEnumerable(nameof(first)).FirstOrDefault();

        public object first(TemplateScopeContext scope, object target, object expression) =>
            first(scope, target, expression, null);
        ...
        public bool any(TemplateScopeContext scope, object target, object expression) =>
            any(scope, target, expression, null);
        ...
        public bool all(TemplateScopeContext scope, object target, object expression) =>
            all(scope, target, expression, null);
        ...
        public IEnumerable<object> where(TemplateScopeContext scope, object target, object expression) =>
            where(scope, target, expression, null);

        public IEnumerable<object> where(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions)
        ...
        public IEnumerable<object> takeWhile(TemplateScopeContext scope, object target, object expression) =>
            takeWhile(scope, target, expression, null);
        ...
        public IEnumerable<object> skipWhile(TemplateScopeContext scope, object target, object expression) =>
            skipWhile(scope, target, expression, null);

        public IEnumerable<object> skipWhile(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions)
        ...
        public IEnumerable<object> orderBy(TemplateScopeContext scope, object target, object expression) =>
            orderBy(scope, target, expression, null);

        public IEnumerable<object> orderBy(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions) =>
        ...
        public IEnumerable<object> orderByDescending(TemplateScopeContext scope, object target, object expression) =>
            orderByDescending(scope, target, expression, null);

        public IEnumerable<object> orderByDescending(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions) =>
        ...
        public IEnumerable<object> orderByDesc(TemplateScopeContext scope, object target, object expression) =>
            orderByDesc(scope, target, expression, null);

        public IEnumerable<object> orderByDesc(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions) =>
        ...
        public IEnumerable<object> thenBy(TemplateScopeContext scope, object target, object expression) =>
            thenBy(scope, target, expression, null);

        public IEnumerable<object> thenBy(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions) =>
        ...
        public IEnumerable<object> thenByDescending(TemplateScopeContext scope, object target, object expression) =>
            thenByDescending(scope, target, expression, null);

        public IEnumerable<object> thenByDescending(
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions) =>
        ...
        private static IComparer<object> GetComparer(
            string filterName,
            TemplateScopeContext scope,
        ...
        public static IEnumerable<object> orderByInternal(
            string filterName,
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions)
        {
            ...
            var sorted = filterName == nameof(orderByDescending)
                             ? items.OrderByDescending(
                                 item => scope.AddItemToScope(itemBinding, item, i++).Evaluate(value, binding),
                                 comparer)
                             : items.OrderBy(
                                 item => scope.AddItemToScope(itemBinding, item, i++).Evaluate(value, binding),
                                 comparer);
        ...
        public static IEnumerable<object> thenByInternal(
            string filterName,
            TemplateScopeContext scope,
            object target,
            object expression,
            object scopeOptions)
        {
            if (!(target is IOrderedEnumerable<object> items))
                throw new NotSupportedException(
                    $"'{filterName}' in '{scope.Page.VirtualPath}' requires an IOrderedEnumerable but received a '{target?.GetType()?.Name}' instead");
        ...
        public IEnumerable<IGrouping<object, object>> groupBy(
            ...
            object expression) =>
            groupBy(scope, items, expression, null);
        ...
        public object get(object target, object key)
        {
            ...
            throw new NotSupportedException(
                $"'{nameof(get)}' expects a collection but received a '{target.GetType().Name}'");
        }
    }
}