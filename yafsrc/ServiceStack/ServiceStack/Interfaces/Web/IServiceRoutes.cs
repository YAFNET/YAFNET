// ***********************************************************************
// <copyright file="IServiceRoutes.cs" company="ServiceStack, Inc.">
...
namespace ServiceStack.Web
{
    ...
    public interface IServiceRoutes
    {
        ...
        /// See <see cref="RouteAttribute.Path">RouteAttribute.Path</see>
        /// for details on the correct format.</param>
        /// <param name="verbs">The comma-delimited list of HTTP verbs supported by the path,
        /// such as "GET,PUT,DELETE".  Specify empty or <see langword="null" />
        /// to indicate that all verbs are supported.</param>
        /// <returns>The same <see cref="IServiceRoutes" /> instance;
        /// never <see langword="null" />.</returns>
        ...
        /// <param name="priority">Used to rank the precedences of route definitions in reverse routing.
        /// i.e. Priorities below 0 are auto-generated have less precedence.</param>
        /// <returns>IServiceRoutes.</returns>
        ...
        /// <param name="summary">The short summary of what the REST does.</param>
        /// <param name="notes">The longer text to explain the behaviour of the REST.</param>
        /// <param name="matches">Must match rule defined in Config.RequestRules or Regex expression with format:
        /// "{IHttpRequest.Field} =~ {pattern}", e.g "PathInfo =~ \/[0-9]+$"</param>
        /// <returns>The same <see cref="IServiceRoutes" /> instance;
        /// never <see langword="null" />.</returns>
