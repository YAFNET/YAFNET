...
namespace ServiceStack
{
    ...
    /// Implements the <see cref="ServiceStack.PclExport" />
    /// </summary>
    /// <seealso cref="ServiceStack.PclExport" />
    public class Net48PclExport : PclExport
    {
        ...
        /// <summary>
        /// Write and flush as an asynchronous operation.
        /// </summary>
        ...
        /// <summary>
        /// Gets the js reader parse method.
        /// </summary>
        /// <typeparam name="TSerializer">The type of the t serializer.</typeparam>
        /// <param name="type">The type.</param>
        /// <returns>ParseStringDelegate.</returns>
...
namespace ServiceStack.Text.FastMember
{
    ...
    public abstract class ObjectAccessor
    {
        ...
        /// Implements the <see cref="ServiceStack.Text.FastMember.ObjectAccessor" />
        /// </summary>
        /// <seealso cref="ServiceStack.Text.FastMember.ObjectAccessor" />
    ...
    public abstract class TypeAccessor
    {
        ...
        /// Implements the <see cref="ServiceStack.Text.FastMember.TypeAccessor" />
        /// </summary>
        /// <seealso cref="ServiceStack.Text.FastMember.TypeAccessor" />
