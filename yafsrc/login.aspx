...
<tr>
	<td class=header1 colspan=2><%= GetText("login_title") %></td>
</tr>
<tr>
	<td class=postheader width=50%><%= GetText("login_username") %></td>
	<td class=post width=50%><asp:TextBox id=UserName runat="server"/></td>
</tr>
<tr>
	<td class=postheader><%= GetText("login_password") %></td>
	<td class=post><asp:TextBox id=Password runat="server" TextMode="Password"/></td>
</tr>
<tr>
	<td class=postheader><%= GetText("login_auto") %></td>
...
<tr>
	<td class=header1 colspan=2><%= GetText("login_recover") %></td>
</tr>
<tr>
	<td class=postheader width=50%><%= GetText("login_username") %>:</td>
...
<tr>
	<td class=postheader><%= GetText("login_email") %>:</td>
