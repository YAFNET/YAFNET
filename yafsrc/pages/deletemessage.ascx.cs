    ...
    public partial class deletemessage : ForumPage
    {
        ...
        private void LinkedPosts_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                DeleteAllPosts.Checked = DeleteAllPosts.Enabled = DeleteAllPosts.Checked = ForumModeratorAccess || IsAdmin;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            isModeratorChanged = (PageUserID != OwnerUserId);
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["m"] != null)
                {
                    ...
                    string mbody = FormatMsg.FormatMessage(this, body, tFlags);
        ...
        public bool CanDeletePost
        {
            get
            {
                return !PostLocked && ((int)msg["ForumFlags"] & (int)YAF.Classes.Data.ForumFlags.Locked) != (int)YAF.Classes.Data.ForumFlags.Locked && ((int)msg["TopicFlags"] & (int)YAF.Classes.Data.TopicFlags.Locked) != (int)YAF.Classes.Data.TopicFlags.Locked && ((int)msg["UserID"] == PageUserID || ForumModeratorAccess) && ForumDeleteAccess;
            }
        }
