...
<%@ Register TagPrefix="uc1" TagName="SuspendUser" Src="../../controls/EditSuspendUser.ascx" %>
<%@ Register TagPrefix="uc1" TagName="EditUserPoints" Src="../../controls/EditUserPoints.ascx" %>
...
<table width="100%" cellspacing="1" cellpadding="0" class="content" >
  <tbody>
	...
	<tr>
      ...
      <asp:LinkButton runat="server" id="SuspendUserLink" onclick="Edit5_Click" /> <br />
      <asp:LinkButton runat="server" id="EditUserPointsLink" onclick="Edit6_Click" /> <br />
    </td>
    <td valign="top" class="post">
      <asp:MultiView ID="UserAdminMultiView" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="SuspendUserView" runat="server">
          <uc1:SuspendUser runat="server" id="SuspendUserControl"></uc1:SuspendUser>
        </asp:View>
        <asp:View ID="EditUserPointsView" runat="server">
          <uc1:EditUserPoints runat="server" ID="EditUserPointsControl" />
        </asp:View>
      </asp:MultiView>
     </td>
  </tr>
