...
namespace YAF.Pages.Admin
{
	...
	/// </summary>
	public partial class nntpservers : YAF.Classes.Base.AdminPage
	{
		...
		{
			RankList.DataSource = YAF.Classes.Data.DB.nntpserver_list(PageContext.PageBoardID,null);
			DataBind();
		}
		...
		private void RankList_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
		{
			...
			{
				case "edit":
					YAF.Classes.Utils.yaf_BuildLink.Redirect( YAF.Classes.Utils.ForumPages.admin_editnntpserver,"s={0}",e.CommandArgument);
					break;
				case "delete":
		...
		{
			YAF.Classes.Utils.yaf_BuildLink.Redirect( YAF.Classes.Utils.ForumPages.admin_editnntpserver);
		}
	}
}
