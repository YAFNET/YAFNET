<%@ Reference Control="~/pages/attachments.ascx" %>
<%@ Control language="c#" Inherits="yaf.pages.admin.attachments" CodeFile="attachments.ascx.cs" CodeFileBaseClass="yaf.AdminPage" %>
