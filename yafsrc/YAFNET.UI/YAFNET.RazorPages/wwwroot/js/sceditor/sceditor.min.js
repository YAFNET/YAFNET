!function() {
    ...
    var Pe = {
        ...
        size: {
            _dropDown: function(t, e, n) {
                ...
                for (let e = 1; e <= 7; e++) Te(o, He("sizeOpt", {
                    size: e
                }, !0));
            ...
            _dropDown: function(t, e, n) {
                ...
                Ce(o, "click", "a", function(e) {
                    ...
                    e.forEach(function(e) {
                        e.useToolbar || Te(o, He("extensionOpt", {
                            extension: e.name
                        }, !0));
                    });
        ...
        image: {
            ...
            exec: function(e) {
                ...
                Pe.image._dropDown(o, e, function(e, t) {
                    var n = "";
                    t && (n += ` alt="${Fe(t)}"`), n += ` src="${Fe(e)}"`, o.wysiwygEditorInsertHtml(`<img${n} class="img-user-posted img-thumbnail" />`);
                });
            },
        ...
        email: {
            ...
            exec: function(e) {
                ...
                Pe.email._dropDown(n, e, function(e, t) {
                    !n.getRangeHelper().selectedHtml() || t ? n.wysiwygEditorInsertHtml(`<a href="mailto:${Fe(e)}">${Fe(t || e)}</a>`) : n.execCommand("createlink", "mailto:" + e);
                });
            },
        ...
        link: {
            ...
            exec: function(e) {
                ...
                Pe.link._dropDown(n, e, function(e, t) {
                    t || !n.getRangeHelper().selectedHtml() ? n.wysiwygEditorInsertHtml(`<a href="${Fe(e)}">${Fe(t || e)}</a>`) : n.execCommand("createlink", e);
                });
            },
        ...
        quote: {
            exec: function(e, t, n) {
                ...
                t ? (o = o + t + (n = n ? `<cite class="card-text text-end d-block text-body-secondary small">${Fe(n)}</cite>` : "") + r, 
        ...
        vimeo: {
            ...
            exec: function(e) {
                ...
                Pe.vimeo._dropDown(n, e, function(e, t) {
                    n.wysiwygEditorInsertHtml(He("vimeo", {
                        url: e,
                        vimeoId: t
                    }));
                });
        ...
        instagram: {
            ...
            exec: function(e) {
                ...
                Pe.instagram._dropDown(n, e, function(e, t) {
                    n.wysiwygEditorInsertHtml(He("instagram", {
                        url: e,
                        id: t
                    }));
                });
        ...
        facebook: {
            ...
            exec: function(e) {
                ...
                Pe.facebook._dropDown(t, e, function(e) {
                    t.wysiwygEditorInsertHtml(He("facebook", {
                        url: e
                    }));
                });
            },
        ...
        youtube: {
            ...
            exec: function(e) {
                ...
                Pe.youtube._dropDown(n, e, function(e, t) {
                    n.wysiwygEditorInsertHtml(He("youtube", {
                        url: e,
                        id: t
                    }));
                });
    ...
    var R = e(/\{\{[\w\W]*|[\w\W]*\}\}/gm), L = e(/<%[\w\W]*|[\w\W]*%>/gm), O = e(/\${[\w\W]*}/gm), I = e(/^data-[\-\w.\u00B7-\uFFFF]/), F = e(/^aria-[\-\w]+$/);
    const Ut = e(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i);
    var H = e(/^(?:\w+script|data):/i), P = e(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g);
    const Bt = e(/^html$/i);
    ...
    var Vt = function F(e) {
        ...
        c;
        const l = e.document, H = l.currentScript;
        let i = e.document;
        const {
            DocumentFragment: P,
        ...
        function Se(e) {
            if (!r || r !== e) {
                ...
                !0 === n.html && (je(h, At), je(g, Ft)), !0 === n.svg && (je(h, _t), 
                je(g, Ht), je(g, zt)), !0 === n.svgFilters && (je(h, Mt), je(g, Ht), 
            ...
            if (I("beforeSanitizeElements", t, null), !((n = t) instanceof W) || "string" == typeof n.nodeName && "string" == typeof n.textContent && "function" == typeof n.removeChild && n.attributes instanceof B && "function" == typeof n.removeAttribute && "function" == typeof n.setAttribute && "string" == typeof n.namespaceURI && "function" == typeof n.insertBefore && "function" == typeof n.hasChildNodes) {
                ...
                if (I("uponSanitizeElement", t, {
                    ...
                    if (h[n] && !b[n]) return t instanceof U && !function(e) {
                        ...
                        return Ee[e.namespaceURI] && (e.namespaceURI === S ? t.namespaceURI === N ? "svg" === n : t.namespaceURI === D ? "svg" === n && ("annotation-xml" === o || Ie[o]) : Boolean(O[n]) : e.namespaceURI === D ? t.namespaceURI === N ? "math" === n : t.namespaceURI === S ? "math" === n && Fe[o] : Boolean(Pe[n]) : e.namespaceURI === N ? (t.namespaceURI !== S || Fe[o]) && (t.namespaceURI !== D || Ie[o]) && !Pe[n] && (He[n] || !O[n]) : "application/xhtml+xml" === _ && Ee[e.namespaceURI]);
        ...
        const Oe = i.createElement("form"), Ie = je({}, [ "mi", "mo", "mn", "ms", "mtext" ]), Fe = je({}, [ "foreignobject", "desc", "title", "annotation-xml" ]), He = je({}, [ "title", "style", "font", "a", "script" ]), O = je({}, _t), Pe = (je(O, Mt), 
    ...
    function $e(r, e) {
        var i, y, u, a, l, c, d, s, w, f, m, p, t, h, g, v, b, F, x, H, P, n, T, z, U, E, C, B, W, V, j, $, Y, q, G, X, K, Q, Z, J, k, ee, te, ne, oe, re, D, ie, S, ae, le, se, ce, N, ue, A, de, o, _ = this, M = {}, R = [], L = {}, fe = {}, O = (_.commands = qe(!0, {}, e.commands || Pe), 
        ...
        me.addHook("uponSanitizeElement", function(e, t) {
            ...
            Xe(s)), O.spellcheck || De(y, "spellcheck", "false"), "https:" === ze.location.protocol && De(a, "src", "about:blank"), 
            De(s, "title", "source"), Te(y, a), Te(y, s), Te(y, w), _.dimensions(O.width || Je(r), O.height || Oe(r)), 
            ...
            var t = "", e = (O.styles.forEach(e => {
                ...
                styles: t
            })), d.close(), c = d.body, l = a.contentWindow, _.readOnly(!!O.readOnly), 
            ht && (Oe(c, "100%"), Ce(c, "touchend", _.focus)), De(r, "tabindex")), e = (De(s, "tabindex", e), 
            De(a, "tabindex", e), h = new pt(l, null, I), Xe(r), _.val(r.value), 
            O.placeholder || De(r, "placeholder"));
            e && (s.placeholder = e, De(c, "placeholder", e));
        }, $ = function() {
            O.autoUpdate && (Ce(c, "blur", de), Ce(s, "blur", de)), null === O.rtl && (O.rtl = "rtl" === Ne(s, "direction")), 
            _.rtl(!!O.rtl), O.autoExpand && (Ce(c, "load", o, !0), Ce(c, "input keyup", o)), 
            ...
            Ce(c, "keypress", J), Ce(c, "keydown", Q), Ce(c, "keydown", Z), Ce(c, "keyup", S), 
            Ce(c, "blur", ue), Ce(c, "keyup", A), Ce(c, "paste", G), Ce(c, "cut copy", X), 
            Ce(c, t, te), Ce(c, o, ae), Ce(c, n, ne), Ce(c, "blur", function() {
                _.val() || Re(c, "placeholder");
            }), Ce(c, "focus", function() {
                Ze(c, "placeholder");
            }), Ce(s, "blur", ue), Ce(s, "keyup", A), Ce(s, "keydown", Q), Ce(s, t, te), 
            Ce(s, n, ne), Ce(d, "mousedown", ee), Ce(d, o, ae), Ce(d, "keyup", S), 
            ...
            u = ye("div", {
                ...
                i = ye("div", {
                    ...
                    var n, o, r = a[t];
                    !r || -1 < l.indexOf(t) || (n = r.shortcut, o = He("toolbarButton", {
                        name: t
            ...
            if (tt(y)) if (_.sourceMode()) t = e ? s.value.length : 0, s.setSelectionRange(t, t); else {
                if (st(c), e) for ((n = c.lastChild) || (n = ye("p", {}, d), Te(c, n)); n.lastChild; ) Ae(n = n.lastChild, "br") && n.previousSibling && (n = n.previousSibling);
            ...
            return "boolean" != typeof e ? !s.readonly : (c.contentEditable = !e, 
            s.readonly = !e, re(e), _);
        }, _.rtl = function(e) {
            var t = e ? "rtl" : "ltr";
            return "boolean" != typeof e ? "rtl" === De(s, "dir") : (De(c, "dir", t), 
            De(s, "dir", t), Ze(y, "rtl"), Ze(y, "ltr"), Re(y, t), C && C.rtl && C.rtl(e), 
            _);
        }, re = function(n) {
            ...
            ke(window, "pageshow", k), xe(s), xe(u), xe(y), delete r._sceditor, 
            Ke(r), r.required = P);
            ...
            if (o) {
                ...
                }), Te(c, i), n.clipboardData.setData("text/plain", i.innerText), 
            ...
            if (n) {
                ...
                for (let e = 0; e < l.length; e++) {
                    if (l.indexOf("text/html") < 0 && ze.FileReader && o && jt.test(o[e].type)) {
                        var r = n.items[e].getAsFile();
                ...
                a.text = a["text/plain"], a.html = I(a["text/html"]), K(a);
            } else if (!E) {
                var i = t.scrollTop;
                for (h.saveRange(), E = Ue.createDocumentFragment(); t.firstChild; ) Te(E, t.firstChild);
                setTimeout(function() {
                    var e = t.innerHTML;
                    t.innerHTML = "", Te(t, E), t.scrollTop = i, E = !1, h.restoreRange(), 
                    K({
                        html: I(e)
                    });
                }, 0);
            ...
            e.html ? (t.innerHTML = I(e.html), lt(t)) : t.innerHTML = Fe(e.text || ""), 
            {
                val: t.innerHTML
            });
            ...
            lt(c), $t(c, d), Ke(n = Ee(c, "#sceditor-end-marker")[0]), e = c.scrollTop, 
            t = ct(n).top + 1.5 * n.offsetHeight - o, Xe(n), (e < t || t + o < e) && (c.scrollTop = t), 
            N(!1), h.restoreRange(), S());
        }, _.wysiwygEditorInsertText = function(e, t) {
            _.wysiwygEditorInsertHtml(Fe(e), Fe(t));
            ...
            return Te(c, n), lt(n), xe(n), t = n.innerHTML, t = !1 !== e && i.hasOwnProperty("toSource") ? i.toSource(t, d) : t;
        }, _.getBody = function() {
            return c;
            ...
            c.innerHTML = I(e = e || "<p><br /></p>"), S(), N(), o();
            ...
            Qe(s), Qe(a), Le(y, "wysiwygMode", e), Le(y, "sourceMode", !e), re(), 
            ...
            function e() {
                if (l.getSelection() && l.getSelection().rangeCount <= 0) x = null; else if (h && !h.compare(x)) {
                    if ((x = h.cloneSelected()) && x.collapsed) {
                        ...
                        var t = x.startOffset;
                        for (t && e.nodeType !== be && (e = e.childNodes[t]); e && e.parentNode !== c; ) e = e.parentNode;
                        e && Ie(e, !0) && (h.saveRange(), $t(c, d), h.restoreRange());
                    }
                    et(y, "selectionchanged");
                }
                H = !1;
            }
            H || (H = !0, "onselectionchange" in d ? e() : setTimeout(e, 100));
        }, le = function() {
            var e, t = h.parentNode();
            v !== t && (e = v, v = t, b = h.getFirstBlockParent(t), et(y, "nodechanged", {
                oldNode: e,
                newNode: v
            })), F && ((t = b.querySelector("span[style]")) && Se(t, "style"), F = !1);
            ...
            return he(e) ? _.bind("blur", e, t, n) : (_.sourceMode() ? s : c).blur(), 
            _;
        }, _.focus = function(e, t, n) {
            if (he(e)) _.bind("focus", e, t, n); else if (_.inSourceMode()) s.focus(); else {
                ...
                o.collapse(!0), h.selectRange(o))), l.focus(), c.focus();
            }
            return D(), _;
            ...
            if ((t.ctrlKey || t.metaKey) && e.push("ctrl"), t.altKey && e.push("alt"), 
            t.shiftKey && (e.push("shift"), o[r] ? i = o[r] : n[i] && (i = n[i])), 
            i && (r < 16 || 18 < r) && e.push(i), e = e.join("+"), L[e] && !1 === L[e].call(_) && (t.stopPropagation(), 
            t.preventDefault()), "]" === t.key && _.inSourceMode()) {
                o = s, n = o.selectionStart;
            ...
            var t, n, o;
            if (F = !0, !O.disableBlockRemove && 8 === e.which && (n = h.selectedRange()) && (t = n.startContainer, 
            ...
            p = !1), o && e && h.saveRange(), (t = n ? s.value : c.innerHTML) !== N.lastVal && (N.lastVal = t, 
            et(y, "valuechanged", {
                rawValue: n ? _.val() : t
            })), o && e && h.removeMarkers());
        }, ue = function() {
...
!function(n) {
    "use strict";
    var c = void 0 !== window.FileReader, v = /data:[^;]+;base64,/i;
    n.plugins.dragdrop = function() {
        ...
        function f(e) {
            ...
            function t(e) {
                const t = r.getBody().ownerDocument.getElementById(n.id);
        ...
        c && (s = 0, this.signalReady = function() {
            i = (r = this).opts.dragdrop || {}, a = i.handleFile, A = r.getContentAreaContainer().parentNode, 
            ...
            if (!("handlePaste" in i) || i.handlePaste) {
                const r = document.createElement("div");
                r.innerHTML = e.val;
                var t, n = r.querySelectorAll("img");
                for (let e = 0; e < n.length; e++) {
                    const A = n[e];
                    v.test(A.src) && ((t = function(e) {
                        var t = e.substr(5, e.indexOf(";") - 5);
                        const n = atob(e.substr(e.indexOf(",") + 1)), r = new Uint8Array(n.length);
                    ...
                    }(A.src)) ? a(t, f(A)) : A.parentNode.removeChild(A));
                }
                e.val = r.innerHTML;
            }
        });
