...
/// The Signature tests.
/// </summary>
public class SignatureTests(ComposeScenario scenario) : DatabaseTestBase(scenario)
{
    /// <summary>
            ...
            async page =>
                {
                    ...
                    // Do actual test
                    await page.GotoAsync($"{this.TestSettings.TestForumUrl}Profile/EditSignature");
