...
/// </summary>
public class HostSettingsTests(ComposeScenario scenario) : DatabaseTestBase(scenario)
{
    /// <summary>
            ...
            async page =>
                {
                    ...
                    await page.GotoAsync($"{this.TestSettings.TestForumUrl}Admin/HostSettings");
