...
/// <summary>
/// Describes one database-backend scenario passed into a parameterized test.
/// Add a new static property here whenever you want to test against a new backend.
/// </summary>
public class ComposeScenario
{
    ...
    private ComposeScenario(string name, string baseUrl, string composeFile)
    {
        this.Name = name;
