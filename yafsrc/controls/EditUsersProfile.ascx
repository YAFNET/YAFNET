...
<table width="100%" class="content" cellspacing="1" cellpadding="4">
	<tr>
		<td class="header1" colspan="2"><%= ForumPage.GetText("CP_EDITPROFILE","title") %></td>
	</tr>
		<tr>
			<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","aboutyou") %></b></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","realname2") %></td>
			<td class="post"><asp:TextBox id="Realname" runat="server" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","occupation") %></td>
			<td class="post"><asp:TextBox id="Occupation" runat="server" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","interests") %></td>
			<td class="post"><asp:TextBox id="Interests" runat="server" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","gender") %></td>
			<td class="post">
				<asp:DropDownList id="Gender" runat="server" cssclass="edit" /></td>
		</tr>		
	<tr>
		<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","location") %></b></td>
	</tr>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","where") %></td>
		<td class="post"><asp:TextBox id="Location" runat="server" cssclass="edit"/></td>
	</tr>
	<tr>
		<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","homepage") %></b></td>
	</tr>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","homepage2") %></td>
		<td class="post"><asp:TextBox runat="server" id="HomePage" cssclass="edit"/></td>
	</tr>
	
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","weblog2") %></td>
			<td class="post"><asp:TextBox runat="server" id="Weblog" cssclass="edit" /></td>
		</tr>
		<tr>
			<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","messenger") %></b></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","msn") %></td>
			<td class="post"><asp:TextBox runat="server" id="MSN" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","yim") %></td>
			<td class="post"><asp:TextBox runat="server" id="YIM" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","aim") %></td>
			<td class="post"><asp:TextBox runat="server" id="AIM" cssclass="edit" /></td>
		</tr>
		<tr>
			<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","icq") %></td>
			<td class="post"><asp:TextBox runat="server" id="ICQ" cssclass="edit" /></td>
		</tr>
	
	
	<tr>
		<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","timezone") %></b></td>
	</tr>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","timezone2") %></td>
	...
	<tr runat="server" id="ForumSettingsRows">
		<td colspan="2" class="header2"><b><%= ForumPage.GetText("CP_EDITPROFILE","FORUM_SETTINGS") %></b></td>
	</tr>
	...
	<asp:PlaceHolder runat="server" ID="ShowOldPassword" Visible="true">
	    <tr>
		    <td class="postheader" width="50%"><%= ForumPage.GetText("CP_EDITPROFILE","oldpassword") %></td>
		    <td class="post" width="50%"><asp:TextBox cssclass="edit" ID="OldPassword" Runat="server" TextMode="Password"/></td>
	    </tr>
	</asp:PlaceHolder>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","newpassword") %></td>
		<td class="post"><asp:TextBox cssclass="edit" ID="NewPassword1" Runat="server" TextMode="Password"/></td>
	</tr>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","confirmpassword") %></td>
		<td class="post"><asp:TextBox cssclass="edit" ID="NewPassword2" Runat="server" TextMode="Password"/></td>
	</tr>

	<tr>
		<td colspan="2" class="header2"><%= ForumPage.GetText("CP_EDITPROFILE","change_email") %></td>
	</tr>
	<tr>
		<td class="postheader"><%= ForumPage.GetText("CP_EDITPROFILE","email") %></td>
