...
namespace YAF.Controls.Statistics
{
    ...
    public class ActiveDiscussions : BaseControl
    {
        ...
        protected override void Render(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            htmlOutput += "<tr><td class=\"header1\">" + ForumPage.GetText("LATEST_POSTS") + "</td></tr>";
            System.Data.DataTable dt = YAF.Classes.Data.DB.topic_latest(ForumPage.PageBoardID, 7, ForumPage.PageUserID);
            int i = 1;
            ...
            foreach (System.Data.DataRow r in dt.Rows)
            {
                ...
                //Output Topic Link
                htmlOutput += string.Format("&nbsp;<a href=\"{1}\">{0}</a></td>", YAF.Utils.BadWordReplace(Convert.ToString(r["Topic"])), YAF.Forum.GetLink(YAF.ForumPages.posts,"m={0}#{0}",r["LastMessageID"]));
                //Output Message Icon
                htmlOutput += "<img src=\"" + ForumPage.GetThemeContents("ICONS","ICON_LATEST") + "\" border=\"0\" alt=\"\"></a>";
                htmlOutput += "</td></tr>";
            }
