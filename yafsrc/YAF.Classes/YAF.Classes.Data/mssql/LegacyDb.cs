...
namespace YAF.Classes.Data
{
    ...
    public static class LegacyDb
    {
        ...
        public static DataTable active_list(
            object boardID, object Guests, object showCrawlers, int activeTime, object styledNicks)
        {
        ...
        public static DataTable active_list_user(
            object boardID, object userID, object Guests, object showCrawlers, int activeTime, object styledNicks)
        {
        ...
        public static void album_image_save(
            object imageID, object albumID, object caption, object fileName, object bytes, object contentType)
        {
            ...
            if (!useFileTable)
            {
                using (var cmd = MsSqlDbAccess.GetCommand("attachment_list"))
                {
                    ...
                    foreach (DataRow row in tbAttachments.Rows)
                    {
                        try
                        {
                            string fileName = "{0}/{1}.{2}.yafupload".FormatWith(
                                uploadDir, row["MessageID"], row["FileName"]);
        ...
        public static void attachment_save(
            object messageID, object fileName, object bytes, object contentType, Stream stream)
        {
        ...
        public static int board_save(
            object boardID, object languageFile, object culture, object name, object allowThreaded)
        {
        ...
        public static void category_save(
            object boardID, object categoryId, object name, object categoryImage, object sortOrder)
        {
                    ...
                    using (var trans = connMan.OpenDBConnection.BeginTransaction(MsSqlDbAccess.IsolationLevel))
                    {
                        using (
                            var da = new SqlDataAdapter(
                                MsSqlDbAccess.GetObjectName("category_list"), connMan.DBConnection))
                        {
                            ...
                            DataTable dtForumListSorted =
                                ds.Tables[MsSqlDbAccess.GetObjectName("ForumUnsorted")].Clone();
        ...
        public static DataTable forum_listall_sorted(
            object boardID, object userID, int[] forumidExclusions, bool emptyFirstRow, int startAt)
        {
        ...
        public static DataTable forum_listread(
            object boardID, object userID, object categoryID, object parentID, object useStyledNicks)
        {
        ...
        public static DataSet forum_moderatelist(object userID, object boardID)
        {
            using (var connMan = new MsSqlDbConnectionManager())
            {
                using (var ds = new DataSet())
                {
                    using (
                        var da = new SqlDataAdapter(
                            MsSqlDbAccess.GetObjectName("category_list"), connMan.OpenDBConnection))
                    {
                        using (
                            SqlTransaction trans =
                                da.SelectCommand.Connection.BeginTransaction(MsSqlDbAccess.IsolationLevel))
                        {
                            da.SelectCommand.Transaction = trans;
                            da.SelectCommand.Parameters.AddWithValue("BoardID", boardID);
                            da.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public static int forum_save_parentschecker(object forumID, object parentID)
        {
            using (
                var cmd =
                    MsSqlDbAccess.GetCommand(
                        "SELECT " + MsSqlDbAccess.GetObjectName("forum_save_parentschecker") + "(@ForumID,@ParentID)", 
                        true))
            {
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ForumID", forumID);
        ...
        public static void group_medal_save(
            object groupID, object medalID, object message, object hide, object onlyRibbon, object sortOrder)
        {
        ...
        public static void mail_create(
            object from, object fromName, object to, object toName, object subject, object body, object bodyHtml)
        {
        ...
        public static void mail_createwatch(
            object topicID, object from, object fromName, object subject, object body, object bodyHtml, object userID)
        {
        ...
        public static void message_delete(
            object messageID, bool isModeratorChanged, string deleteReason, int isDeleteAction, bool DeleteLinked)
        {
        ...
        public static DataTable message_findunread(
            object topicID, object messageId, object lastRead, object showDeleted, object authorUserID)
        {
        ...
        public static void nntpforum_save(
            object nntpForumID, object nntpServerID, object groupName, object forumID, object active)
        {
        ...
        public static void poll_remove(
            object pollGroupID, object pollID, object boardId, bool removeCompletely, bool removeEverywhere)
        {
            ...
            foreach (PollSaveList question in pollList)
            {
                ...
                for (uint choiceCount = 0; choiceCount < question.Choice.GetUpperBound(1) + 1; choiceCount++)
                {
                    if (!string.IsNullOrEmpty(question.Choice[0, choiceCount]))
                    {
                        ...
                        sb.AppendFormat(
                            "@PollID,@Choice{0},@Votes{0},@ChoiceObjectPath{0}, @ChoiceMimeType{0}", choiceCount);
                        sb.Append("); ");
                    }
                }
                ...
                using (var cmd = MsSqlDbAccess.GetCommand(sb.ToString(), true))
                {
                    ...
                    for (uint choiceCount1 = 0; choiceCount1 < question.Choice.GetUpperBound(1) + 1; choiceCount1++)
                    {
                        ...
                        {
                            cmd.Parameters.AddWithValue(
                                String.Format("@Choice{0}", choiceCount1), question.Choice[0, choiceCount1]);
        ...
        public static void smiley_save(
            object smileyID, object boardID, object code, object icon, object emoticon, object sortOrder, object replace)
        {
        ...
        public static void system_initialize_executescripts(string script, string scriptFile, bool useTransactions)
        {
            ...
            using (var connMan = new MsSqlDbConnectionManager())
            {
                ...
                {
                    using (
                        SqlTransaction trans = connMan.OpenDBConnection.BeginTransaction(MsSqlDbAccess.IsolationLevel))
                    {
                                ...
                                if (grant)
                                {
                                    ...
                                    foreach (DataRow row in dt.Select("IsProcedure=1 or IsScalarFunction=1"))
                                    {
                                        cmd.CommandText = string.Format(
                                            "grant execute on \"{0}\" to \"{1}\"", row["Name"], userName);
                                        cmd.ExecuteNonQuery();
                                    }
                                    ...
                                    {
                                        cmd.CommandText = string.Format(
                                            "grant select,update on \"{0}\" to \"{1}\"", row["Name"], userName);
                                        cmd.ExecuteNonQuery();
                                    }
                                }
                                else
        ...
        public static DataTable topic_active(
            object boardID, object pageUserId, object since, object categoryID, object useStyledNicks)
        {
        ...
        public static int user_aspnet(
            int boardID, string userName, string displayName, string email, object providerUserKey, object isApproved)
        {
            try
            {
        ...
        public static int user_get(int boardID, object providerUserKey)
        {
            using (
                var cmd =
                    MsSqlDbAccess.GetCommand(
                        "select UserID from {databaseOwner}.{objectQualifier}User where BoardID=@BoardID and ProviderUserKey=@ProviderUserKey", 
                        true))
            {
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("BoardID", boardID);
        ...
        public static DataTable user_list(
            object boardID, object userID, object approved, object groupID, object rankID, object useStyledNicks)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_list"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_removepointsbytopicid"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("TopicID", topicID);
                cmd.Parameters.AddWithValue("Points", points);
        ...
        public static void user_savenotification(
            object userID, object pmNotification, object autoWatchTopics, object notificationType, object dailyDigest)
        {
                ...
                try
                {
                    ...
                    if (reader != null)
                    {
                        if (reader.HasRows)
                        {
                            int rowIndex = 1;
                            var columnNames =
                                reader.GetSchemaTable().Rows.Cast<DataRow>().Select(r => r["ColumnName"].ToString()).
                                    ToList();
        ...
        private static DataTable forum_sort_list(
            DataTable listSource, int parentID, int categoryID, int startingIndent, int[] forumidExclusions)
        {
            ...
            DataTable listSource, DataTable listDestination, int parentID, int categoryID, int currentIndent)
        {
            foreach (DataRow row in listSource.Rows)
            {
                ...
                newRow["ForumID"] = row["ForumID"];
                newRow["ForumName"] = "{0} {1}".FormatWith(sIndent, row["ForumName"]);
